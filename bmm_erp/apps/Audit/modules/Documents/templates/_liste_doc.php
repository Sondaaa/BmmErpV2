    ...
    <div class="col-xs-12">
        ...
        <div class="table-header">
            ...
            if ($str != '')
                $str = substr($str, 1);
            ?>
            <a target="_blanc" href="<?php echo url_for('Documents/ImprimerListeDocFournisseur?' . $str) ?>" class="btn btn-sm btn-success" style="float: right; padding: 5px 9px;">
                                ...
                                <?php foreach ($pager->getResults() as $doc): ?>
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a href="<?php echo url_for('Documents/Imprimerbonexterne?iddoc=') . $doc->getId() ?>" target="_blanc">Exporter PDF</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
