...
<div id="sf_admin_container">
    ...
    <div class=" widget-header-large">
        <h3 class="widget-title grey lighter">
            <div class="col-lg-6"><?php echo $documentachat->getTypedoc() ?><br></div> 
                        ...
                        <div class="widget-main padding-24">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="list-unstyled  spaced">
                                            <li><i class="ace-icon fa fa-caret-right green"></i>PROJET:</li>
                                            <li><i class="ace-icon fa fa-caret-right green"></i>CHAPITRE:</li>
                                            <li><i class="ace-icon fa fa-caret-right green"></i>TITRE:</li>
                                        </ul>
                                    </div><div class="col-lg-6">
                                        <ul class="list-unstyled  spaced">
                                            <li><i class="ace-icon fa fa-caret-right green"></i>ART:</li>
                                            <li><i class="ace-icon fa fa-caret-right green"></i>PAR:</li>
                                            <li><i class="ace-icon fa fa-caret-right green"></i>S/P:</li>
                                        </ul>
                                    </div>
                                </div><!-- /.col -->
                            </div><!-- /.row -->
                            ...
                            <div class="col-lg-6">
                                <div class="widget-box transparent">
                                    <div class="widget-header widget-header-small">
                                        <h4 class="widget-title blue smaller">Fournisseur</h4>
                                    </div>
                                    <div class="widget-body">
