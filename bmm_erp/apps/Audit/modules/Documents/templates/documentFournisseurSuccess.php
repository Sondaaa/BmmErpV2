<div id="sf_admin_container">
    <h1>Liste des <u>B.C.E.S & B.D.C.S</u> par Fournisseur</h1>
    <div id="sf_admin_bar">
        <div class="sf_admin_filter" style=" width: 65%;">
            ...
            <table class="table table-bordered table-hover" cellspacing="0" style="margin-bottom: 0px;">
                ...
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('Documents/documentFournisseur') ?>" class="btn btn-white btn-success">Effacer</a>
...
<script  type="text/javascript">
    ...
    function goPage(page) {
        if ($("#id_fournisseur").val() != '0') {
            $.ajax({
                url: '<?php echo url_for('Documents/goPageDoc') ?>',
                data: 'page=' + page +
