            ...
            <div class="tabbable">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    foreach ($listesordredeservice as $od) {
                        ...
                        ?>
                        <li >
                            <a data-toggle="tab" href="#or<?php echo $ordres->getId() ?>" ng-click="InialiserChamps(); AfficheDetailPrix(<?php echo $form->getObject()->getId() ?>); AfficheSousDetailPrix(<?php echo $form->getObject()->getId() ?>)" >
                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset>
                            ...
                            <div class="col-lg-9">
                                <table class="disabledbutton">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="width: 10%"><label>TOTAL GENERAL HTVA</label></td>
                                            <td style="width: 20%">
                                                <?php echo $form['totalht']->renderError() ?>
                                                <?php echo $form['totalht'] ?>
                                            </td>
                                            <td style="width: 10%"><label>TVA</label></td>
                                            <td style="width: 30%">
                            ...
                            <div class="col-lg-3">
                                <?php include_partial('lots/form_action_ios', array('idlot' => $form->getObject()->getId(), 'type' => "type2", 'formlot' => $form, 'listesordredeservice' => $listesordredeservice)); ?>
                            </div>
                        </fieldset>
                    </div>
                    <?php
                    foreach ($listesordredeservice as $od) {
                        ...
                        <div id="or<?php echo $ordres->getId() ?>" class="tab-pane fade" >
                            ...
                            include_partial('sousdetailprix/formsousdetail_1', array('sousdetailprix' => $sousdetailprix, 'form' => $formsousdetail, 'formlot' => $form));
                            ?>
                        </div>
                    <?php } ?>
                </div>
