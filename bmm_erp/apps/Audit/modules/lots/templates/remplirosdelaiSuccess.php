                    ...
                    foreach ($listesordredeservice as $od) {
                        ...
                        <li >
                            <a data-toggle="tab" href="#or<?php echo $ordres->getId() ?>"  >
                                ...
                                Ordre de Service : <?php echo $ordres->getTypeios() ?>
                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset >
                            ...
                            <div class="col-lg-3">
                                <?php include_partial('lots/form_action_ios', array('type' => "ios", 'idlot' => $form->getObject()->getId(), 'formlot' => $form, 'listesordredeservice' => $listesordredeservice)); ?>
                            </div>
                        </fieldset>
                    </div>
                    <?php
