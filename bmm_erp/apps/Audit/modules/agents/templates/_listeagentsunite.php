        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés  relie au  "<?php echo $unite->getLibelle(); ?> "</h4>
                </div>
...
//                                $listes=  AgentsTable::getInstance()->getlisteagents($idde,$idfin);
                    ...
                    <div class="modal-footer" >
                        <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparunite?idunite='.$idd) ?>" class="btn  btn-success pull-left">
