<div id="sf_admin_container">
    <h1 id="replacediv"> Base Comptable 
        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter Plan.C Client - Exercice <?php echo $_SESSION['exercice']; ?> => Excel</small>
    </h1>
</div>
...
<div class="row">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Plan-comptable-client-<?php echo $_SESSION['exercice']; ?>')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter Plan.C Client vers Fichier Excel
        </button>
    </div>
