...
<div class="col-md-12" style="margin-top: 15px; margin-bottom: 15px;">
    <span class="btn btn-white btn-primary pull-right" onclick="saveTableDefinition()"><i class="ace-icon fa fa-save bigger-110 icon-only"></i> Enregistrer Composition</span>
</div>
