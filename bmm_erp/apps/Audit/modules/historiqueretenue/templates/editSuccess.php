                            ...
                            <table class="table table-bordered table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <label>  
                                            <?php if ($historiqueretenue->getIdRetenue() != ""): ?>
                                                <?php echo $historiqueretenue->getRetenuesursalaire()->getAgents()->getNomComplet() . " " . $historiqueretenue->getRetenuesursalaire()->getAgents()->getPrenom(); ?>
                                            <?php elseif ($historiqueretenue->getIdDemandepret() != ""): ?>
                                                <?php echo $historiqueretenue->getDemandepret()->getAgents()->getNomComplet() . " " . $historiqueretenue->getDemandepret()->getAgents()->getPrenom(); ?>
                                            <?php elseif ($historiqueretenue->getIdDemandeavance() != ""): ?>
                                                <?php echo $historiqueretenue->getDemandeavance()->getAgents()->getNomComplet() . " " . $historiqueretenue->getDemandeavance()->getAgents()->getPrenom(); ?>
