...
//        $categorie = Doctrine_Core::getTable('categorierh')->findAll();
        ?>
        <?php
        foreach ($corps as $c):
            if ($c->getId() == 2) {
                ...
                <div id="table-scroll-1" class="table-scroll" style="margin-bottom: 10px;">
                    <div class="table-wrap" ng-init="AfficheSalairedebsae()">
                        <table id="fonctionnaire" class="main-table">
                            <thead>
                                <tr>
                                    <th class="fixed-side" scope="col">Catégorie</th>
                            ...
                            <?php // $sous_corps = SouscorpsTable::getInstance()->findByCorpsOrderByLibelle($c->getId()); ?>
                            <?php // foreach ($sous_corps as $sc): ?>
                                <tr>
                                    <?php $test = 0; ?>
                                    ...
                                    <?php foreach ($categories as $cat): ?>
                                        ...
                                        <tr>
                                        <?php endif; ?>
                                        <td class="fixed-side" scope="col" style="background: repeat-x #F2F2F2; background-image: linear-gradient(to bottom,#F8F8F8 0,#ECECEC 100%);" rowspan="<?php echo $echelle->count(); ?>"><?php echo $cat->getlibelle(); ?></td>
                                        <?php $test_2 = 0; ?>
                                        <?php foreach ($echelle as $echel): ?>
                                            ...
                                            <?php foreach ($echelon as $e): ?>
                                                <td rowspan="1" style="padding: 3px;">
                                                    <input class="disabledbutton" style="width: 65px; padding: 3px 4px 4px;" type="text" data="fonctionnaire" id="<?php echo $cat->getId() . '_' . $echel->getId() . '_' . $e->getId() ?>"></td>
                                            <?php endforeach; ?>
                                            <?php if ($test_2 != 0): ?>
                                            </tr>
                                        <?php endif; ?>
            ...
            if ($c->getId() == 1) {
                ...
                <div id="table-scroll-2" class="table-scroll">
                    <div class="table-wrap">
                        <table id="ouvrier" class="main-table">
                            <thead>
                                <tr>
                                    <th class="fixed-side" scope="col">Catégorie</th>
                                        ...
                                        <?php foreach ($grades as $grade): ?>
                                            ...
                                            <?php foreach ($echelle as $echel): ?>
                                                ...
                                                <?php foreach ($echelon as $e): ?>
                                                    ...
                                                    <tr>
                                                    <?php endif; ?>
                                                    <td rowspan="1" style="padding: 3px;"><input class="disabledbutton" type="text" style="width: 65px; padding: 3px 4px 4px;" data="ouvrier" id="<?php echo $cat->getId() . '_' . $grade->getId() . '_' . $echel->getId() . '_' . $e->getId() ?>"></td>
                                                <?php endforeach; ?>
                                                <?php if ($test_3 != 0): ?>
                                                </tr>
                                            <?php endif; ?>
