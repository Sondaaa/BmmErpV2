<div id="sf_admin_container">
    <h1>SUIVI BON DEPENSE AU COMPTANT REGROUPE</h1>
</div>
...
//                                                echo $bon_deponse_externe_difinitif->getFirst()->getNumerodocachat();
                                        ...
                                        <td>
                                            ...
                                            if (sizeof($bon_deponse_externe_difinitif) >= 1) {
                                                ...
                                                if (sizeof($piecejoint) >= 1) {
                                                    echo date('d/m/Y', strtotime($piecejoint->getFirst()->getDocumentbudget()->getDatecreation()));
                                                } else {
                                                    echo '';
                                                }
                                            }
                                        ...
                                        <td style="text-align: right">
                                            ...
                                            if (sizeof($bon_deponse_externe_difinitif) >= 1) {
                                                ...
                                                $piecejoint = PiecejointbudgetTable::getInstance()->findbyIdDocachat($id_docparent);
                                                if (sizeof($piecejoint) >= 1) {
                                                    echo $piecejoint->getFirst()->getDocumentbudget()->getMnt();
                                                } else {
                                                    echo '';
                                                }
                                            }
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            if (sizeof($bon_deponse_externe_difinitif) >= 1) {
                                                ...
                                                if (sizeof($docparent_parent) >= 1 && sizeof($facuture_comptabe) >= 1) {
                                                    foreach ($facuture_comptabe as $fac):
                                                        echo include_partial('tddetaildocfacture', array('boncomm' => $fac));
                                                    endforeach;
                                                }
                                            } else {
                                                echo '';
...
//                                                    echo $bon_deponse_externe_difinitif->getFirst()->getLignemouvementfacturation()->getFirst()->getNumerofacture();
                                                    foreach ($bon_deponse_externe_difinitif->getFirst()->getLignemouvementfacturation() as $ligne):
                                                        echo $ligne->getNumerofacture(). "<br>";
                                                    endforeach;
                                                }
                                            } else {
                                                echo '';
                                        ...
                                        <td style="text-align: right">
                                            ...
                                            if (sizeof($bon_deponse_externe_difinitif) >= 1) {
                                                ...
                                                if (sizeof($docparent_parent) >= 1 && sizeof($facuture_comptabe) >= 1) {
                                                    foreach ($facuture_comptabe as $fac):
                                                        echo number_format($fac->getMntttc(), 3, ".", " ") . "<br>";
