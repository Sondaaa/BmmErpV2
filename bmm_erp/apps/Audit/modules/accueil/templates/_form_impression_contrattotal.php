                ...
                <fieldset class="col-lg-12">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr> 
                            ...
                            <td><input id="numero_bce" name="numero_contrat" type="checkbox" style="width: 25px"></td>
                            <td>N°Contrat Définitif</td>
                            <td><input id="numero_bced" name="numero_contratdef" type="checkbox" style="width: 25px"></td>
                            <td>Montnt Contrat Def.</td>
                            <td><input id="montant_bced" name="montant_contratdef" type="checkbox" style="width: 25px"></td>
                            <td></td>
                           </tr> 
