                    ...
                    <table id="listBalance" class="mws-datatable-fn mws-table main-table">
                        <thead>
                            <tr>
                                ...
                                <th style="widows: 10%;text-align: center" colspan="3" >Bon Commande Externe</th>
...
//                                                echo $document_achat_externe_difinitif->getFirst()->getNumerodocachat();
                                        ...
                                        <td>
                                            ...
                                            if (sizeof($document_achat_externe_difinitif) >= 1) {
                                                ...
                                                if ($piecejoint && $piecejoint->getFirst())
...
//                                                        if (($piece_budget->getFirst()->getId() != null))
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            if (sizeof($document_achat_externe_difinitif) >= 1) {
                                                $docparent_parent = Doctrine_Core::getTable('documentachat')->findByIdDocparent($id_docparent);
                                                if (sizeof($docparent_parent) >= 1) {
//                                            echo include_partial('tddetaildocfacture', array('boncomm' => $docparent_parent->getFirst()));
//                                            if (sizeof($document_achat_externe_difinitif) >= 1) {
//                                                $docparent_parent = Doctrine_Core::getTable('documentachat')->findByIdDocparent($id_docparent);
//                                                if (sizeof($docparent_parent) >= 1 && sizeof($facuture_comptabe) >= 1) {
                                                    echo $docparent_parent->getFirst()->getNumerodocachat();
                                                }
                                            } else {
                                                echo '';
                                            }
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            if (sizeof($document_achat_externe_difinitif) >= 1) {
                                                $docparent_parent = Doctrine_Core::getTable('documentachat')->findByIdDocparent($id_docparent);
                                                if (sizeof($docparent_parent) >= 1 && $document_achat_externe_difinitif->getFirst()->getLignemouvementfacturation()->getFirst()->getNumerofacture() != null) {
                                        ...
                                        <td style="text-align: right">
                                            ...
                                            if (sizeof($document_achat_externe_difinitif) >= 1) {
                                                $docparent_parent = Doctrine_Core::getTable('documentachat')->findByIdDocparent($id_docparent);
                                                if (sizeof($docparent_parent) >= 1) {
                                                    echo number_format($docparent_parent->getFirst()->getMntttc(), 3, ".", " ");
                                                }
                                            } else {
                                                echo '';
                                            }
