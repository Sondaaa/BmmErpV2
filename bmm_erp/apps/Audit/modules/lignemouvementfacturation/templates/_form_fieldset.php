...
<div class="row" id="details_mouvements">
    <div class="col-xs-12">
        <div class="widget-box" >
            <div class="widget-header widget-header-flat">
            ...
            <div class="widget-body">
                <div class="widget-main" style="padding-bottom: 0px; width: 100%; overflow: auto; min-height: 500px">
                    <table id="idformulaire">
                        <tr>
                            <td colspan="3" style="text-align: center;">Facture</td>
                            <td colspan="3" style="text-align: center; background-color: #dff0d8;">B.C.E / B.D.C / Contrat</td>
                        </tr>
                        <tr>
                            <td>Date<br>
                            ...
                            <td>Numéro<a id="info_doc_achat" onclick="showHistorique()" style="float: right; cursor: pointer;"><i class="ace-icon fa fa-info-circle bigger-130"></i></a><br>
                                <input type="text" value="" id="documentachat" ng-model="documentachat.text" ng-change="AfficheDocAchat('#documentachat', '#id_documentachat', '#date_documentachat', '#montant_documentachat')">
                                <input type="hidden" id="id_documentachat">
                            </td>
                            <td>Date<br>
                                <input type="date" value="" id="date_documentachat">
                            </td>
                            <td>Montant<br>
                        ...
                        <tr>
                            <td colspan="3" style="text-align: center; background-color: #fcf8e3;">R.R.S / P.V.R</td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">Raison sociale
                                <input type="text" value="" id="fournisseur_raison" ng-model="fournisseur.text" ng-change="AfficheFournisseur('#fournisseur_raison', '#id_fournisseur')">
                                <input type="hidden" value="" id="id_fournisseur">
                            </td>
                        </tr>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="width: 200px; background-color: #dff0d8;">B.C.E / B.D.C / Contrat</th>
                        ...
                        <tbody ng-repeat="lgop in listes_operations">
                            <tr>
                                ...
                                <td style="background-color: #fcf8e3;"><span ng-if="lgop.rrs != ''">{{lgop.rrs}}</span> + <span ng-if="lgop.pvr != ''">{{lgop.pvr}}</span></td>
