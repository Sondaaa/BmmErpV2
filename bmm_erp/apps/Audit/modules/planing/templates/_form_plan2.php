            ...
            <div class="modal-body">
             ...
             <div class="row"></div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary pull-right" onclick="voirplan2()">Suivi des Règlements</button>
                    <button id="btnfermer" style="margin-right: 15px" class="btn  pull-right" data-dismiss="modal" onclick="annuler2()">
                        Fermer
                    </button>
                </div>
            </div>
