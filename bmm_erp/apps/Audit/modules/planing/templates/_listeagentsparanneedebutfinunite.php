<div id="my-modalagentsParAnneeDebutFinUnite" class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés  de "<?php  echo $unite->getLibelle() ; ?>"   participants à  La Formation entre  "<?php echo $idd ?> " - "<?php echo $idf ?> "</h4>
                </div>
                ...
                <div class="modal-body" >
                    ...
                    <div class="modal-footer" >
                        <a id="button_print" target="_blanc" href="<?php echo url_for('planing/ImprimerAlllisteparAnneedebutfinUnite?idannee=' . $idd .'&idannefin='.$idf .'&idunite='.$idunite ) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" id="btn1"  class="btn  pull-left"  onclick="fermeragentsAnneedebutfinUnite()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentsAnneedebutfinUnite()
    {
        $('#my-modalagentsParAnneeDebutFinUnite').removeClass('in');
        $('#my-modalagentsParAnneeDebutFinUnite').css('display', 'none');
    }
