        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés de   "<?php echo $unite->getLibelle(); ?> " participants à La Formation avec l'organisme  "<?php echo $four->getRs(); ?> " </h4>
                </div>
