            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                            ...
                            <tbody>
                                ...
                                foreach ($listes as $l) {
                                    ...
                                    <tr style="cursor: pointer;" ondblclick="chRubriqueParDomaine1('<?php echo $ag->getId(); ?>', '<?php echo $ag->getCode(); ?>', '<?php echo $ag->getLibelle(); ?>')">
                                        ...
                                        <td ><?php echo $i; ?> </td>
                                        <td><?php echo $ag->getDomaineuntilisation()->getCode(); ?> </td>
                    ...
                    <div class="modal-footer" >
                        <a id="button_print" target="_blanc" href="<?php echo url_for('rubriqueformation/ImprimerlisteRubriqueParDomaine?iddomaine=' . $idd) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" class="btn  pull-left"  onclick="fermerRubriqueParDomanie1()" >
