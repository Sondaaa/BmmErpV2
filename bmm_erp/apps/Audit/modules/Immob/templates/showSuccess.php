                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td><label>Taux d'amortisement</label></td>
                                            <td><?php echo $immo->getTauxammortisement(); ?></td>
                                        </tr>
                                        <tr>
                                            <td><label>Mode d'amortisement</label></td>
...
//  echo date("Y-m-d h:i:s",$time1)."<br>".date('Y-m-d h:i:s',$time2)."<br>";
                ...
                <table>
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                &nbsp;<a class="btn btn-primary" href="<?php echo url_for('Immob/show?id=' . $immo->getId() . "&page=immp") ?>">Impprimer</a>
                            </td>
                        </tr>
                    </tfoot>
                </table>
