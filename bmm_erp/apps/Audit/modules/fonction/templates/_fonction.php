        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <table id="dynamic-table" class="dynamic-table" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            foreach ($listes as $l) {
                                $ag = $l;
                                ?>
                                <tr style="cursor: pointer;" ondblclick="chfonction('<?php echo $ag->getId(); ?>', '<?php echo $ag->getDescription(); ?>')">
                ...
                <div class="modal-footer" >
                    <a id="button_print" target="_blanc" href="<?php echo url_for('fonction/ImprimerAllliste') ?>" class="btn  btn-success pull-left">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                        <span class="bigger-110 no-text-shadow">Imprimer</span>
                    </a>
                    <button type="button" value="Fermer" class="btn pull-left" onclick="fermerfonction()">
                        Fermer</button>
                </div>
            </div>
        </div>
...
<script  type="text/javascript">
    ...
    function chfonction(id, libelle)
    {
        ...
        $('#idfonction-agent').val(id);
        $('#liebllefonction-agent').val(libelle);
    }
