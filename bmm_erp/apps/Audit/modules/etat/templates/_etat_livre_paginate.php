                            ...
                            <?php if ($numero_compte != $livre->getPlandossiercomptable()->getNumerocompte()):
                              ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" style="font-weight: bold; text-align: left; background-color: #eaf3f7;"><?php echo $livre->getPlandossiercomptable()->getLibelle() ?></td>
                                    <td colspan="5" style="font-weight: bold;">Report</td>
                                </tr>
                            <?php endif;
