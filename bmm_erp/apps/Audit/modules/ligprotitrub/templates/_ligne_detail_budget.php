            ...
            <form>
                <div class="sf_admin_list">
                    <table id="list_rubrique" class="table table-bordered table-hover" cellspacing="0">
                        ...
                        <tbody>
                            <?php $rubriques = LigprotitrubTable::getInstance()->getFirstParentByTitre($titre_budget->getId()); ?>
                            ...
                            <?php else: ?>
                                <?php foreach ($rubriques as $ldb): ?>
                                    ...
                                    <?php if ($rubriques_sous_lignes->count() != 0): ?>
                                        ...
                                        <?php $mnt_rapport = calculMontantRapportSousRubrique::getMnt($rubriques_sous_lignes); ?>
                                        <tr style="background-color: #e5f1f7;">
                                            <td><?php echo $ldb->getCode(); ?></td>
                                            <td><?php echo $ldb->getRubrique()->getLibelle(); ?></td>
                                            <td><?php echo number_format($mnt_rapport["provisoire"], 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($mnt_rapport["engagement"], 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($mnt_rapport["ecart"], 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($mnt_rapport["ordonnance"], 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($mnt_rapport["paye"], 3, '.', ' '); ?></td>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr style="background-color: #e5f1f7;">
                                            <td><?php echo $ldb->getCode(); ?></td>
                                            <td><?php echo $ldb->getRubrique()->getLibelle(); ?></td>
                                            <td><?php echo number_format($total_provisoire, 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($total_engage, 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($total_provisoire - $total_engage, 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($total_ordonnance, 3, '.', ' '); ?></td>
                                            <td><?php echo number_format($total_paye, 3, '.', ' '); ?></td>
                                            <td style="text-align: center;">
