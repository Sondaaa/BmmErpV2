                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($document_budgets as $db): ?>
                                        <?php if ($db->getAnnule() == false || $db->getAnnule() == null): ?>
                                            ...
                                            <?php $document_achat = $piecejointbudget->getDocumentachat(); ?>
                                            <?php
                                            ...
                                            <tr <?php if (!($document_budget_provisoire) && !($document_budget_engage)): ?>style="background-color: #ffdcdc"<?php endif; ?>>
                                                ...
                                                <td style="padding-left: 20px; color: #006ea6;"><?php echo $document_achat->getFournisseur(); ?></td>
                                                <td style="text-align: right;"><?php if ($db->getIdType() == 3) echo number_format($mnt_provisoire, 3, '.', ' '); ?></td>
                                                <td style="text-align: right;"><?php if ($db->getIdType() == 1) echo number_format($mnt_engage, 3, '.', ' '); ?></td>
