<fieldset>
    ...
    <table id="budget_rubrique" name="tr_table" table_rubrique="">
        ...
        <tbody id="tbody_rubrique">
            ...
            <?php foreach ($rubriques as $rubrique): ?>
                <?php include_partial('ligprotitrub/ligne_prototype', array('rubrique' => $rubrique)); ?>
    ...
    <input type="button" value="Enregistrer prototype" onclick="ValiderSousDetail(<?php echo $formdetail->getObject()->getId() ?>, 1)">
       
            <a href="<?php echo url_for('prototype') ?>" class="btn btn-white btn-primary">
            ...
            if ($("#ligprotitrub_nordre").val() != '') {
                ...
                if (trouve == 0) {
                    ...
                    if (verif_montant) {
                        ...
                        $.ajax({
                            url: '<?php echo url_for('ligprotitrub/ajouterPrototype') ?>',
                            data: 'id=' + id +
