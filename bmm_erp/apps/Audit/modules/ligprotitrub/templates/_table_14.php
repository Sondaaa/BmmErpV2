...
<div class="col-md-12 annexe_type" id="div_add_annexe_<?php echo $type; ?>" style="margin-bottom: 15px;">
    <div class="col-md-12">
        <legend>
            <span style="font-size: 16px;">إكساء الأعوان</span>
    ...
    <div class="col-md-12" name="for_save_annexe" id="for_save_annexe_<?php echo $type; ?>">
        ...
        <?php else: ?>
            <table style="margin-bottom: 0px;">
                <thead>
                    <tr style="font-size: 12px;">
                        <th style="width: 15%; text-align: center;">الكلفة الجملية</th>
                        <th style="width: 15%; text-align: center;">السعر الفردي</th>
                        <th style="width: 10%; text-align: center;">العدد الجملي</th>
                        <th style="width: 10%; text-align: center;">عدد الأعوان</th>
                        <th style="width: 10%; text-align: center;">الكمية / الفرد</th>
                        <th style="width: 25%; text-align: center;">نوعية اللباس</th>
                    ...
                    <tr name="tr_for_add">
                        ...
                        <th><input id="<?php echo $type; ?>_prix" class="align_right" type="text" value="" onkeyup="setTotalLigneAnnexeType<?php echo $type; ?>()"></th>
                        <th><input id="<?php echo $type; ?>_nombre" class="align_center" type="text" value="" readonly="true"></th>
                        <th><input id="<?php echo $type; ?>_agent" class="align_center" type="text" value="" onkeyup="setTotalLigneAnnexeType<?php echo $type; ?>()"></th>
                        <th><input id="<?php echo $type; ?>_quantite" class="align_center" type="text" value="" onkeyup="setTotalLigneAnnexeType<?php echo $type; ?>()"></th>
                        <th><input id="<?php echo $type; ?>_type" type="text" value=""></th>
            ...
            <table style="margin-bottom: 0px;">
                <thead>
                    <tr>
                        <th style="text-align: center; width: 15%;"><input type="text" class="align_right" id="total_total_<?php echo $type; ?>" value="0.000" readonly="true"></th>
                    ...
                    <tr>
                        ...
                        <th style="text-align:center;">مبلغ مصحح</th>
                    </tr>
                </thead>
            </table>
    ...
    <script  type="text/javascript">
        ...
        function addligne<?php echo $type; ?>() {
            if ($("#<?php echo $type; ?>_total").val() != '' && $("#<?php echo $type; ?>_type").val() != '' && $("#<?php echo $type; ?>_numero").val() != '') {
                ...
                tr_html = tr_html + '<td name="<?php echo $type; ?>_prix" style="text-align:right;">' + $("#<?php echo $type; ?>_prix").val() + '</td>';
                tr_html = tr_html + '<td name="<?php echo $type; ?>_nombre" style="text-align:center;">' + $("#<?php echo $type; ?>_nombre").val() + '</td>';
                tr_html = tr_html + '<td name="<?php echo $type; ?>_agent" style="text-align:center;">' + $("#<?php echo $type; ?>_agent").val() + '</td>';
                tr_html = tr_html + '<td name="<?php echo $type; ?>_quantite" style="text-align:center;">' + $("#<?php echo $type; ?>_quantite").val() + '</td>';
                tr_html = tr_html + '<td name="<?php echo $type; ?>_type" style="text-align:right;">' + $("#<?php echo $type; ?>_type").val() + '</td>';
                ...
                $('#<?php echo $type; ?>_prix').val('');
                $('#<?php echo $type; ?>_nombre').val('');
                $("#<?php echo $type; ?>_agent").val('');
                $("#<?php echo $type; ?>_quantite").val('');
                $("#<?php echo $type; ?>_type").val('');
        ...
        function setTotalLigneAnnexeType<?php echo $type; ?>() {
            if ($("#<?php echo $type; ?>_quantite").val() != '' && $("#<?php echo $type; ?>_agent").val() != '') {
                var agent = parseFloat($('#<?php echo $type; ?>_agent').val());
                var quantite = parseInt($('#<?php echo $type; ?>_quantite').val());
                var total = parseInt(parseInt(agent) * parseInt(quantite));
                $('#<?php echo $type; ?>_nombre').val(parseInt(total));
            } else {
                $('#<?php echo $type; ?>_nombre').val('');
            }

            if ($("#<?php echo $type; ?>_nombre").val() != '' && $("#<?php echo $type; ?>_prix").val() != '') {
                var montant = parseFloat($('#<?php echo $type; ?>_prix').val());
        ...
        function editLigneExemple<?php echo $type; ?>(id) {
            ...
            $("#<?php echo $type; ?>_prix").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(1)').html().trim());
            $("#<?php echo $type; ?>_nombre").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(2)').html().trim());
            $("#<?php echo $type; ?>_agent").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(3)').html().trim());
            $("#<?php echo $type; ?>_quantite").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(4)').html().trim());
            $("#<?php echo $type; ?>_type").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(5)').html().trim());
