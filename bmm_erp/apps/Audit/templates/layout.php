<?php if ($sf_user->isAuthenticated()) : ?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?php echo sfconfig::get('sf_appdir') ?>assets/css/fullcalendar.min.css" />
        <!-- ace styles -->
    ...
    <body class="no-skin" ng-app="Appdoc">
        ...
        <div id="my-modaledition-planning" class="modal fade" tabindex="-1" style="width: 1200px">
        ...
        <script src="<?php echo sfconfig::get('sf_appdir') ?>assets/js/fullcalendar.min.js"></script>
        <script src='<?php echo sfconfig::get('sf_appdir') ?>assets/js/main.js'></script>
        <script src='<?php echo sfconfig::get('sf_appdir') ?>assets/js/locales-all.js'></script>
        ...
        <script>
            ...
            $('.nav-list').attr('style', 'margin: 0 0 0px 0px !important;');
            ...
            //Rest Button style
            $('input:submit').not('[id="btnvaliderPersonnelle"]').addClass('btn btn-white btn-success');
            ...
            //Td action
            $(".sf_admin_td_actions").attr('style', 'display:ruby;list-style: none;margin-bottom:0px;margin-left:10px;');
            ...
            $('input:text[id!="delai"]').not('[id="mission_heurearrive"]').not('[id="mission_heuresortie"]').not('[id="formulaire_nbrponitsjour"]').not('[id="formulaire_nbpointmois"]').not('[id="formulaire_dureejou"]').not('[id="formulaire_dureemois"]').not('[id="demandederemboursement_signature"]').not('[id="demandederemboursement_bloc"]').not('[id="hopital1"]').not('[data-width="fixed"]').not('[id="idprime"]').not('[id="idlieu"]').not('[id="iddebut_agent"]').not('[id="id"]').not('[id="idagents-conge"]').not('[id="idsousrubrique1"]').not('[id="idunite1"]').not('[id="idsituation"]').not('[id="idrubrique1"]').not('[id="iddoma"]').not('[id="idFormat"]').not('[id="idorg"]').not('[id="idagents"]').not('[id="idunite-formation"]').not('[id="idrubrique"]').not('[id="idsousrubrique"]').not('[id="idorganisme"]').not('[id="idFormateur"]').not('[id="idposition"]').not('[id="idechelle"]').not('[id="idechelon"]').not('[id="idcategorie"]').not('[id="idcorps"]').not('[id="idgrade"]').not('[id="idfin"]').not('[id="iddirection_agent"]').not('[id="iddirection"]').not('[id="idposte"]').not('[id="idfonction"]').not('[id="idfonction-agent"]').not('[id="idfonction-formation"]').not('[id="idsousdirection_rh"]').not('[id="idservice"]').not('[id="idunite"]').not('[data="fonctionnaire"]').not('[data="ouvrier"]').attr('style', 'width: 100%;');
        ...
        <script src="<?php echo sfconfig::get('sf_appdir') ?>js/AngularCtrl/CtrlCaisse.js"></script>
        ...
        <script src="<?php echo sfconfig::get('sf_appdir') ?>js/AngularCtrl/CtrlStatistique.js"></script>
        ...
        <!--<script src="<?php //  echo sfconfig::get('sf_appdir')  
                            ?>js/AngularCtrl/CtrlPaie.js"></script>-->
