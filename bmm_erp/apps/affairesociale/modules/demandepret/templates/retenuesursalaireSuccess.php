        ...
        <div class="widget-box">
            ...
            <div class="widget-body">
                <div class="widget-main" style="min-height: 200px;" ng-init="InitialiserSociete()"><!-- -->
                    ...
                    <fieldset>
                        <legend>Formulaire pour la societe</legend>
                        <table>
                            <tr>
                                <td>Societe</td>
                                <td class="disabledbutton">
                            ...
                            <tr>
                                ...
                                <td class="disabledbutton">
                                    ...
                                    <input type="text" ng-model="dateemposte.text" id="dateemposte" placeholder="Date emposte"   class="form-control">
                                </td>
                                <td class="disabledbutton">
                    ...
                    <fieldset>
                        <table>
                            <tr>
                                <td>Date debbut Retenue Prêt</td>
                                <td>
                        ...
                        <table>
                            <thead>
                                <tr style="background: #ffdcdc">
                                    ...
                                    <th style="width: 20%">Montant Mensielle</td>
                                    <th style="width: 20%">Date Fin Retenue</td>
                                </tr>
                            </thead>
                            <tbody>
