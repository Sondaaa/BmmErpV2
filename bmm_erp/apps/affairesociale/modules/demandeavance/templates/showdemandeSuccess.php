                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="demandeavance[mois]" id="demandeavance_mois" >
                                        <option <?php if ($demandeavance->getMois() == '1'): ?>selected="true"<?php endif; ?> value="01">Janvier</option>
                                        <option <?php if ($demandeavance->getMois() == '2'): ?>selected="true"<?php endif; ?> value="02">Février</option>
                                        <option <?php if ($demandeavance->getMois() == '3'): ?>selected="true"<?php endif; ?> value="03">Mars</option>
                                        <option <?php if ($demandeavance->getMois() == '4'): ?>selected="true"<?php endif; ?> value="04">Avril</option>
                                        <option <?php if ($demandeavance->getMois() == '5'): ?>selected="true"<?php endif; ?> value="05">Mai</option>
                                        <option <?php if ($demandeavance->getMois() == '6'): ?>selected="true"<?php endif; ?> value="06">juin</option>
                                        <option <?php if ($demandeavance->getMois() == '7'): ?>selected="true"<?php endif; ?> value="07">Juillet</option>
                                        <option <?php if ($demandeavance->getMois() == '8'): ?>selected="true"<?php endif; ?> value="08">Août</option>
                                        <option <?php if ($demandeavance->getMois() == '9'): ?>selected="true"<?php endif; ?> value="09">Septembre</option>
                                        <option <?php if ($demandeavance->getMois() == '10'): ?>selected="true"<?php endif; ?> value="10">Octobre</option>
                                        <option <?php if ($demandeavance->getMois() == '11'): ?>selected="true"<?php endif; ?> value="11">Nouvembre</option>
                                        <option <?php if ($demandeavance->getMois() == '12'): ?>selected="true"<?php endif; ?> value="12">Décembre</option>
                                    </select>
                                </td>
                                <td>Anée</td>
                                <td>
