<div id="sf_admin_container">
    <h1>Demande Paiement Anticipé</h1>
</div>
<div class="col-md-12">
...
//                        $agents = AgentsTable::getInstance()->getAgentsRetenue();
                ...
                <table>
                    ...
                    <tr id="formligne">
                        ...
                        <td> 
                            <input type="text" value="" ng-model="reference.text" id="reference" autocomplete="off" class="align_center" placeholder="Reference">
                        </td>
                    </tr>
                    <tr style="background: repeat-x #F2F2F2;background-image: linear-gradient(to bottom,#F8F8F8 0,#ECECEC 100%);">
                        <th style="width: 10%">Date Reçue </th>
                        <th style="width: 10%">Date début Retenue</th>
                        <th style="width: 10%">Date Fin Retenue</th>
                        <th style="width: 15%">Montant Payé</th>
                        <th style="width: 15%">Nbr mois payé</th>
                    ...
                    <tr>
                        <td> 
                            <input type="date" value="" ng-model="daterecue.text" id="daterecue" autocomplete="off" class="form-control" placeholder="Date Reçue ">
                        </td>
                        <td class="disabledbutton"> 
                    ...
                    <tbody ng-repeat="ligne in Listepaiement">
                        <tr>
                            ...
                            <td style="text-align: center;">{{ligne.reference}}</td>
                        </tr>
                        <tr>
                            <td style="text-align: center;">{{ligne.daterecue}}</td>
