        ...
        <table cellspacing="0">
            ...
            <tbody>
                <?php foreach ($configuration->getFormFilterFields($form) as $name => $field): ?>
                    ...
                    <?php
                    include_partial('tenues/filters_field', array(
                        'name' => $name,
    ...
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            <div class="widget-main" style="padding: 5%; text-align: center;">
                <a href="<?php echo url_for('tenues/new') ?>" class="btn btn-outline btn_new btn-success" style="text-align: center; font-size: 14px !important; " >Nouvelle Affectation  Tenue  de Travail</a>  
                <br><br>
...
<script  type="text/javascript">
    function printListtenue() {
        ...
        if ($('#tenues_filters_id_typetenue').val() != '')
        {
            if (url == '')
                url = '?id_typemission=' + $('#tenues_filters_id_typemission').val();
            else
                url = url + '&id_typemission=' + $('#tenues_filters_id_typemission').val();
        }
