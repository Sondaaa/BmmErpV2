<?php if ($sf_user->isAuthenticated()) : ?>
    ...
    <body class="no-skin" ng-app="Appdoc">
        ...
        <script>
            ...
            $('td button').not('[class="btn btn-primary btn-xs"]').not('[class="btn btn-xs btn-danger btn-xs"]').attr('class', 'btn btn-xs btn-success');
            //Rest Button style
            ...
            $('input:date[id!="datemax"]').attr('style', 'width: 35%;');
