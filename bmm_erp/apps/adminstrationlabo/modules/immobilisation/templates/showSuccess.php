            ...
            <div id="sf_admin_content">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <!--<td><?php //if($immo->getPlancomptable() && $immo->getPlancomptable()->getNumerocompte() ) echo $immo->getPlancomptable()->getNumerocompte(); 
                                        ?></td>-->
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><label>Validation Fiche Par le Comptable</label></td>
                                <td colspan="3">
                                    <?php
                ...
                <table>
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                &nbsp;<a class="btn btn-xs btn-success" href="<?php echo url_for('immobilisation/index') ?>">Liste d'immob.</a>
                                &nbsp;<a class="btn btn-white btn-primary" href="<?php echo url_for('immobilisation/ImprimerFiche') . '?id='  . $immo->getId()  ?>">Imprimer</a>
                            </td>
                        </tr>
                    </tfoot>
                </table>
