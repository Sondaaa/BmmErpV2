            ...
            <form>
                <table class="table table-bordered table-hover" cellspacing="0">
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                <a href="<?php echo url_for('@demandeur') ?>" class="btn btn-xs btn-success">Effacer</a>
                    ...
                    <tbody>
                        ...
                        <!-- <tr class="sf_admin_form_row sf_admin_text ">
                            <td><label for="demandeur_filters_id_projet">Projet</label></td>
                            <?php $projets = ProjetTable::getInstance()->findAll();?>
                            <td>
                                <select id="demandeur_filters_id_projet" name="demandeur_filters[id_projet]" class="chosen-select form-control" style="width: 100%;">
                                    <option value=""></option>
                                    <?php //foreach ($projets as $projet) : ?>
                                        <option value="<?php //echo $projet->getId() ?>">
                                            <?php // echo $projet->getLibelle() ; ?>
                                        </option>
                                    <?php //endforeach; ?>
                                </select>
                            </td>
            ...
            <div class="widget-body">
                <div class="widget-main" style="padding: 5%; text-align: center;">
                    ...
                    <button style="font-size: 14px !important; font-weight: bold !important;" 
                            onclick="printListDemandeur()" class=" btn btn-xs btn-danger">
                        <i class="ace-icon fa fa-print bigger-110"></i> Imprimer Liste des Demandeurs
                    </button>
                    <br><br>
                    <a  href="<?php echo url_for('demandeur/exporterDemandeurExcel') 
    ...
    <div class="col-xs-12">
        ...
        <div>
            <table id="listDemandeur">
                <thead>
                    <tr>
                        <th style="width: 40%; ">Demandeur</th>
...
<script type="text/javascript">
    ...
    function Printdemandeur(id) {
        var url = '';
        if (id) {
            url = '?id=' + id;
        }
        url = '<?php echo url_for('demandeur/ImprimerfichedemandeurLabo') ?>' + url;
        window.open(url, '_blank');
        win.focus();
    }
</script>
