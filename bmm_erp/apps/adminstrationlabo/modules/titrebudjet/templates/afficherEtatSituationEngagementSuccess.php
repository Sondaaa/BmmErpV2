<div class="col-xs-12">
    ...
    <table id="liste_recap" class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            $date_antecedent = $annee . '-' . $mois_anterieur . '-01';
            ...
            <?php foreach ($listes as $liste) : ?>
                ...
                <?php $montant_ordonnance_courant_ruprique = DocumentbudgetTable::getInstance()->getMontantCourantRubriqueByLigprotitrub($date_antecedent, $date_fin, $liste->getId()); ?>
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-size: 12px;"><b><?php echo number_format($montant_ordonnance_antecedent_rub, 3, '.', ' '); ?></b></td>
                    <td style="text-align: right; font-size: 12px;"><b><?php echo number_format($mnt_courant_rub_sans, 3, '.', ' '); ?></b></td>
                    <td style="text-align: right; font-size: 12px; background-color: #d9edf7;"><b><?php echo number_format($montant_ordonnance_antecedent_rub + $mnt_courant_rub_sans, 3, '.', ' '); ?></b></td>

                    <td style="text-align: right; font-size: 12px; background-color: #fdffd5;"><b><?php echo number_format(($liste->getMnt() + $mnt_transfert_final) - ($montant_ordonnance_antecedent_rub + $mnt_courant_rub_sans), 3, '.', ' '); ?></b></td>
                    ...
                    <td style="text-align: right; font-size: 12px; background-color: #f2dede;"><b><?php echo number_format($montant_ordonnance_antecedent_rub + $mnt_courant_rub_sans - ($montant_paiement_anterieur_rub + $montant_paiement_courant_rubsousrubrique), 3, '.', ' ') ?></b></td>
                </tr>
                <?php $sous_listes = LigprotitrubTable::getInstance()->getSousrubriqueByTitreBudget($titre, $liste->getIdRubrique()); ?>
                <?php foreach ($sous_listes as $sous_liste) : ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-size: 11px;"><?php echo number_format($sous_liste->getMntEngage(), 3, '.', ' '); ?></td>
                        <td style="text-align: right; font-size: 11px; background-color: #d9edf7;"><?php echo number_format($montant_ordonnance_antecedent_sous_liste->getMnt() + $sous_liste->getMntEngage(), 3, '.', ' '); ?></td>
                        <td style="text-align: right; font-size: 11px; background-color: #fdffd5;"><?php echo number_format(($sous_liste->getMnt() + $sous_liste->getMntexterne() + $sous_liste->getMntretire()) - ($montant_ordonnance_antecedent_sous_liste->getMnt() + $sous_liste->getMntEngage()), 3, '.', ' '); ?></td>
                        <td style="text-align: right; font-size: 11px;"><?php echo number_format($montant_paiement_anterieur_sous_liste->getMnt(), 3, '.', ' '); ?></td>
                    ...
                    $mnt_engage_payer_sous = $mnt_engage_payer_sous + $montant_ordonnance_antecedent_sous_liste->getMnt() + $sous_liste->getMntEngage() - ($montant_paiement_anterieur_sous_liste->getMnt() + $montant_paiement_courant_sous_liste->getMnt());
                    
                endforeach;
                $mnt_engage_courant = $mnt_engage_courant + $mnt_courant_rub_sans;
