                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>Prototype Ou Budget Prévisionnel Global</label>
                                                <?php

                                                $budget_titre = new Titrebudjet();
                                                $prototype = Doctrine_Core::getTable('titrebudjet')
                                                    ->createQuery('a')->AndWhere("trim(typebudget) like trim('" . "Prototype" . "') or trim(typebudget) like trim('" . "Budget Prévisionnel Global" . "')")
