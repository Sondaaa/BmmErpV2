    ...
    <div class="col-sm-12">
        ...
        <fieldset style="margin-top: 20px;" class="col-md-6 pull-right">
            ...
            <?php if (trim($titrebudjet->getTypebudget()) == "Prototype"): ?>
                <a class="btn btn-xs btn-success" href="<?php echo url_for('titrebudjet/index?type=prototype') ?>">Retour à la Liste</a>
            <?php else: ?>
                <a class="btn btn-xs btn-success" href="<?php echo url_for('@titrebudjet') ?>">Retour à la Liste</a>
            <?php endif; ?>
        </fieldset>
    </div>
</div>
