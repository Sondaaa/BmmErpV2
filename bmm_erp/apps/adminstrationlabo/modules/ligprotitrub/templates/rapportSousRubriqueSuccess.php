                ...
                <form>
                    <table style="margin-bottom: 0px;" class="table table-bordered table-hover" cellspacing="0">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="2">
                                    <a onclick="" href="<?php echo url_for('ligprotitrub/rapportSousRubrique') ?>" class="btn btn-xs btn-success">Effacer</a>
                                    <input type="submit" value="Filtrer" class="btn btn-xs btn-success" onclick="detailSousRubrique()">
                                </td>
                            </tr>
                        </tfoot>
                    </table>
