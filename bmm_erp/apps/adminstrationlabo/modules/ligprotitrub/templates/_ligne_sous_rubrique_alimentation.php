...
<tr>
    ...
    <td style="width: 40%; font-size: 12px;">
        <table>
            ...
            <?php $sous_rubriques = LigprotitrubTable::getInstance()->getSousRubrique($sous_rubrique->getIdRubrique(), $sous_rubrique->getIdTitre(),$tranche->getId()); ?>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php foreach ($sous_rubriques as $s_rubrique): ?>
                                    <?php include_partial('ligprotitrub/ligne_sous_rubrique_alimentation', array('tranche'=>$tranche,'sous_rubrique' => $s_rubrique, 'index' => $id)); ?>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                    </td>
