<form>
    <fieldset>
        ...
        <input id="libelle_edit" style="width: 100%;" placeholder="Libellé exercice budgétaire" readonly="true" type="text" value="<?php echo $exercice->getLibelle() ?>" />
    </fieldset>
    <br>
    <fieldset>
        <div class="col-xs-6">
            <label>Date Ouverture :</label>
            <input id="date_debut_edit" style="width: 100%;" type="date" value="<?php echo $exercice->getDateDebut() ?>" onchange="setLibelleEdit()" />
        </div>
        <div class="col-xs-6">
            <label>Date Clôture :</label>
            <input id="date_fin_edit" style="width: 100%;" type="date" value="<?php echo $exercice->getDateFin() ?>" />
        </div>
    </fieldset>
