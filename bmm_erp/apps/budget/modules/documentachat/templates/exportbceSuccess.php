...
<!--<li class="<?php // if ($tab == "") echo 'active'                   ?>"><a href="#home" data-toggle="tab" aria-expanded="true">Détail </a></li>-->
                <li class="<?php if ($tab != "3") echo 'active' ?>"><a href="#profilep" data-toggle="tab" ng-controller="CtrlDemandeprix" ng-click="InialiserDemandePrix()" aria-expanded="false">Fiche B. C. Externe (système) Provisoire</a></li>
                <li class="<?php if ($tab == "3") echo 'active' ?>"><a href="#profile" data-toggle="tab" aria-expanded="false" ng-controller="CtrlDemandeprix" ng-click="InialiserDemandePrix();
                            AfficheDocBCEP('<?php echo $ids; ?>')">Fiche B. C. Externe</a></li>
...
<!--                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="datecreation_p" value="<?php echo $_SESSION['exercice_budget'] . date('-m-d'); ?>" min="<?php echo $_SESSION['exercice_budget'] . "-01-01"; ?>" max="<?php echo $_SESSION['exercice_budget'] . "-12-31"; ?>" type="date">
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <div style="padding: 1%;width: 60%;font-size: 16px;float: left">
                        ...
                        <table style="list-style: none; margin-top: 116px;" class="table table-striped table-bordered table-hover">
                            <tr>
                                <td>
                                    <table style="margin-bottom: 0px;">
                                        <tr>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr ng-repeat="lignedoc in lignedocsdeponsep">
                                    ...
                                    <td><p style="border-bottom: #000 dashed 1px !important"><input type="text" class="form-control align_center" style="" id="qte_p_{{lignedoc.norgdre}}" value="{{lignedoc.qte|integer}}" ordre="{{lignedoc.norgdre}}" provisoire="p_" onchange="miseAjour(this)">{{lignedoc.unitedemander}}</p></td>
                                    <td><p style="border-bottom: #000 dashed 1px !important"><input type="text" class="form-control align_center" style="" id="puht_p_{{lignedoc.norgdre}}" value="{{lignedoc.puht}}" ordre="{{lignedoc.norgdre}}" provisoire="p_" onchange="miseAjour(this)"></p></td>
                                    <td>
                                        <p style="border-bottom: #000 dashed 1px !important">
                                            <select id="tva_p_{{lignedoc.norgdre}}" ordre="{{lignedoc.norgdre}}" provisoire="p_" onchange="miseAjour(this)">
...
<!--                                        <tr>
                                        ...
                                        <tr>
                                            <td>Date de création</td>
                                            <td>
                                                <input id="datecreation" value="<?php echo $_SESSION['exercice_budget'] . date('-m-d'); ?>" min="<?php echo $_SESSION['exercice_budget'] . "-01-01"; ?>" max="<?php echo $_SESSION['exercice_budget'] . "-12-31"; ?>" type="date">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Max Date de réponse</td>
                            ...
                            <tr>
                                <td>
                                    <table style="margin-bottom: 0px;">
                                        <tr>
                                            <td>Montant Total TTC :</td>
                                            <td><input class="align_right" type="text" id="total_ttc" value="" readonly="true" /></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
...
<!--                                <tr>
                                ...
                                <tr ng-repeat="lignedoc in lignedocsdeponse" >
                                    ...
                                    <td><p style="border-bottom: #000 dashed 1px !important"><input type="text" class="form-control" style="" id="puht_{{lignedoc.norgdre}}" value="{{lignedoc.mntht}}" ordre="{{lignedoc.norgdre}}" provisoire="" onchange="miseAjour(this)"></p></td>
                                    <td>
                                        <p style="border-bottom: #000 dashed 1px !important">
                        ...
                        <div id="btnvalider_bdcd" class="disabledbutton">
                            <input type="button" value="Enregistrer" ng-model="btnvalider" class="btn btn-primary" ng-click="ValiderBondexterne('<?php echo $ids; ?>', '')"> 
                        </div>
                    </div>
                </div>
