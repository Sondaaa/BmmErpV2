    ...
    <div id="sf_admin_content">  
        ...
        <fieldset style="margin-left: 50%;">
            ...
            <div>
                ...
                <a  style="font-size: 18px" class="btn btn-outline btn-primary1" href="<?php echo url_for('documentachat/valideretenvoyer') . '?iddoc=' . $documentachat->getId() . '&btn=envoyer' ?>">Envoi à l'unité <?php if ($documentachat->getIdTypedoc() != 9)
                        echo 'achat';
                    else
                        echo 'marches';
                    ?>  </a>
