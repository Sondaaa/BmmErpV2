<div id="sf_admin_container">
    ...
    <div id="sf_admin_content" ng-controller="myCtrldocvisa">  
        ...
        <fieldset id="zone_avis_budgetaire">
            ...
            <table style="float: left; width: 83%;">
                <tbody>
            ...
            <table ng-repeat="visa in visadonnees" style="border: none !important; background: none !important; float: right; width: 17%; margin-top: -5px;">
                <tr>
                    <td style="border: none !important; padding: 0px; text-align: center;">
                        <img src="<?php echo sfconfig::get('sf_appdir') . "uploads/images/" ?>{{visa.chemin}}" style="width: 120px;">
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center; border: none !important; padding: 5px;">{{visa.ag}}</td>
                </tr>
                <tr>
                    <td style="text-align: center; border: none !important; padding: 5px; font-size: 16px;" ng-class="{etat_valide: {{visa.etatvalide}} == false, etat_non_valide: {{visa.etatvalide}} == true}">{{visa.datevisa| date:'dd/MM/yyyy'}}</td>
                </tr>
            </table>
            <?php if ($documentachat->getEtatdocachat() != ''): ?>
                ...
                <?php if ($docachat_annulation): ?>
                    <legend style="color: red;">B.C.I Annulé</legend>
                    ...
                    foreach ($listesdocuments as $lignedoc) {
                        ...
                        <tr>
                            ...
                            <td><?php echo $qtees ?>|<?php echo $qteep ?><br>
                                <input class="input_quantite" type="text" <?php if ($documentachat->getEtatdocachat() != ''): ?>readonly="true"<?php endif; ?> id="input_qte_pe<?php echo $lg->getId() ?>" value="<?php echo $qteea ?>">
                            </td>
                            <td>
        ...
        <fieldset style="margin-left: 50%;">
            ...
            <div>
                <a id="btn_ajout" class="btn btn-outline btn-danger disabledbutton" href="<?php echo url_for('documentachat/validervisa?iddoc=') . $documentachat->getId() . '&btn=valider' ?>">Enregistrer </a>
            </div>
        </fieldset>
    </div>
</div>
...
<style>
    ...
    .etat_valide {color: #b05454;}
    .etat_non_valide {color: #4d8e4d;}
