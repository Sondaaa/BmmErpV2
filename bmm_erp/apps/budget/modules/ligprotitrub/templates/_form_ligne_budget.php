        ...
        <?php if (!$formdetail->getObject()->getEtatbudget() || $formdetail->getObject()->getEtatbudget() != 2): ?>
            <?php if ($typebudget != 'Prototype'): ?>
                ...
                <?php if ($formdetail->getObject()->getEtatbudget() == 1): ?>
                    <input type="button" value="Enregistrer & Clôturer Fiche budget" onclick="ValiderSousDetail('<?php echo $formdetail->getObject()->getId() ?>', '3')">
                <?php endif; ?>
            <?php else: ?>
                ...
                <input type="button" value="Valider & Clôturer Fiche budget" onclick="ValiderSousDetail('<?php echo $formdetail->getObject()->getId() ?>', '2')">
            <?php endif; ?>
        <?php endif; ?>
