        ...
        <form action="" method="post">
            <table cellspacing="0">
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('Documents/bondefinitifContrat') ?>">Effacer</a>
                    ...
                    <table id="dynamic-table">
                        ...
                        <tbody>
                            ...
                            foreach ($boncommandeexterne as $bcex) {
                                ...
                                ?>
                                <tr>
                                    <td><?php echo date('d/m/Y', strtotime($boncomm->getDatecreation())) ?></td> 
                                    <td>
                                        ...
                                        <div id="bci_model<?php echo $boncomm->getId() ?>" class="modal fade" tabindex="-1">
                                            <div class="modal-dialog" style="width: 84%">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <?php echo html_entity_decode($boncomm->getBonCommandeInterne()); ?>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button class="btn btn-sm btn-danger pull-right" data-dismiss="modal">
                                                            <i class="ace-icon fa fa-times"></i>
                                    ...
                                    <td><?php echo html_entity_decode($boncomm->getFactureOuQuittanceParBceOuBdc()); ?>
                                    </td>
                                    <td>
                                        <?php
                                        ...
                                        if ($boncomm->getSignatureParDocumentBCE()) {
                                            ?>
                                            <a href="<?php echo url_for('Documents/preengagementContrat') . '?id=' . $boncomm->getId(); ?>">Transformer Engagment Prov. en Définitif</a>
                                            <?php
                                            if ($boncomm->getIdTypedoc() == 7)
