        ...
        <form action="" method="post">
            <table cellspacing="0" style="margin-bottom: 0px;">
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('Documents/indexfrsBDC') ?>">Effacer</a>
                    ...
                    <table >
                        ...
                        <tbody>
                            ...
                            foreach ($boncommandeexterne as $bcex) {
                                $boncomm = $bcex;
                                $quitance = LigneoperationcaisseTable::getInstance()->findByIdDocachat($boncomm->getId());
                                $ligprotitrub = $boncomm->getDocumentparent()->getLigavisdoc()->getFirst()->getLigprotitrub();
                                ?>
                                <tr>
                                    <td style="text-align: center;">
                                        <input type="checkbox" id="check_<?php echo $boncomm->getId() ?>" ng-click="ValiderChoisirBDC(<?php echo $boncomm->getId() ?>, '<?php echo $quitance->getFirst()->getMntoperation() ?>', '<?php echo $ligprotitrub->getId() ?>', '<?php echo $ligprotitrub->getIdTitre() ?>')">  
                                    </td>
                                    ...
                                    <td style="width: 9%; text-align: right;">
                                        <?php // if (sizeof($quitance) == 0): ?>
                                        <?php if ($boncomm->getMht()) echo number_format($boncomm->getMht(), 3, '.', ' '); ?>
                                        <?php // endif; ?>
                                    </td> 
                                    <td style="width: 9%; text-align: right;">

                                        <?php // if (sizeof($quitance) == 0): ?>
                                        <?php if ($boncomm->getMnttva()) echo number_format($boncomm->getMnttva(), 3, '.', ' '); ?>

                                        <?php // endif; ?>
                                    </td> 
                                    <?php if (sizeof($quitance) >= 1): ?>
                                        <td style="width: 9%; text-align: right;"><?php echo number_format($quitance->getFirst()->getMntoperation(), 3, '.', ' '); ?></td> 
                                    <?php else: ?>
                                                    ...
                                                    <tr class="disabledbutton">
                                                        <td>  <?php //                                                            echo ($ligne->getMnt().'devdddddddd');       ?>
                                                            <ul>
                                                                ...
                                                                <li>Bloqué: <input type="text" class="form-control align_right" value="<?php // if ($ligne && $ligne->getIdTitre()) echo number_format($ligne->getMntencaisse(), 3, ',', ' ');      ?>" id="mntencaisser" ></li>

                                                            </ul>
                                                        </td>
                                                        <td>
                                                            <ul>
                                                                <li>Définitif: <input type="text" class="form-control align_right" value="<?php if ($ligne && $ligne->getIdTitre() && $ligne->getMntengage()) echo number_format($ligne->getMntengage(), 3, '.', ','); ?>" id="credit"></li>
                                                                ...
                                                                <?php $total = floatval($ligne->getMntengage()) + floatval($ligne->getMntprovisoire()); ?>
                                                                <li>Total: <input type="text" class="form-control align_right" value="<?php echo number_format($total, 3, ',', ' '); ?>" id="total_engage" ></li>
                                                            </ul>
                                                        </td>
                                                        <td>
                                                            <?php
...
//                                                            $relicatprovisoire = number_format($ligne->getMntencaisse() - $mntprovisoire, 3, ',', '.');
                                                            $relicatprovisoire = number_format($ligne->getMnt() - $mntprovisoire, 3, ',', ' ');
//                                                            $relicat = $ligne->getMntencaisse() - $mntengager;
                                                            $relicat = $ligne->getMnt() - $mntengager;
                                                            $relicatprvisoire_defi = $relicat - $relicatprovisoire;
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>Provisoire + Définitif : <input type="text" class="form-control align_right" value="<?php echo number_format($relicatprvisoire_defi, 3, ',', ' '); ?>" id="reliqprovisoire"></li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="modal-footer">
                            <button ng-click="AjouterParDocPreengagementBDCNULL()" class="btn btn-sm btn-success pull-right"  style="margin-left: 1%">
