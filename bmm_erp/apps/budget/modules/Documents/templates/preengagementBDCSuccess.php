                        ...
                        if ($piece_joint_provisoire) {
                            ...
                            <div class="col-lg-12" style="margin-top: 20px;">
                                <fieldset>
                                    ...
                                    <object style="width: 100%;height: 900px;" data="<?php echo url_for('Documents/ImprimerprovisoireBDC') . '?iddoc=' . $documentfils->getId() . "&idfiche=" . $piece_joint_provisoire->getIdDocumentbudget() ?>" type="application/pdf">
                                        <embed src="<?php echo url_for('Documents/ImprimerprovisoireBDC') . '?iddoc=' . $documentfils->getId() . "&idfiche=" . $piece_joint_provisoire->getIdDocumentbudget() ?>" type="application/pdf" />
                                    </object>
                                </fieldset>
                            </div>
                            <?php
                        ...
                        <h4 style="height: 50px;"><?php
                            if ($documentachat->getIdFils()) {
                                ...
                                if ($documentfils) {
                                    ...
                                    ?> </h4> 
                                <?php if ($doc_achat->getIdTypedoc() == 7) { ?>
                                    <legend> <?php // echo "ANNEXE " . $numero;                ?></legend>
                                    <object style="width: 100%;height: 800px;" data="<?php echo url_for('Documents/ImprimerAnnexBCEP?iddoc=' . $doc_achat->getId()) ?>" type="application/pdf">
                                        <embed src="<?php echo url_for('Documents/ImprimerAnnexBCEP?iddoc=' . $doc_achat->getId()) ?>" type="application/pdf" />
                                    </object>


                                <?php } ?>
                                <?php if ($doc_achat->getIdTypedoc() == 2 || $doc_achat->getIdTypedoc() == 17) { ?>
                                    <object style="width: 100%;height: 800px;" data="<?php echo url_for('Documents/ImprimerAnnexebondeponseP?iddoc=' . $documentachat->getId()) ?>" type="application/pdf">
                                        <embed src="<?php echo url_for('Documents/ImprimerAnnexebondeponseP?iddoc=' . $documentachat->getId()) ?>" type="application/pdf" />
                                    </object>
                                <?php } ?>
                                <?php
                            }
                        ...
                        <h4 style="height: 50px;"><?php
                            if ($documentachat->getIdFils()) {
                                ...
                                if ($documentfils) {
                                    ...
                                    ?> 
                                    <!--N°:-->
                                    <?php // echo $documentfils->getNumerodocachat() ?></h4> 
                                <?php if ($doc_achat->getIdTypedoc() == 7) { ?>
                                    <legend> <?php // echo "ANNEXE " . $numero;                ?></legend>
                                    <object style="width: 100%;height: 800px;" data="<?php echo url_for('Documents/ImprimerAnnexebonexterne?iddoc=' . $documentfils->getId()) ?>" type="application/pdf">
                                        <embed src="<?php echo url_for('Documents/ImprimerAnnexebonexterne?iddoc=' . $documentfils->getId()) ?>" type="application/pdf" />
                                    </object>
                                <?php } ?>
                                <?php if ($doc_achat->getIdTypedoc() == 2 || $doc_achat->getIdTypedoc() == 17) { ?>
                                    <object style="width: 100%;height: 800px;" data="<?php echo url_for('Documents/ImprimerAnnexebondeponse?iddoc=' . $documentfils->getId()) ?>" type="application/pdf">
                                        <embed src="<?php echo url_for('Documents/ImprimerAnnexebondeponse?iddoc=' . $documentfils->getId()) ?>" type="application/pdf" />
                                    </object>
                                    <?php
                                }
                            }
                            ...
                            <tr>
                                ...
                                <td colspan="4" style="color: red">
                                    <table style="margin-bottom: 0px;">
                                        ...
                                        <?php
                                        // die($form->getObject()->getId().'gr'.$form->getObject()->getMnt() );!$form->getObject()->getMnt()
//                                        die($form->getObject()->getIdType() . 'eee');
                                        if ($documentfils && !$form->getObject()->isNew() && $form->getObject()->getIdType() == 3) {
                                            ?>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                $quitance = LigneoperationcaisseTable::getInstance()->findByIdDocachatAndIdCategorie($documentfils->getId(), 1);
                                                if (sizeof($quitance) >= 1) {
                                                    $dif = $documentachat->getMntttc() - $quitance->getFirst()->getMntoperation();
                                                }
                                                if ($diff > 0)
                                                ...
                                                ?>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                    <?php echo number_format(abs($dif), 3, ',', ' '); ?>
                                                    </td>
    ...
    <?php endif; ?>
                                            ...
                                            <tr style="background-color: #b6fdbb; color: #757575;">
                                                ...
                                                <td><?php echo number_format($ligne->getMntprovisoire(), 3, ',', ' ') . ' - ' . $quitance->getFirst()->getMntoperation() . ' = ' . number_format($ligne->getMntprovisoire() - $quitance->getFirst()->getMntoperation(), 3, ',', ' ') ?></td>
...
//                                                    echo number_format($relicatprovisoire, 3, ',', ' ') . ' + ' . number_format($mntprovisoire, 3, ',', ' ') . ' = ' . $mnt;
                                                ...
                                                <td>
                                                    <?php
                                                    $montrelcat = $relicat - $documentachat->getMntttc();
                                                    ...
                                                    ?>
                                                    <input type="text" value="<?php echo $montrelcat; ?>" id="relicat_total">
                ...
                <fieldset>
                    ...
                    <?php if ($doc_achat->getIdTypedoc() == 2 || $doc_achat->getIdTypedoc() == 17) { ?>
                        ...
                        <?php } if ($documentachat->ValidationEngagement() == 0 && $idpiece != 0 && $doc_achat->getIdTypedoc() == 2) { //&& !$form->getObject()->getMnt() ?>
                            <input  type="button" value="Valider Engagement" ng-click="ValiderEngagementBDC(<?php echo $documentachat->getId() ?>,<?php echo $form->getObject()->getId() ?>)">
                        <?php } ?>
                    <?php } ?>
                    <?php if (!$form->getObject()->isNew()) {
                        //&& $form->getObject()->getMnt()
                        ?>
