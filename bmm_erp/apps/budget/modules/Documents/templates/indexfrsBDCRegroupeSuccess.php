...
//                                die(sizeof($boncomm->getDocumentparent()->getLigavisdoc()).'mp');
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <input type="checkbox" id="check_<?php echo $boncomm->getId() ?>" ng-click="ValiderChoisirBDC(<?php echo $boncomm->getId() ?>, '<?php echo $boncomm->getMntttc() ?>', '<?php echo $ligprotitrub->getId() ?>', '<?php echo $ligprotitrub->getIdTitre() ?>')">  
                                    </td>
...
//                                                            $annees = $params['exercice'];
                                                    ...
                                                    <tr class="disabledbutton">
                                                        ...
                                                        <td>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>Provisoire + Définitive : <input type="text" class="form-control align_right" value="<?php echo $relicatprovisoire ?>" id="reliqprovisoire"></li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="modal-footer">
                            <button ng-click="AjouterParDocPreengagementDefinitif()" class="btn btn-sm btn-success pull-right"  style="margin-left: 1%">
