<a style="float: left;" href="#my-modal_<?php echo $boncomm->getIdTypedoc() ?>_<?php echo $boncomm->getId() ?>" role="button" data-toggle="modal">
    <?php
    echo $boncomm->getNumerodocachat();
    if ($boncomm->getDatesignature())
        echo "<br>" . date('d/m/Y', strtotime($boncomm->getDatesignature()));
    ?>
</a>
<?php
