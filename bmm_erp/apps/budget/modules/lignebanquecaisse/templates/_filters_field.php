        ...
        <td>
            ...
            <?php if ($name != "id_caissebanque" && $name != "id_budget") { ?>
                ...
                if ($name == "id_caissebanque") {
                    $banques = Doctrine_Core::getTable('caissesbanques')->findAll();
                    ?>
                                    ...
                                    <td>
                                        <table>
                                                ...
                                                <td>
                                                    ...
                                                    <select id="budget_param_compte">
                                                        ...
                                                        <?php foreach ($budgets as $budget) { ?>
                                                            ...
                                                            <?php
                                                            if ($ligne && $ligne->getIdTitre() == $budget->getId())
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    Rubriques
                                                    <input type="hidden" id="id_budget" 
                                                           name="lignebanquecaisse_filters[<?php echo $name ?>]"
                                                           value=''  >
