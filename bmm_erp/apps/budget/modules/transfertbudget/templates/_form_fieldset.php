                                            ...
                                            <table>
                                                <tr id="row_budget">
                                                    ...
                                                    <td colspan="2" >
                                                        ...
                                                        <select id="numeroengaement_source" name="numeroengaement_source">
                                                ...
                                                <tr style="background-color: #4580e9;color: white">
                                                    <td colspan="3">
                                                ...
                                                <tr id="detail_source" style="background-color: #4580e9;color: #fff;font-size: 18px">
                                    ...
                                    <td style="width: 50%">
                                        <fieldset>
                                            ...
                                            <table>
                                                ...
                                                <tr id="detail_dest" style="background-color: #4580e9;color: #fff;font-size: 18px">
