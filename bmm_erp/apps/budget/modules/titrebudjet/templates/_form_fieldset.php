                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <?php if (strcmp($prototype, "Prototype") != 0) { ?>
                                            ...
                                            <tr>
                                                <td><label>Prototype Ou Budget Prévisionnel Global</label></td>
                                                <td colspan="5">
                                                    <?php
//                                                $annees_mois_un = date('Y') - 1;
                                                    ...
                                                    $prototype = Doctrine_Core::getTable('titrebudjet')
                                                            ->createQuery('a')
//                                                        ->where('etatbudget=2')   
                                                            ->AndWhere("trim(typebudget) like trim('" . "Prototype" . "') or trim(typebudget) like trim('" . "Budget Prévisionnel Global" . "')")
//                                                        ->orwhere("trim(typebudget) like trim('Exercice:" . $annees_mois_un . "')")
                                                            ->orderBy("a.typebudget")
                                                            ->execute();
                                                    ?>
                            ...
                            <fieldset style="margin-top: 20px;">
                                ...
                                <button ng-if="etatbudget !== '2'" class="btn btn-white btn-success" type="submit">
