        ...
        <tbody>
            ...
            <?php foreach ($listes as $liste) : ?>
                ...
                <tr>
                    ...
                    <td style="text-align: right; font-size: 12px;"><b><?php echo number_format($montant_ordonnance_courant_rub, 3, '.', ' '); ?></b></td>
                    <td style="text-align: right; font-size: 12px; background-color: #d9edf7;"><b><?php echo number_format($montant_ordonnance_antecedent_rub + $montant_ordonnance_courant_rub, 3, '.', ' '); ?></b></td>

                    <td style="text-align: right; font-size: 12px; background-color: #fdffd5;"><b><?php echo number_format(($liste->getMnt() + $mnt_transfert_final) - ($montant_ordonnance_antecedent_rub + $montant_ordonnance_courant_rub), 3, '.', ' '); ?></b></td>
                    ...
                    <td style="text-align: right; font-size: 12px; background-color: #f2dede;"><b><?php echo number_format($montant_ordonnance_antecedent_rub + $montant_ordonnance_courant_rub - ($montant_paiement_anterieur_rub + $montant_paiement_courant_rubsousrubrique), 3, '.', ' ') ?></b></td>
                </tr>
                <?php $sous_listes = LigprotitrubTable::getInstance()->getSousrubriqueByTitreBudget($titre, $liste->getIdRubrique()); ?>
                <?php foreach ($sous_listes as $sous_liste) : ?>
                ...
                endforeach;
                $mnt_engage_courant = $mnt_engage_courant + $montant_ordonnance_courant_rub;
