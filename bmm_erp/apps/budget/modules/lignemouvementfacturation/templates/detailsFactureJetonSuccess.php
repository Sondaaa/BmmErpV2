...
$facture = DocumentachatTable::getInstance()->findOneByIdDocparentAndIdTypedoc($docachat->getId(), 15);
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="tab-content">
                    ...
                    <?php if ($facture): ?>
                        <a class="btn btn-danger btn-sm" href="<?php echo $facture->getLinkDocument() ?>" target="_blanc">
