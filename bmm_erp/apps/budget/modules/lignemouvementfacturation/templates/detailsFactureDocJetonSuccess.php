...
$doc_jeton = DocumentachatTable::getInstance()->findOneByIdDocparentAndIdTypedoc($id_docachat, 16);
if ($doc_jeton)
    $piecejointbudget = PiecejointbudgetTable::getInstance()->findOneByIdDocachat($doc_jeton->getId());
else
...
$docachat = DocumentachatTable::getInstance()->findOneByIdDocparent($id_docachat);
$facture = DocumentachatTable::getInstance()->findOneByIdDocparentAndIdTypedoc($doc_jeton->getId(), 15);
...
<?php $date = date('Y', strtotime($document_budget->getLigprotitrub()->getTitrebudjet()->getDatecreation())); ?>
                    ...
                    <table border="1" style="padding:1%">
                        <tbody>
                            ...
                            <?php
                            if ($document_budget->getLigprotitrub()->getRubrique()->getSousRubriqueBudgetaire()) :
...
<?php endif; ?>
            ...
            <div class="col-sm-6">
                <div class="tab-content">
                    ...
                    <a class="btn btn-danger btn-sm" href="<?php echo $documentachat->getLinkDocument() ?>" target="_blanc">
                        <i class="fa fa-file-pdf-o"></i> Exporter PDF <?php echo $documentachat->getTypedoc() ?>
                    </a> 

<?php if ($doc_jeton): ?>
                        <a class="btn btn-danger btn-sm" style="margin-left: 2px" href="<?php echo $doc_jeton->getLinkDocument() ?>" target="_blanc">
                            <i class="fa fa-file-pdf-o"></i> Exporter PDF <?php echo $doc_jeton->getTypedoc() ?>
                        </a> 
                    <?php endif; ?>  
<?php if ($facture): ?>
                        <a class="btn btn-danger btn-sm" style="margin-top: 2px" href="<?php echo $facture->getLinkDocument() ?>" target="_blanc">
