    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="accuelbci">
                <div class="row">
                    <div class="col-lg-12">
                        <?php echo html_entity_decode($documentachat->ReadHtmlBDCRegAndFactureImression()); ?> 
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="content">
                                                                ...
                                                                <?php if (trim($documentachat->getEtatdocachat()) != "Annulé(e)"): ?>
                                                                    <button id="valide_button" class="btn btn-sm btn-success" onclick="validerDocumentBDCREG()">
...
<script  type="text/javascript">
    ...
    function validerDocumentBDCREG() {
        $.ajax({
            url: '<?php echo url_for('documentbudget/validerOrdonnanceBDCReg') ?>',
