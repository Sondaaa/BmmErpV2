    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="accuelbci">
                <div class="row">
                    <div class="col-lg-12">
                        <?php echo html_entity_decode($documentachat->ReadHtmlFactureImressionContratFacturation($id)); ?> 
...
//                die($id_doc_parent.'mp');
                $facture = DocumentachatTable::getInstance()->findOneByIdDocparentAndIdTypedoc($id_doc_parent, 15);
//                die($facture.'mp');
                if (!$facture) {
                    //Carger facture d'aprés BCEJ
                    $bcej = DocumentachatTable::getInstance()->findOneByIdDocparentAndIdTypedoc($id_doc_parent, 16);
                    if ($bcej)
...
<script  type="text/javascript">
    ...
    function validerDocument() {
        $.ajax({
            url: '<?php echo url_for('documentbudget/validerOrdonnanceLigneBCIcontrat') ?>',
