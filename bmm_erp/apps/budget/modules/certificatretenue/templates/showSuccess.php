    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <?php if ($documentbudget->getDocumentbudget()->count() != 0): ?>
                <a class="btn btn-primary" target="__blanc" href="<?php echo url_for('Ordonnancement/Imprimerordonnance?id=' . $documentbudget->getDocumentbudget()->getFirst()->getId()) ?>" type="button" style="float: right; margin-top: 20px; margin-right: 1%;">
                    <i class="ace-icon fa fa-print bigger-110"></i>
