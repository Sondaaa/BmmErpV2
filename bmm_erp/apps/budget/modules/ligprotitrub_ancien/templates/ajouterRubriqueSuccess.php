...
<tr id="tr_<?php echo $id; ?>" name="tr_rubrique">
    ...
    <?php if (trim($titre->getTypebudget()) != 'Prototype'): ?>
        ...
        <input type="text" class="align_right" readonly="true" name="credit_encaissier" parent_line="" name="credit_alloue" id="credit_encaissier_<?php echo $id; ?>" value="<?php echo number_format($credit_encaissier, 3, '.', ''); ?>" style="max-width: 130px; width: 100%;">
    </td>    
    <?php endif; ?>
    <?php if ($titre->getEtatbudget() == 2): ?>
