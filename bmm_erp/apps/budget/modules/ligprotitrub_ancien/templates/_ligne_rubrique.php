...
<tr id="tr_<?php echo $id; ?>" name="tr_rubrique">
    ...
    <td>
        ...
        <?php $sous_rubriques = LigprotitrubTable::getInstance()->getSousRubrique($rubrique->getIdRubrique(), $rubrique->getIdTitre(),$tranche->getId()); ?>
    ...
    <?php if (trim($rubrique->getTitrebudjet()->getTypebudget()) != 'Prototype'): ?>
        ...
        <input type="text" class="align_right" name="credit_encaissier" parent_line="" id="credit_encaissier_<?php echo $id; ?>" value="<?php echo number_format($rubrique->getMntencaisse(), 3, '.', '') ?>" readonly="true" style="max-width: 130px; width: 100%;">
    </td>    
