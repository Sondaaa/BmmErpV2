...
<tr id="tr_<?php echo $index . '_' . $id; ?>" name="tr_rubrique">
            ...
            <thead>
                <tr>
                    ...
                    <?php if (trim($sous_rubrique->getTitrebudjet()->getTypebudget()) != 'Prototype'): ?>
                        ...
                        <th style="width: 10%">MONTANT EN CAISSIER</th>
    ...
    <?php if (trim($sous_rubrique->getTitrebudjet()->getTypebudget()) != 'Prototype'): ?>
        ...
        <input type="text" class="align_right" name="credit_encaissier" parent_line="" id="credit_encaissier_<?php echo $index . '_' . $id; ?>" value="<?php echo number_format($sous_rubrique->getMntencaisse(), 3, '.', '') ?>" readonly="true" style="max-width: 130px; width: 100%;">
    </td>    
