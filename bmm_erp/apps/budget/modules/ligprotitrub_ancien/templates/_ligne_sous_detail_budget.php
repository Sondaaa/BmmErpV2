<?php foreach ($rubriques_sous_lignes as $ligne_sous_rubrique): ?>
    ...
    <?php if ($rub_sous_lignes->count() != 0): ?>
        ...
        <tr>
            ...
            <td style="<?php echo $style_td ?>"><?php echo number_format($ecart, 3, '.', ' '); ?></td>
    ...
    <?php else: ?>
        ...
        if ($total_provisoire == 0 && $total_engagement > 0) {
            $ecar = abs($total_provisoire - $total_engagement);
        } else {
            $ecar = ($total_provisoire - $total_engagement);
        }
        ?>
        <tr>
            <td style="padding-left: <?php echo $margin_left ?>px; color: <?php echo $color; ?>;"><?php echo $ligne_sous_rubrique->getCode(); ?></td>
            ...
            <td style="<?php echo $style_td ?>"><?php echo number_format($ecar, 3, '.', ' '); ?></td>
