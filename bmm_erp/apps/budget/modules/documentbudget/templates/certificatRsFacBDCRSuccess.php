...
//                $ids = explode(',', $ids);
                ...
                //$total_doc_ttc = 0;
                $objet_reglement = '';
                $docachat = DocumentachatTable::getInstance()->findOneById($ids);
                $total_doc_ttc =  $docachat->getMntttc();
                    if ($docachat->getIdTypedoc() == 15) {
                        $objet_reglement =  $docachat->getNumero() ;                        
                    }
                        ...
                        <div class="widget-body">
                            <div class="widget-main" style="padding-bottom: 0px;">
                                ...
                                <table style="margin-bottom: 10px;">
                                    ...
                                    <tr>
                                        <td>Montant TTC</td>
                                        <td><input id="montant_document_achat" readonly="true" type="text" value="<?php echo number_format($docachat->getMntttc(), 3, '.', ' '); ?>" /></td>
                                    </tr>
                                    <tr>
                ...
                <?php $lignes = TvaTable::getInstance()->getBaseTvaByDocsContratBDCREG($ids);
               ?>
    ...
    <div class="row" id="zone_save_button">
        <div class="col-xs-12">
            ...
            <button class="btn btn-xs btn-primary" type="button" style="float: right; margin-right: 1%;" onclick="saveCertificatBDCREG()">
...
<script  type="text/javascript">
    ...
    function saveCertificatBDCREG() {
        if (($('#taux_retenue').val() != '0')) {
            $.ajax({
                url: '<?php echo url_for('documentbudget/saveCertificatRetenueBdcReg') ?>',
