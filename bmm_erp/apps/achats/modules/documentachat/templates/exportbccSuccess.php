                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <input id="referencebdc_p"  type="text">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Type BDC</td>
                                            <td>
                                                <select id="bdc_type">
                                                    ...
                                                    <option value="1"><?php echo 'Regroupe' ?></option>      
                            ...
                            <td>
                                <p style="border-bottom: #000 dashed 1px !important">
                                    <textarea id="desc_p_{{lignedoc.norgdre}}" class="form-control"
                                              ...
                                              provisoire="p_"> {{lignedoc.observation}}
                                    </textarea>
                                </p>
                            </td>
                            <td style="text-align: center;">
...
<!--                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <input id="referencebdc"  type="text">
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr ng-repeat="demandeprix in docDemandePrix">
                                    ...
                                    <?php ?>
                                    <td>
                                        <a ng-if="demandeprix.idtypedoc == 17" href="<?php echo url_for('documentachat/imprimerBDCProvisoire?iddoc=') ?>{{demandeprix.id}}  "  class="btn btn-primary1"
                                           ng-model="BtnExporter" target="_blanc">Exporter PDF</a>
                                        <a ng-if="demandeprix.idtypedoc == 2" href="<?php echo url_for('documentachat/imprimerBDCDefinitf?iddoc=') ?>{{demandeprix.id}}  "   class="btn btn-primary1"
                                           ng-model="BtnExporter" target="_blanc">Exporter PDF</a>
                                    </td>
