                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 20%;" class="disabledbutton">
                                                <input type="text" value="" readonly="true" ng-model="fournisseur_p.text" id="fournisseur_p" class="form-control" ng-change="AfficheFournisseurTuneps()">
                                            </td>
                                            <td style="width: 60%;">
                                                <input type="text" value="" ng-model="fournisseur_tuneps.text" id="fournisseur_tuneps" class="form-control" ng-change="AfficheFournisseurTuneps()">
                                            </td>
                                            <!-- <select id="fournisseur_p">
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                            <option value="<?php //echo $fournisseur->getId(); 
                ...
                <div class="tab-pane <?php if ($tab == "3") echo 'fade active in' ?>" id="profile" ng-controller="CtrlDemandeprix" <?php if ($documentachatBCEP) : ?> ng-init="AfficheLignedocBCIVersBCE('<?php echo $documentachatBCEP->getId() ?>', '')" <?php endif; ?>>
                    ...
                    <div>
                        ...
                        <div id="btnvalider_bdcd" class="disabledbutton">
                            <input type="button" value="Enregistrer" id="btnvalider_bce" ng-model="btnvalider"
                            <?php if (sizeof($docparent) >= 1) : ?> 
                                class="btn btn-primary disabledbutton" 
                                <?php else : ?> class="btn btn-primary" <?php endif; ?>
