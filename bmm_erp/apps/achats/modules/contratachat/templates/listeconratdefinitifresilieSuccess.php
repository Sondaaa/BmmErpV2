<div id="sf_admin_container">
    <h1>Liste des Contrats Définitifs Résilies</h1>
        ...
        <form action="" method="post" >
            <table cellspacing="0" style="margin-bottom: 0px;">
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('contratachat/listeconratdefinitifresilie') ?>">Effacer</a>
            ...
            <div>
                <table id="list_forme" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                        //die(sizeof($pager).'f');
                        include_partial('contratachat/list_contratresilie', array('pager' => $pager));
                        ?>
                    </tbody>
                </table>
...
<div class="col-md-12">
    <?php include_partial('pagination_contratdefinitifresilier', array('pager' => $pager)) ?>
...
<script>
    function printListDocAchats() {
        ...
        url = '<?php echo url_for('contratachat/imprimerlisteContratachatDefresilie') ?>' + url;
    ...
    function ExportListDocAchats() {
        ...
        url = '<?php echo url_for('contratachat/exporterlisteContratResilie') ?>' + url;
        window.open(url, '_blank');
        win.focus();
    }
