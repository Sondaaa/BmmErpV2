<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des Contrats Provisoire Annulés')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Liste des Contrats Provisoires d'achat annulés  vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv">Liste des Contrats Provisoires d'achats annulés

        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter Liste des Contrats Provisoires d'achat annulés => Excel</small>
    </h1>
