<div id="sf_admin_container">
    <h1>Liste des Contrats Provisoires annulés</h1>
</div>
<div id="sf_admin_bar" > 
        ...
        <form action="" method="post" >
            <table cellspacing="0" style="margin-bottom: 0px;">
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('contratachat/listeconratprovisoireannule') ?>">Effacer</a>
    ...
    <script>
        function printListDocAchats() {
            ...
            url = '<?php echo url_for('contratachat/imprimerlisteContratachatProvisoireAnnule') ?>' + url;
        ...
        function ExportListDocAchats() {
            ...
            url = '<?php echo url_for('contratachat/exporterlisteContratProvisoireAnnule') ?>' + url;
            window.open(url, '_blank');
            win.focus();
        }
