...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="col-xs-12" style="border: 1px solid #307ECC; padding-top: 10px;" ng-controller="CtrlDashboard">
            <div id="table-scroll" class="table-scroll" style="margin-bottom: 10px;" scrolly="scollingCommandeContrat()">
                    ...
                    <table id="listCommandescontrat" class="mws-datatable-fn mws-table main-table">
                        ...
                        <tbody>
                            ...
                            foreach ($documentachats as $document_achat):
                                ...
                                $contratachat = ContratachatTable::getInstance()->findByIdDocAndIdTypedoc($id_doc_parent, 19);
