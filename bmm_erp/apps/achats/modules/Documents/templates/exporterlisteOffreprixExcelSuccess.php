<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des Offres de prix')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Liste des Offres de prix  vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv"> Liste des Offres de prix

        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter liste  des Offres de prix => Excel</small>
    </h1>
        ...
        <table style="margin-bottom: 0px; margin-top: 2px" id="table_plan" border="1">
            <thead>
                <tr>
                    ...
                    <td style="text-align:center;width: 35%;">Fournissuer</td>
