<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des BCEP')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Liste des Bon de commande externe (Système) provisoire par fournisseur  vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv"> Liste des Bon de commande externe Provisoire par fournisseur

        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter liste des BCEP => Excel</small>
    </h1>
        ...
        <table style="margin-bottom: 0px; margin-top: 2px" id="table_plan" border="1">
            <thead>
                <tr>
                    ...
                    <td style="text-align:center;width: 15%;">N° BCEP</td>
            ...
            <tbody id="tblData">
                <tr>  
                    ...
                    foreach ($documentachats as $documentachat):
                        ...
                        <td>
                            <?php
                            $document_achat_externe_difinitif = Doctrine_Core::getTable('documentachat')->findByIdAndIdTypedoc($documentachat->getId(), 18);
