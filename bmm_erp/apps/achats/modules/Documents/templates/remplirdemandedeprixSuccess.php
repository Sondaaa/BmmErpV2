...
<!--                                <tr>
                        ...
                        <a type="button" value="Retour à la liste" ng-model="btnretour" class="btn btn-white btn-success" href="<?php echo url_for('Documents/indexfrs?idtype=8') ?>" >Retour à la liste</a> 
