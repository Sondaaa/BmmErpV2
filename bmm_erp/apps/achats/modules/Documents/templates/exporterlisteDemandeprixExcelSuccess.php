<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des Demandes de prix')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Liste des Demandes de prix  vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv"> Liste des Demandes de prix

        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter liste  des Demandes de prix => Excel</small>
    </h1>
