...
<fieldset class="<?php if ($user->getAcceesDroit("achat_et_validation_frs")) echo 'disabledbutton' ?>" 
                ...
                <td colspan="2">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?php // echo $form['codefrs']->render(array('value'=>  $form->getObject()->getCurrentCodeFRS())) ?>
                        </div>
                        <div class="col-md-6">
