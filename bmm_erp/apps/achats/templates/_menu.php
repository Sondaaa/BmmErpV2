                    ...
                    <ul class="nav nav-list">
                        ...
                        <li class="hover">
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a class="<?php if (!$user->getProfilModule($acces_achat->getId(), "Fournisseur")) echo 'disabledbutton' ?>" href="<?php echo url_for('@ribbancaire') ?>">
                                        Rib fournisseur
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="hover">
                            ...
                            <b class="arrow"></b>
                            <ul class="submenu">
                                <li><a class="<?php if (!$user->getProfilModuleAction($acces_achat->getId(), "Bon de Commande Interne", "Création")) echo 'disabledbutton' ?>" href="<?php echo url_for('documentachat/new?idtype=6') ?>"><i class="fa fa-file-o fa-fw"></i> N. Fiche B.C. Interne</a></li>
                                <li><a class="<?php if (!$user->getProfilModule($acces_achat->getId(), "Bon de Commande Interne")) echo 'disabledbutton' ?>" href="<?php echo url_for('documentachat/index') ?>"><i class="fa fa-list-alt fa-fw"></i> Liste B.C. Interne</a></li>
                                <li><a class="<?php if (!$user->getProfilModule($acces_achat->getId(), "Bon de Commande Interne")) echo 'disabledbutton' ?>" href="<?php echo url_for('documentachat/listeAnnule') ?>"><i class="fa fa-list-alt fa-fw"></i> Liste B.C.I Annulé</a></li>
                                <li><a class="<?php if (!$user->getProfilModule($acces_achat->getId(), "Liste Documents/B.C.I")) echo 'disabledbutton' ?>" href="<?php echo url_for('Documents/index') ?>"><i class="fa fa-list-alt fa-fw"></i> Liste Documents/B.C.I</a></li>
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        <li class="hover">
