...
<?php } ?>
                        ...
                        <th>Quantité</th>
                        <th>Projet</th>
                        <th>Motif pour Achat</th>      <?php if ($documentachat->getIdTypedoc() != 9) { ?>           
...
<?php } ?>
        ...
        <fieldset style="margin-left: 50%;">
            ...
            <div>
                <a style="font-size: 18px" class="btn btn-outline btn-primary1" href="<?php echo url_for('@documentachat') ?>">Liste B.C.I.</a>
