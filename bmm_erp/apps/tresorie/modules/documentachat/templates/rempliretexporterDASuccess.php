<div id="sf_admin_container">
    ...
    <div id="sf_admin_content" ng-controller="myCtrldocvisa">
        ...
        <fieldset style="margin-left: 50%;">
            ...
            <div>
                <!-- <a id="btn_ajout" class="btn btn-outline btn-success disabledbutton" href="<?php //echo url_for('documentachat/validervisa?iddoc=') . $documentachat->getId() . '&btn=valider' 
                                                                                                ?>">
                    <i class="ace-icon fa fa-save bigger-110"></i> Regrouper
                </a> -->
                <a id="btn_ajout" class="btn btn-outline btn-default " href="<?php echo url_for('documentachat/validervisa?iddoc=') . $documentachat->getId() . '&btn=valider' ?>">
                    <i class="ace-icon fa fa-save bigger-110"></i> Enregistrer et Envoyer l'unite Budget
                </a>
            </div>
        </fieldset>
        <fieldset>
