...
<fieldset>
    ...
    <table>
        ...
        <tbody>
            <tr id="formligne">
                <td><input type="text" value="" ng-model="nordre.text" id="nordreid" style="width: 40px;" class="form-control disabledbutton" ></td>
                <td>
                    <input  type="text" ng-value="" ng-model="code.text" id="codearticle"  autocomplete="off"  style="width: 80px" class="form-control" ng-change="RechercheArticleByCodeAndDesignation()">                   
                </td>
                <td>
                ...
                <td><input type="text" value="" ng-model="quantite.text" id="quantite" style="width: 50px" class="form-control"></td>
                <td>
...
<fieldset style="margin-left: 50%">
    ...
    <div >
        <input id="btnvalider" style="font-size: 18px" ng-click="AjouterBCI()" type="button" value="Valider B.C.I... " class="btn btn-outline btn-danger" />
    </div>
