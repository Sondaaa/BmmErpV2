        ...
        <form action="" method="post" >
            <table cellspacing="0" style="margin-bottom: 0px;">
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('documentachat/listeAnnule') ?>">Effacer</a>
        ...
        <div class="col-xs-12">
            ...
            <div>
                <table id="list_forme" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                        include_partial('documentachat/list_bdc_achatannulation', array('pager' => $pager, 'id_type' => $id_type));
                        ?>
                    </tbody>
                </table>
            </div>
...
<script>
    function printListDocAchats() {
        ...
        if (url == '')
            ...
            url = url + '&id_type=17';
        url = '<?php echo url_for('documentachat/imprimerlisteDocachatAnnuler') ?>' + url;
