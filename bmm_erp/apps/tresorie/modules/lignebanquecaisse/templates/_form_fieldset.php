...
<?php
//include_partial('lignebanquecaisse/form_field', array(
//      'name'       => $name,
                                            ...
                                            <tr>
                                                ...
                                                <td><?php
                                                    ...
                                                    $budgets = Doctrine_Query::create()
                                                                    ...
                                                                    ->orWhere("trim(typebudget) like trim('Exercice:" . $_SESSION['exercice_budget'] . "') ")
...
<style>
    ...
    table > tbody > tr > td, label {font-size: 16px;}
