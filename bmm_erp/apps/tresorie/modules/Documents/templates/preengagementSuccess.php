        ...
        <div class="tab-content">
            <div class="tab-pane <?php if ($active == "home") echo "fade active in" ?> " id="home">
                ...
                <div style="margin-top: 10px;">
                    <object style="width: 100%;height: 900px;" data="<?php echo url_for('Documents/imprimerBDCProvisoire?iddoc=' . $documentachat->getId()) ?>" type="application/pdf">
                        <embed src="<?php echo url_for('Documents/imprimerBDCProvisoire?iddoc=' . $documentachat->getId()) ?>" type="application/pdf" />
                    </object>
                </div>
                <div style="margin-top: 10px;">
                    ...
                    <table >
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="bg bg-danger" style="padding:1%">
                                     <?php if($piece_budget): ?>  
                                        <?php echo html_entity_decode($piece_budget->getDocumentbudget()->getLigprotitrub()->getTitreEtRubrique());?> 
                                    <?php endif; ?>
                                    </div>
                                </td>
                            </tr>
...
//                                    }
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="bg bg-danger">
                                    <?php
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($liste_demande_de_prix as $l) {
                                ...
                                ?>
                                <tr>
                                    <td><input <?php // if ($ligne_article_caisse) { checked="checked"  ?><?php // } ?> id="check_<?php echo $ligne->getId() ?>" type="checkbox" class="list_checbox_article" ng-click="AjouterArticleListeSelectionner(<?php echo $ligne->getId() ?>)"></td>
