        ...
        <div class="tab-content">
            <div class="tab-pane <?php if ($active == "home") echo "fade active in" ?> " id="home">
                ...
                <div style="margin-top: 10px;">
                    <object style="width: 100%;height: 900px;" data="<?php echo url_for('Documents/ImprimerbondeponseReg?iddoc=' . $documentachat->getId()) ?>" type="application/pdf">
                        <embed src="<?php echo url_for('Documents/ImprimerbondeponseReg?iddoc=' . $documentachat->getId()) ?>" type="application/pdf" />
                    </object>
                </div>
                <div style="margin-top: 10px;">
...
//                                        echo $form->getObject()->getMntoperation();?>" id="mnt_operation">-->
...
<?php } ?>
                ...
                <fieldset >
                    ...
                    <input  type="button" value="Mettre à ajour" ng-click="AjouterQuittanceBDC(<?php echo $documentachat->getId() ?>, <?php echo $idcategorie ?>)">
