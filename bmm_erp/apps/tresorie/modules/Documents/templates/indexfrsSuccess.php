                    ...
                    <tbody>
                        ...
                        foreach ($boncommandeexterne as $bcex) {
                            ...
                            <tr>
                                ...
                                <td><?php  if($boncomm->getFournisseur()) echo $boncomm->getFournisseur() ?></td> 
                                <td><?php if($boncomm->getMht()) echo $boncomm->getMht() ?></td> 
                                <td><?php if($boncomm->getMnttva()) echo $boncomm->getMnttva() ?></td> 
                                <td><?php if($boncomm->getMntttc() && $boncomm->getMntttc() !='NAN') echo floatval ($boncomm->getMntttc()) ?></td> 
                                <td>
                                    <?php
                                    if ($boncomm->getIdFils() && $document_fils) {
