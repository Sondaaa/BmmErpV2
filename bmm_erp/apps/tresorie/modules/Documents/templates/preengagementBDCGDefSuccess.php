...
<div id="sf_admin_container" ng-controller="CtrlCaisse">
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class=""  ><a href="#listeengagement" data-toggle="tab" aria-expanded="false">Liste des fiches quittances Provisoires & Définitifs</a>
            </li>
        </ul>
...
//                                    }
                            ...
                            <tr>
                                ...
                                <td ><label>RAS IRPP/IS</label></td>
                                <td >

                                    <?php echo $form['retenueirrp']->renderError() ?>
                                    <?php echo $form['retenueirrp'] ?>
                                </td>
                                <td ><label>RAS TVA</label></td>
                                <td >

                                    <?php echo $form['retenuetva']->renderError() ?>
                                    <?php echo $form['retenuetva'] ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <fieldset >
                    ...
                    <input  type="button" value="Mettre à ajour" ng-click="AjouterQuittanceBDCDef(<?php echo $documentachat->getId() ?>, <?php echo $idcategorie ?>, false)">
                    <?php
                    $id_doc_achat = $ligne->getIdDoc();
                    $doc_achat = DocumentachatTable::getInstance()->find($id_doc_achat);
                   
//                    die($doc_achat->getId().'fr');
                    $quitancepro = LigneoperationcaisseTable::getInstance()->findByIdDocachatAndIdCategorie($doc_achat->getId(), 1);
                    $quitancedef = LigneoperationcaisseTable::getInstance()->findByIdDocachatAndIdCategorie($doc_achat->getId(), 2);
                    ?>
                    <?php
                    if (sizeof($quitancedef) == sizeof($quitancepro)):
                        ?>
                        <input  type="button" value="Mettre à ajour & Clôturer " ng-click="AjouterQuittanceBDCDef(<?php echo $documentachat->getId() ?>, <?php echo $idcategorie ?>, true)">                 
                    <?php endif; ?> 
