<div id="sf_admin_container">
    <h1 id="replacediv"> Liste <?php echo $typedocachat->getLibelle(); ?> </h1>
</div>
...
<!--                            <th>Fournisseur</th>
                    ...
                    <tbody>
                        ...
                        foreach ($boncommandeexterne as $bcex) {
                            ...
                            <tr>
                                ...
                                if ($typedocachat->getId() == 21) {
                                    $detail_retenue .= " Retenue à la source ";
                                }
                                ?>
                                <td>
    ...
    <!--                                <td><?php // echo $boncomm->getFournisseur()    ?></td> 
                                ...
                                <td>
                                    ...
                                    <?php } ?>
                                    <?php // if ($piece) { ?>  
                                    <a href="<?php echo url_for('Documents/preengagementBDCG?id=') . $boncomm->getId() ?>"><?php echo $detail ?></a>
                                    <?php // } ?>
                                    <?php // if ($typedocachat->getId() == 21) { ?>  
                                    <!--<br><a href="<?php // echo url_for('Documents/preengagementBDCGRetenue?id=') . $boncomm->getId()  ?>"><?php // echo $detail_retenue  ?></a>-->
                                    <?php // } ?>                                     
                                    <?php
//                                    if (!$piece)
//                                        echo "<p style='color:red'>L'imputation budget non encore traitée</p>";
                                    ?>
                                </td>
                            </tr>
                        <?php } ?>
