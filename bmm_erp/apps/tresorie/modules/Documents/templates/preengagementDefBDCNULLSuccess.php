    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane <?php if ($active == "detail") echo "fade active in" ?>" id="engagement" >
                <fieldset>
                    <legend>Fiche de quittance <?php echo 'Définitif'; ?></legend>
                    <table>
                        <tbody>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="background-color: red">
                                    ...
                                    if (sizeof($quitanceprovisoire) >= 1)
                                        $mnt = $quitanceprovisoire->getMntoperation();
                                    ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            foreach ($liste_demande_de_prix as $l) {
                                ...
                                ?>
                                <tr>
                                    <td><input <?php // if ($ligne_article_caisse) { checked="checked"?>  <?php // } ?> 
                                               id="check_<?php echo $ligne->getId() ?>" type="checkbox" class="list_checbox_article" ng-click="AjouterArticleListeSelectionner(<?php echo $ligne->getId() ?>)"></td>
                ...
                <fieldset >
                    ...
                    <input  type="button" value="Mettre à ajour" ng-click="AjouterQuittanceDEFBDCNULL(<?php echo $documentachat->getId() ?>)">
