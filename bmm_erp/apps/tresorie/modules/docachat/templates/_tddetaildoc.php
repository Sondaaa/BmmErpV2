...
//                        echo html_entity_decode($boncomm->ReadHtmlContrat($listesdocuments));
                ...
                <div class="modal-footer">
                    ...
                    <a id="btnimpexpo" class="btn btn-primary pull-left" target="_blanc"
                       href="<?php echo url_for('docachat/imprimerBCEDefinitf?iddoc=') . $boncomm->getId() ?>">
                ...
                <?php } ?>
                    ...
                    <a id="btnimpexpo" class="btn btn-primary pull-left" target="_blanc"
                       href="<?php echo url_for('docachat/imprimerBCEProvisoire?iddoc=') . $boncomm->getId() ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                ...
                <?php } ?>
                    ...
                    <a id="btnimpexpo" class="btn btn-primary pull-left" target="_blanc"
                       href="<?php echo url_for('docachat/imprimerBDCDefinitf?iddoc=') . $boncomm->getId() ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                ...
                <?php } ?>
                    ...
                    <a id="btnimpexpo" class="btn btn-primary pull-left" target="_blanc"
                       href="<?php echo url_for('docachat/imprimerBDCProvisoire?iddoc=') . $boncomm->getId() ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                ...
                <?php } ?>
                    ...
                    <a id="btnimpexpo" class="btn btn-primary pull-left" target="_blanc"
                       href="<?php echo url_for('docachat/imprimerBDCRegroupeProvisoire?iddoc=') . $boncomm->getId() ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                ...
                <?php } ?>
                    ...
                    <a id="btnimpexpo" class="btn btn-primary pull-left" target="_blanc"
                       href="<?php echo url_for('docachat/ImprimerbondeponseRegrouppe?iddoc=') . $boncomm->getId() ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
