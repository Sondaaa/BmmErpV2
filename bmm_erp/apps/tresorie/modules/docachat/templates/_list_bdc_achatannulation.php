<?php if (sizeof($pager) == 0): ?>
    <tr>
        <td style="text-align:center; font-weight: bold; font-size: 16px !important;" colspan="7">Liste des Documents achats annulés vide</td>
    </tr>
<?php endif; ?>
<?php $i = 1; ?>
<?php foreach ($pager as $docs): ?>
    ...
    <?php echo date('d/m/Y', strtotime($docs->getDocumentachat()->getDatecreation()));  ?></td>
        ...
        <td style="text-align: center;">
            <a type="button" href="<?php echo url_for('docachat/showAnnule') . '?iddoc=' . $docs->getDocumentachat()->getId() ?>" class="btn btn-xs btn-primary">Détails</a>
        </td>
    </tr>
