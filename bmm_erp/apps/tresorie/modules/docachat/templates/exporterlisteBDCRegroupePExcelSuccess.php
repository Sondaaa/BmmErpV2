<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des BDC Regroupe P')">
    ...
    <h1 id="replacediv"> Liste des Bon dépense au comptant Regroupe Provisoire par fournisseur
