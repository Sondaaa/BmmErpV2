<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des BDCS')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Liste des Bon dépense au comptant Système par fournisseur  vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv"> Liste des Bon dépense au comptant  Système par fournisseur

        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter liste des BDCS => Excel</small>
    </h1>
...
if ($idfrs != '')
    $q->andWhere("d.id_frs like =" . $idfrs . "");
        ...
        <table style="margin-bottom: 0px; margin-top: 2px" id="table_plan" border="1">
            <thead>
                <tr>
                    ...
                    <td style="text-align:center;width: 15%;">N° BDCS</td>
            ...
            <tbody id="tblData">
                <tr>  
                    ...
                    <td style="text-align: center">
                        ...
                        <td>
                            <?php
                            $document_achat_externe_difinitif = Doctrine_Core::getTable('documentachat')->findByIdAndIdTypedoc($documentachat->getId(), 2);
