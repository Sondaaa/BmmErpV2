<div id="sf_admin_container">
    ...
    $documentachatBDCP = DocumentachatTable::getInstance()->findOneByIdDocparentAndIdTypedoc($ids, 17);
...
<!--<li class="<?php // if ($tab == "") echo 'active'                              ?>"><a href="#home" data-toggle="tab" aria-expanded="true">Détail</a></li>-->
                <li class="<?php if ($tab != "3") echo 'active' ?>"><a href="#profilep" data-toggle="tab" aria-expanded="false" ng-controller="CtrlDemandeprix" ng-click="InialiserBDCPS();">Fiche B. D. aux Comptant Provisoire</a></li>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a class="btn  btn-xs  btn-primary" ng-click="AddDetailBDC()"
                                           title="Add Ligne">
                                            <i class="fa fa-plus"></i>
                                        </a> 
                                        <button type="button" class="btn   btn-xs  btn-danger" 
                                                ng-click="ViderChampsBDC()"
                            ...
                            <td>
                                <p style="border-bottom: #000 dashed 1px !important">
                                    <textarea id="desc_p_{{lignedoc.norgdre}}" class="form-control"
                                              ordre="{{lignedoc.norgdre}}"
                                              provisoire="p_"> {{lignedoc.observation}}</textarea>
                                </p>
                            </td>
                            <td style="text-align: center;">
...
<!--                                        <tr>
                    ...
                    <div style="padding: 1%;width: 60%;font-size: 16px;float: left">
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                <select id="listesbdcp" style="width: 100%">
                                                    ...
                                                    <option ng-repeat="demandeprix in docDemandePrix" ng-if="demandeprix.idtypedoc === 17 && demandeprix.id ===<?php echo $idbdcp ?>" selected="selected" value="{{demandeprix.id}}" ng-init="EtatBDCP_dans_budgetBDCNULL(demandeprix.id)">{{demandeprix.numero}} - {{demandeprix.rs}}</option>
                                                    <option ng-repeat="demandeprix in docDemandePrix" ng-if="demandeprix.idtypedoc === 17 && demandeprix.id !=<?php echo $idbdcp ?>" value="{{demandeprix.id}}" ng-click="EtatBDCP_dans_budgetBDCNULL(demandeprix.id)">{{demandeprix.numero}} - {{demandeprix.rs}}</option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <td>
                                    <table style="margin-bottom: 0px;">
                                        <tr>
                                            ...
                                            <td><input class="align_right" type="text" id="quitance_def_ttc_bdc" 
                                                       value="<?php
                        ...
                        <!-- <table style="list-style: none; margin-top: 47px;" class="table table-striped table-bordered table-hover">
                            <tr>
                                <td>
                                    <table style="margin-bottom: 0px;">
                                        <tr><td>Droit de Timbre</td>
                                            <td>
                                                <select id="droit_timbre_bdc_sys" >
                                                    <option value="1" <?php //if ($documentachatBDCP->getDroittimbre() == '1'): ?>selected="true" <?php //endif; ?>><?php //echo 'Avec' ?></option>      
                                                    <option value="0" <?php //if ($documentachatBDCP->getDroittimbre() == '0'): ?>selected="true" <?php //endif; ?> ><?php //echo 'Sans' ?></option>
                                                </select>
                                            </td>
                                            <td>Montant Total TTC :</td>
                                            <td><input class="align_right" type="text" id="total_ttc_bdc" 
                                                <?php
//                                                if (sizeof($documentachatBCE) >= 1) {
//                                                    echo $documentachatBCE->getMntttc();
//                                                } elseif (sizeof($documentachatBCE_Sys) >= 1) {
//                                                    if ($documentachatBCE_Sys->getIdTypedoc() == 18 || $documentachatBCE_Sys->getIdTypedoc() == 17) {
                                                ?> 
                                                       value="<?php // echo $documentachatBCE_Sys->getMntttc()           ?>"
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" style="" id="qtesysBDC"></td>
                                    <td><input type="text" class="form-control" style="" id="puhtsysBDC"></td>
                                    ...
                                    <td><input type="text" class="form-control" style="" id="totalhaxsysBDC"  readonly="true"></td>                                
                                     <td>
                                    ...
                                    <td><input type="text" class="form-control" style="" id="fodecsysBDC"   readonly="true"></td>
                                    <td><input type="text" class="form-control" style="" id="totalhtvasysBDC"  readonly="true" ></td>
                                    <td>                   
                                    ...
                                    <td><input type="text" class="form-control" style="" id="totalttcsysBDC" readonly="true" ></td>

                                    <td>
                                        <textarea id="observationsysBDC" class="form-control" ></textarea>
                                    </td>
                                    <td style="text-align: center;">
                                        <a class="btn  btn-xs  btn-primary" ng-click="AddDetailBDCS()"
                                           title="Add Ligne">
                                            <i class="fa fa-plus"></i>
                                        </a> 
                                        <button type="button" class="btn   btn-xs  btn-danger" 
                                                ng-click="ViderChampsBDCS()"
                                                title="Vider les Chmaps"><i class="fa fa-minus"></i></button>
...
<!--                                    <td><p style="border-bottom: #000 dashed 1px !important">
                                            <input type="text" class="form-control" style="" id="puht_{{lignedoc.norgdre}}" value="{{lignedoc.puht|integer}}" ordre="{{lignedoc.norgdre}}" provisoire="" onchange="miseAjour(this)"></p></td>-->
                            <input type="hidden" id="id_lignebce" value="{{lignedoc.id}}">
                            <td>{{lignedoc.puht}}</td>                            
...
<!--                                    <td>
                        ...
                        <div id="btnvalider_bdcd"  style="padding: 1%; width: 100%; text-align: right;"><!--class="disabledbutton"-->
                            <input type="button" value="Enregistrer" ng-model="btnvalider" class="btn btn-primary1" ng-click="ValiderBondedeponseDEF('<?php echo $ids; ?>', '<?php echo $idbdcp; ?>')"> 
                        </div>
                    </div>
                </div>
                <div class="tab-pane" style="height: 1200px" id="listesdemandeprix" ng-controller="CtrlListesBondeponse" ng-init="AfficheDocNULL('<?php echo $ids; ?>');
