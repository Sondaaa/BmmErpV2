...
<div class="row" ng-controller="CtrlMouvement">
    <div class="col-xs-12">
        <div class="widget-box" >
            ...
            <div class="widget-body">
                <div class="widget-main" style="padding-bottom: 0px;" <?php if ($id): ?> ng-init="InitiliserCaisseanque('<?php echo $id; ?>')"<?php endif; ?>>
                    ...
                    <table>
                        ...
                        <td colspan="3" <?php if ($id) { ?>class="disabledbutton"<?php } ?>> 
                            ...
                            <select  id="mouvementbanciare_id_banque_horbci" >
                ...
                <div class="widget-main" style="padding-bottom: 0px; width: 100%; overflow: auto; min-height: 500px">
                    <table id="idformulaire">
                        <tr>
                            ...
                            <td colspan="2">Libellé d'opération
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo $form['id_instrument'] ?><input type="button" id="btnchargercheque" value="charger chèque" ng-click="ChargerCheque()">
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php //if ($agent->getNomcomplet() != ''):     ?>
                                                                                <option value="<?php //echo $agent->getId();                  ?>"><?php //echo $agent->getNomcomplet()                  ?></option>
                                <?php //endif;  ?>
                                <?php //endforeach;      ?>
                                                                    </select>
                                                                </div>-->
                    ...
                    <table>
                        ...
                        <tbody ng-repeat="lgop in listes_operations">
                            <tr>
                                ...
                                <td>{{lgop.ribbeni}}<br>{{lgop.refbenifi}}</td>
                            ...
                            <tr ng-if="lgop.flag_commission">
                                ...
                                <td colspan="5">{{lgop.titrecomm}}</td>
                                <td>
