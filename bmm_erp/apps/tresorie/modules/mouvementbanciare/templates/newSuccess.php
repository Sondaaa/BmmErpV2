...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <?php include_partial('mouvementbanciare/form', array('mouvementbanciare' => $mouvementbanciare, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper,'id'=>$id ,'type'=>$type)) ?>
  </div>
