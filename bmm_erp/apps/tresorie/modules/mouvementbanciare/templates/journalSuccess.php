                ...
                <form>
                    <table style="margin-bottom: 0px;" class="table table-bordered table-hover" cellspacing="0">
                        <tbody>
                            ...
                            <tr class="sf_admin_form_row sf_admin_foreignkey sf_admin_filter_field_type">
                                <td>
                                    <label for="mouvementbanciare_filters_quitance">Quitance</label></td>
                                <td>
                                    <select id="mouvementbanciare_filters_quitance" class="chosen-select form-control">                                      
                                        <option></option>
                                        <option value="1">Avec Quitance </option>
                                        <option value="0">Sans Quitance</option>
                                    </select>
                                </td>
                            </tr>
                        </tbody>
