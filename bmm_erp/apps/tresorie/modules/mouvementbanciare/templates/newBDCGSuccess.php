            ...
            <div class="widget-body" >
                <div class="widget-main" style="padding-bottom: 0px;" ng-init="InitiliserCaisseanque('<?php echo $id; ?>')">
                    ...
                    if ($id) {
                        ...
                        $documentbudget = $document->getPiecejointbudget()->getFirst()->getDocumentbudget()->getLigprotitrub()->getId();
                        $lignecaisse = Doctrine_Core::getTable('lignebanquecaisse')->findOneByIdBudget($documentbudget);
                    }
                            ...
                            <td <?php if ($id != null) { ?>class="disabledbutton"<?php } ?>>
                                ...
                                <select name="mouvementbanciare[id_banque]" id="mouvementbanciare_id_banque" >
                                    <?php foreach ($caisses as $caisse):
                                        ...
                                        <option <?php
                                        if ($id != null) {
                                            if ($lignecaisse->getIdCaissebanque() == $caisse->getId()):
                                                ?> 
                                                    selected="true"<?php
                                                endif;
                                            }
