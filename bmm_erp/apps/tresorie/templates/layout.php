    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
        ...
        <body class="no-skin" ng-app="Appdoc">
            ...
            <script>
                ...
                $('select').not('[id="skin-colorpicker"]').not('[id="tva"]').not('[id="idnote"]').not('[id="mouvementbanciare_id_documentachat"]').not('[id="id_banque_cible"]').not('[id="mouvementbanciare_id_object"]').attr('class', "chosen-select form-control");
                ...
                document.title = ("BMM - Caisses : " + contenueh1);
            </script>
