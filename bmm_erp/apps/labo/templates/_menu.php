    ...
    <ul class="nav nav-list">
        ...
        <li class="hover">
            ...
            <ul class="submenu">
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a class="<?php // if (!$user->getProfilModule($acces_stock->getId(), "Article")) echo 'disabledbutton' 
                                        ?>" href="<?php echo url_for('@article') ?>">Stock</a></li>
                ...
                <!-- <li><a class="<?php //if (!$user->getProfilModule($acces_stock->getId(), "Nature Article")) echo 'disabledbutton' 
                                    ?>" href="<?php //echo url_for('@naturearticle') 
                                                                                                                                                    ?>">Nature Article</a></li> -->
        ...
        <li class="hover">
            ...
            <ul class="submenu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        <li><a class="<?php if (!$user->getProfilModule($acces_stock->getId(), "Bon de Commande Interne")) echo 'disabledbutton' ?>" href="<?php echo url_for('Documents/indexdemandeur?idtype=4') ?>"> BCI Magasin</a></li>
                    </ul>
                </li>
            </ul>
            <!-- /.dropdown-user -->
            ...
            <ul class="submenu">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li><a class="<?php if (!$user->getProfilModule($acces_stock->getId(), "Fiche Sortie")) echo 'disabledbutton' ?>" href="<?php echo url_for('documentachat/index?idtype=11') ?>">Liste Fiches Sortie Provisoire</a></li>
                        <li><a class="<?php if (!$user->getProfilModule($acces_stock->getId(), "Fiche Sortie")) echo 'disabledbutton' ?>" href="<?php echo url_for('documentachat/index?idtype=23') ?>">Liste Fiches Sortie Définitifs</a></li>
