<?php if ($sf_user->isAuthenticated()) : ?>
    ...
    <head>
        ...
        <title>GESTION LABO - ONE ERP</title>
    ...
    <body class="no-skin"  ng-app="Appdoc">
        ...
        <script>
            ...
            $('select').not('[id="skin-colorpicker"]').not('[id="demandeur_id_agent"]').not('[id="tva"]').not('[id="idnote"]').attr('class', "chosen-select form-control");
