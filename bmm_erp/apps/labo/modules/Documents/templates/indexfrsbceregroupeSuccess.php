                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons" style="text-align: center;">
                                        <p href="#my-modalbcireg_<?php echo $boncomm->getId() ?>" role="button"  data-toggle="modal">
                                            <i class="ace-icon fa fa-search-plus bigger-130"></i>
                                        </p> 
                                    </div>
                                    <div id="my-modalbcireg_<?php echo $boncomm->getId() ?>" class="modal fade" tabindex="-1" >
                                        <div class="modal-dialog" style="width: 90%">
                                            <div class="modal-content" >
                                                ...
                                                <div class="modal-body">
                                                    <?php echo html_entity_decode($boncomm->getTransfertPvBCEregrouppe()); ?>
                                                </div>
