        ...
        <table cellspacing="0">
            ...
            <tbody>
                ...
                foreach ($configuration->getFormFilterFields($form) as $name => $field):
                    ...
                    ?>
                <?php endforeach; ?>
            <input  type="hidden" name="id_typedoc" id="id_typedoc" value="<?php if (!$idtype)
...
<div class="col-xs-4  widget-container-col" id="widget-container-col-1">
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            ...
            <?php  if($idtype==10):?>    
            <a href="<?php echo url_for('documentachat/new?idtype='.$idtype) ?>" class="btn btn-outline btn_new btn-success" style="text-align: center;height: 55px !important; width: 250px; font-size: 14px !important; " >Nouveau Bon d'entrée <br>Stock</a>  
            <?php elseif($idtype==11):?>
                <a href="<?php echo url_for('documentachat/new?idtype='.$idtype) ?>" class="btn btn-outline btn_new btn-success" style="text-align: center;height: 55px !important; width: 250px; font-size: 14px !important; " >Nouveau Bon Sortie Prvisoire</a>  
                
            <?php endif; ?>
                <br><br>
                <a style="height: 55px !important; width: 250px; font-size: 14px !important; font-weight: bold !important;" target="_blanc" href="<?php echo url_for('Documents/Imprimerlistepvreception') . '' . $str ?>" class=" btn btn-xs btn-success">
