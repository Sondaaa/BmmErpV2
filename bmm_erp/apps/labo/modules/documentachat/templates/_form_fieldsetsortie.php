...
<div class="col-lg-12">
                ...
                <tr>
                    <th colspan="9">
                        <table>
                            ...
                            if ($user->getIdMagasin() && $user->getIsAdmin()) {
    ...
    <fieldset style="margin-left: 30%">
        ...
        <div>
            ...
            <input id="btnvalider_provisoire" ng-click="AjouterBS('<?php echo $idtype; ?>','')" type="button" value="Valider le Bon de Sortie Provisoire " class="btn btn-outline btn-danger" />
