        ...
        <div class="widget-box">
            ...
            <div class="widget-body">
                <div class="widget-main">
                    <form method="POST" action="<?php echo url_for('Achatdoc/showSuivicommande') ?>">
...
<?php include_partial('Achatdoc/form_impression', array());?>
</div>
...
//        url = url + '&start_date=' + $('#start').val() + '&end_date=' + $('#end').val() + '&id_bci=' + $('#id_bci').val();
        url = '<?php echo url_for('Achatdoc/exportersuivibce') ?>' + url;
