    ...
    <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="smaller lighter blue no-margin">SUIVI BON DE COMMANDE  : IMPRESSION PERSONNALISEE </h4>
            </div>
...
<script  type="text/javascript">
  ...
  if ($('input[name=datepai]').is(':checked')) {
        ...
        if (valide) {
            ...
            url = '<?php echo url_for('Achatdoc/imprimerFicheBoncommandeAvecChoix') ?>' + url;
