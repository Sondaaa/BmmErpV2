...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_content">
    <?php include_partial('documentachat/form', array('documentachat' => $documentachat, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper , 'idfrs' => $idfrs, 'iddocparent' => $iddocparent)) ?>
  </div>
