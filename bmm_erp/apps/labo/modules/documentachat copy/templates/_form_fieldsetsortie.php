...
<div class="col-lg-12">
    ...
    <fieldset style="margin-left: 30%">
        ...
        <div>
            <a class="btn btn-xs btn-danger" href="<?php echo url_for('documentachat/index?idtype=11'); ?>">Liste des Bons de sortie</a>
            <input id="btnvalider" ng-click="AjouterBS()" type="button" value="Valider le Bon de Sortie... " class="btn btn-outline btn-danger" />
            <input id="btnpasstock" ng-click="RenvouyerLaboBS()" type="button" value="Envoyé au labo pour faire DA (pas Stock)" class="btn btn-outline btn-succcess" />
        </div>
    </fieldset>
</div>