...
<div id="verif_zone" style="display: none;">
    <legend>Tableau D.I. : <span id="count_bci"></span> <span style="font-size: 14px;">D.I.</span></legend>
    <div class="col-xs-12 col-sm-12" style="margin-bottom: 10px;">
...
<script  type="text/javascript">
    ...
    function makeTableFromColumn() {
        ...
        text_table_bci = text_table_bci + '<thead><tr><th>D.I.</th><th>Date</th><th>Demandeur</th><th>Service</th><th>Montant estimatif</th></tr></thead>';
        text_table_bci = text_table_bci + '<tbody>';
        //bdc
        var text_table_bdc = '<table class="table table-bordered table-hover">';
        text_table_bdc = text_table_bdc + '<thead><tr><th>D.I.</th><th>B.D.C</th><th>Date</th><th>Demandeur</th><th>Service</th><th>Fournisseur</th><th>Montant TTC</th></tr></thead>';
        text_table_bdc = text_table_bdc + '<tbody>';
        //bce
        var text_table_bce = '<table class="table table-bordered table-hover">';
        text_table_bce = text_table_bce + '<thead><tr><th>D.I.</th><th>B.C.E</th><th>Date</th><th>Demandeur</th><th>Service</th><th>Fournisseur</th><th>Montant TTC</th></tr></thead>';
