    ...
    <div class="col-xs-12">
        <div class="table-header" style="margin-bottom: 0px;">
            ...
            <button style="float: right; padding: 5px 12px;margin-left: 4px"
                    target="_blanc" 
                    onclick="setExportExcelBciContratId()"
                        ...
                        if (sizeof($fichecontrat) >= 1):
                            ...
                            <table id="listCommandesBCIcontrat" class="mws-datatable-fn mws-table main-table">
                                ...
                                <tr style="background: #D3D3D3">
                                    ...
                                    <th>N°Facture Sys</th><th>Montant</th>
...
//                                                echo $document_achat_externe_difinitif->getFirst()->getNumerodocachat();
                                ...
                                <tfoot>
                                    <tr style="background-color: #fff; background: repeat-x #F2F2F2;font-size: 14px;text-align: center"><td colspan="6">Somme des Achats</td>
                                        <td style="text-align: right">
                                            <?php
                                    ...
                                    <tr style="background-color: #fff; background: repeat-x #F2F2F2;font-size: 14px;text-align: center"><td colspan="6">Le Reste</td><td></td>
                                        <td style="text-align: right">
                                            <?php
