            ...
            <form>
                <table class="table table-bordered table-hover" cellspacing="0">
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                <a href="<?php echo url_for('fournisseur/indexFrsActif?actitf=' . $actif) ?>" class="btn btn-xs btn-success">Effacer</a>
    ...
    <div class="col-xs-4  widget-container-col" id="widget-container-col-1">
        <div class="widget-box" id="widget-box-1">
            ...
            <button style="font-size: 14px !important; font-weight: bold !important;" 
                    onclick="printListFournisseur()" class=" btn btn-xs btn-danger">
