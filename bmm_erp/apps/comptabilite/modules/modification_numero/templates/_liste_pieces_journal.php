    ...
    <?php foreach ($pieces as $piece): ?>
        <tr>
            ...
            <td style="text-align: center;">
                <a style="cursor: pointer;" onclick="showJournal('<?php echo $i; ?>')" id="text_new_journal_<?php echo $i ?>"><i class="ace-icon fa fa-pencil-square-o bigger-110"></i> <?php echo $piece->getJournalcomptable() ?></a>
            </td>
            <td style="text-align: center;">
                ...
                <input id="journal_<?php echo $i ?>" name="journl" value="<?php echo $piece->getDate() ?>" type="hidden"/>
            </td>
            <td style="text-align: center;">
