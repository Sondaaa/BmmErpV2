<?php if ($pager->count() == 0): ?>
    <tr>
        <td style="text-align:center; font-weight: bold; font-size: 16px !important;" colspan="4">Liste des Dossiers vide</td>
    </tr>
<?php endif; ?>
<?php foreach ($pager->getResults() as $ref): ?>
    <tr>
        ...
        <td><?php echo $ref->getUtilisateur()->getAgents()->getNomcomplet(); ?></td>
