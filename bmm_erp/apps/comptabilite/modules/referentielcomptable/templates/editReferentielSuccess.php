<form  method="post" enctype="multipart/form-data" action="<?php echo url_for('referentielcomptable/updateReferentiel ') .'?id=' . $referentiel->getId()?>">
    <fieldset>
        <table>
            <tr>
                <td>
                    <label>Rèfèrenteil Comptable * :</label></td>
                <td colspan="2">
