    ...
    <div class="widget-box widget-color-blue2 ui-sortable-handle" id="widget-box-2">
        ...
        <div class="widget-body">
            <div class="widget-main">
                <form action="<?php echo url_for('dossier/goPlanExcel') ?>" name="form_upload" role="form" method="post" enctype="multipart/form-data">
...
<div class="col-xs-12 col-sm-6 widget-container-col ui-sortable" id="widget-container-col-2">
    <div class="widget-box widget-color-blue2 ui-sortable-handle" id="widget-box-2">
        <div class="widget-header">
            <h5 class="widget-title bigger lighter"><i class="ace-icon fa fa-info"></i> Instructions : Import Plan Comptable</h5>
        </div>
        ...
        <div class="widget-body">
            <div class="widget-main">
                <div class="col-sm-12">
                    ...
                    <ol id="info_import">
                        <li>Télécharger le fichier <a href="<?php echo sfconfig::get('sf_appdir') ?>uploads/import_format/plan_comptable.xlsx" target="_blank"><i class="ace-icon fa fa-hand-o-right"></i> plan_comptable.xlsx <i class="ace-icon fa fa-file-excel-o green"></i></a></li>
                        <li>Saisir les données dans le fichier <i class="ace-icon fa fa-hand-o-right"></i> plan_comptable.xlsx
                            <br>
                            <span style="color: #9d4040;">(Ne supprimer pas les 2 premiers lignes, ne changer plus le 2ème ligne)</span>
                        </li>
                        <li>Upload le fichier <i class="ace-icon fa fa-hand-o-right"></i> plan_comptable.xlsx, puis envoyer</li>

                        <li>Traiter les données</li>
                        <li>Enregistrer et finaliser l'importation du plan comptable</li>
                    </ol>
                    <hr style="margin-bottom: 10px; margin-top: 10px;">
