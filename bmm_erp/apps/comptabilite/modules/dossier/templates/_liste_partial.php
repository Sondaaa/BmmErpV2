<?php if (count($pager) == 0): ?>
    <tr>
        <td style=" vertical-align: middle; text-align:center; font-weight: bold; font-size: 18px !important; height: 150px;" colspan="6">Liste des dossiers comptables  vide</td>
    </tr>
<?php endif; ?>
<!--$pager->getResults()!-->
<?php foreach ($pager->getResults() as $dossier): ?>
    <tr>
