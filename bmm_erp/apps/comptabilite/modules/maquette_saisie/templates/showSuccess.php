                ...
                <div class="widget-main">
                    <form>
                        <div class="mws-panel-body no-padding">
                            <table id="liste_ligne_show" style="margin-bottom: 0px;" class="table table-bordered table-hover">
                                <thead>
                                            ...
                                            <td>
                                                <div class="mws-form-row" style="text-align: center;">
                                                    ...
                                                    switch (trim($ligne->getSpecificationmontant())) {
                                                        ...
                                                        case 'saisimanuel':
                                                            $spécification_montant = 'Saisi Manuel';
                                                             break;
                                                        case 'fixe':
                                                ...
                                                <?php if (trim($ligne->getSpecificationmontant()) == 'saisimanuel'): ?>
                                                    <div class="mws-form-row" style="text-align: center;">
                                                        <!--<input type="text" disabled="disabled" value="<?php echo $ligne->getSpecificationmontant(); ?>">-->
                                                    </div>
                                                <?php endif; ?>
                                                    ...
                                                    <div class="mws-form-row" style="text-align: center;">
                                                        ...
                                                        if ($ligne->getIdContrepartie() != '' && $ligne->getIdComptecomptable() != null) {
                                                            ...
                                                            <input type="text" disabled="disabled" 
                                                                   value="<?php
                                                                   echo trim($numero_contrepartie) . ' - ' . $libelle_contrepartie;
                                                               }
                                                               ?>">
                                                    </div>
    <?php endif; ?>
