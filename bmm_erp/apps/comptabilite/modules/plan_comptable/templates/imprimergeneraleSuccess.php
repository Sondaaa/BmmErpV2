<div id="sf_admin_container">
    <h1 id="replacediv"> Base Comptable 
        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter Plan Comptable Général - Exercice <?php echo $_SESSION['exercice']; ?> => PDF</small>
    </h1>
</div>
...
//       . " AND id_exercice = " . $_SESSION['exercice_id']
        ...
        . " AND LENGTH(trim(plandossiercomptable.numerocompte)) <= 8"
...
<div class="row">
    <div class="col-sm-12">
        <button id="gpdf" style="float: right;" class="btn btn-xs btn-danger">
            <i class="ace-icon fa fa-file-pdf-o"></i> Exporter Plan.C.Général en PDF
        </button>
        <a target="_blank" href="<?php echo url_for('plan_comptable/exporterExcelPlangeneral') ?>"
           class="btn btn-xs btn-success "type="button"
           style="float: right;margin-right: 3px">
            <i class="ace-icon fa fa-file-excel-o "></i>
            Exporter Plan.C.Général vers Excel (.xlsx )
        </a>
    </div>
...
<script  type="text/javascript">
    ...
    var fileName = "Plan Comptable Général : <?php echo $_SESSION['exercice']; ?>";
    var margins = {
        top: 30,
        bottom: 20,
        left: 20,
    ...
    $(document).ready(function () {
        $("#gpdf").click(function () {
            ...
            function (dispose) {
                ...
                pdfdoc.save('Plan-comptable-general-<?php echo $_SESSION['exercice']; ?>.pdf' + '.pdf');
            },
                    margins
                    );
        });
