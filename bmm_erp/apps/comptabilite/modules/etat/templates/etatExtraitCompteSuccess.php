                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:left; padding-left: 1%; width: 35%; font-weight: bold;"></th>
                                <th style="text-align:left; padding-left: 1%; width: 10%; font-weight: bold;">Ordre</th>
                                <th style="text-align:left; padding-left: 1%; width: 15%; font-weight: bold;">Période</th>
                                <th style="text-align:left; padding-left: 1%; width: 15%; font-weight: bold;">Affichage</th>
                                <th style="text-align:left; padding-left: 1%; width: 10%; font-weight: bold;">Solde</th>
                                <th style="text-align:left; padding-left: 1%; width: 15%; font-weight: bold;"></th>
                            </tr>
                        </thead>
                        <tr>
                            <td>
                                Compte Comptable <select id="compte">
                                    <option value=''></option>
                                    <?php foreach ($comptes as $compte): ?>
                                        <option id="compte_<?php echo $compte->getNumerocompte(); ?>" value="<?php echo $compte->getId() ?>"> <?php echo $compte->getNumerocompte() . ' - ' . $compte->getLibelle(); ?> </option>
                                    <?php endforeach; ?>
                                </select>
                                <br>
                            ...
                            <td>
                                <br>
                                <input type="checkbox" id="non_lettre"/> Non Lettrées
                                <br><br><br>
                                <input type="checkbox" id="lettre"/> Lettrées
                            </td>
                            <td>
                                <br>
...
<!--<input type="checkbox" id="tout"/> Solde-->
                            </td>
                ...
                <div class="mws-panel grid_8" id="liste_etat_extrait_compte" style="margin-top: 15px;">
...
<script  type="text/javascript">
    ...
    function bloquerletrage() {
//        if ($('#non_lettre').is(':checked') == true)
//        {
//            $('#btn_anuler_lettrer').addClass("disabledbutton");
//            $('#btn_lettrer').addClass("disabledbutton");
//        }
//        else{
//            $('#btn_anuler_lettrer').removeClass('disabledbutton');
    ...
    function afficher() {
        ...
        if ($('#compte').val() == '') {
            ...
            $.ajax({
                ...
                data: 'compte=' + $('#compte').val() + '&journal=' + $('#journal').val() +
                        '&date_debut=' + $('#date_debut').val() + '&date_fin=' + $('#date_fin').val() +
                        '&order=' + order
                        + '&lettre=' + $('#lettre').is(':checked') +
                        '&non_lettre=' + $('#non_lettre').is(':checked')
...
//                $('#liste_etat_extrait_compte').html(data);
    ...
    function AddIDPiece(id) {
        ...
        else if ($('#txt_lettre_hiden_' + id).val() != '')
        {
