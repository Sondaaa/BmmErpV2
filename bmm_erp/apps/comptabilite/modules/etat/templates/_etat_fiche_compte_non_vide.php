...
<?php if ($etatFicheCompte->count() != 0): ?>
    <div class="row">
        <div class="col-xs-12">
            <div class="table-header" style="margin-bottom: 0px; background-color: #9585BF;">
                Comptes Comptables ( Sauf Vide ) :
                <a target="_blank" class="btn btn-sm btn-success" style="float: right; padding: 5px 12px;" href="<?php echo url_for("etat/imprimeEtatFicheNonVide?" . $url); ?>">
                    <i class="ace-icon fa fa-print bigger-110"></i>
                    <span class="bigger-110 no-text-shadow">Imprimer Tout</span>
                </a>
            </div>
            <div class="col-xs-12" style="border: 1px solid #9585BF; padding-top: 10px;">
                ...
                <?php foreach ($etatFicheCompte as $fiche): ?>
                    <?php if ($fermeture == 1): ?>
                        <div class="table-header" style="background: #82AF6F; border-color: #82AF6F;">
                            ...
                            <a target="_blank" class="btn btn-sm btn-purple" style="float: right; padding: 5px 12px;" href="<?php echo url_for("etat/imprimeEtatFicheOne?" . $url_compte); ?>">
                                <i class="ace-icon fa fa-print bigger-110"></i>
