...
$resultat_debit = '';
$resultat_credit = '';
$resultat_debit_precedent = '';
$resultat_credit_precedent = '';
            ...
            <table class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th style="width: 4%;">Référence</th>
<!--                        <th style="width: 7%;">Nature Pièce</th>-->
                        <th style="width: 5%;">N° Ext.</th>
                        <th style="width: 37%;">Libellé</th>
                ...
                <tbody>
                    <?php if ($date_debut != '' && $date_fin != ''): ?>
                        <?php if ($etatJournal_precedent->count() != 0): ?>
                            <?php foreach ($etatJournal_precedent as $fiche_prec): ?> 
                                <?php
                        ...
                        <tr style="font-size:11px;background-color:#F3F3F3">
                                <!--<td style="font-weight: bold; background-color: #eaf3f7;"><?php //echo $journal->getPlancomptable()->getPlandossiercomptable()->getNumerocompte()           ?></td>-->
                            <td colspan="5" style="font-weight: bold; text-align: left; "><?php echo $journal->getCode() . ' ' . $journal->getLibelle(); ?></td>                           
                            <td colspan="1" style="font-weight: bold;">Report</td>
                            <td style="text-align: right; font-weight: bold;font-size: 16px">
                                <?php
                                echo number_format($resultat_debit_precedent, 3, '.', ' ');
                                ?>
                            </td>
                            <td style="text-align: right; font-weight: bold;font-size: 16px">
                                <?php
                                echo number_format($resultat_credit_precedent, 3, '.', ' ');
                                ?>
                            </td>                                          
                        </tr>
                    <?php endif; ?>
                ...
                <?php if ($etatJournal->count() != 0): ?>
                    <tfoot>
                        ...
                        <tr style="background: repeat-x #F2F2F2;">
                            <td style="text-align: center; font-weight: bold; font-size: 18px" colspan="2" class="fixed-side" scope="col">Total Avec Report</td>
                            <td colspan="4"></td>
                            <td style="text-align: right; font-weight: bold;font-size: 16px">
                                <?php
                                echo number_format($resultat_debit + $resultat_debit_precedent, 3, '.', ' ');
                                ?>
                            </td>
                            <td style="text-align: right; font-weight: bold;font-size: 16px">
                                <?php
                                echo number_format($resultat_credit + $resultat_credit_precedent, 3, '.', ' ');
                                ?>
                            </td>
                        </tr>
