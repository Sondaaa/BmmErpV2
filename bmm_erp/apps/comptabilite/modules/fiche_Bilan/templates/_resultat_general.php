        ...
        <form class="mws-form">
            <div class="mws-form-inline">
                <legend>Paramétrage du Résultat
                    <button id="chargement_button_2" class="btn btn-xs btn-purple" style="float: right;" onclick="chargerPrecedentGeneral('2')"><i class="ace-icon fa fa-arrow-down"></i> Charger Paramétrage Précédent (<?php echo $_SESSION['exercice'] - 1; ?>)</button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_2_2" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe_2">
                        ...
                        <tr>
                            <td style="padding-left: 6%;">Achats de marchadises consommés</td>
                            <td style="text-align: center;">
                                <input value="" type="hidden" name="note_2">
                                <?php
                                $compte_decoche = '';
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                $compte_decoche = '';
                                $compte_coche = '';
                                if ($parametre_resultat[12]->getId() != ''):
                                    $params = ParametrebilancompteTable::getInstance()->findByIdParametrebilan($parametre_resultat[12]->getId());
                                    foreach ($params as $param_compte):
                                        if ($param_compte->getType() == 1)
                                            $compte_coche = $compte_coche . $param_compte->getIdCompte() . ',';
                                        else
                                ...
                                ?>
                                <input id="compte_decoche_2_12" value="<?php echo $compte_decoche; ?>" type="hidden" name="compte_decoche_2">
                                <input id="compte_coche_2_12" value="<?php echo $compte_coche; ?>" type="hidden" name="compte_coche_2">
                                <input id="parametre_id_2_12" value="<?php echo $parametre_resultat[12]->getId(); ?>" type="hidden">
                                <input id="regroupement_id_2_12" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe_2">

                                <button title="Ajouter par Compte" onclick="gererOneCompte2(12)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompte2(12)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Regroupper les Comptes" onclick="regrouperCompte2(12)" class="btn btn-xs btn-danger"><i class="ace-icon fa fa-file-text"></i>R</button>

                            </td>
                            <td>
                                <input type="text" value="<?php if ($parametre_resultat[12]->getId()) echo $parametre_resultat[12]->getPlandossiercomptable2(); ?>" id="compte_debut_2_12" onkeyup="chargerCompte('#compte_debut_2_12', '#hidden_compte_debut_2_12', '#compte_debut_2_12_libelle')"/>
                                <input type="hidden" value="<?php echo $parametre_resultat[12]->getIdComptedebut(); ?>" name="hidden_compte_debut_2" id="hidden_compte_debut_2_12" />
                                <input type="hidden" value="<?php echo $parametre_resultat[12]->getPlandossiercomptable2()->getNumerocompte(); ?>" id="compte_debut_2_12_libelle" />
                            </td>
                            <td>
                                <input type="text" value="<?php if ($parametre_resultat[12]->getId()) echo $parametre_resultat[12]->getPlandossiercomptable(); ?>" id="compte_fin_2_12" onkeyup="chargerCompte('#compte_fin_2_12', '#hidden_compte_fin_2_12', '#compte_fin_2_12_libelle')"/>
                                <input type="hidden" value="<?php echo $parametre_resultat[12]->getIdComptefin(); ?>" name="hidden_compte_fin_2" id="hidden_compte_fin_2_12" />
                                <input type="hidden" value="<?php echo $parametre_resultat[12]->getPlandossiercomptable()->getNumerocompte(); ?>" id="compte_fin_2_12_libelle" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                $compte_decoche = '';
                                $compte_coche = '';
                                if ($parametre_resultat[13]->getId() != ''):
                                    $params = ParametrebilancompteTable::getInstance()->findByIdParametrebilan($parametre_resultat[13]->getId());
                                    foreach ($params as $param_compte):
                                        if ($param_compte->getType() == 1)
                                            $compte_coche = $compte_coche . $param_compte->getIdCompte() . ',';
                                        else
                                ...
                                ?>
                                <input id="compte_decoche_2_13" value="<?php echo $compte_decoche; ?>" type="hidden" name="compte_decoche_2">
                                <input id="compte_coche_2_13" value="<?php echo $compte_coche; ?>" type="hidden" name="compte_coche_2">
                                <input id="parametre_id_2_13" value="<?php echo $parametre_resultat[13]->getId(); ?>" type="hidden">
                                <input id="regroupement_id_2_13" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe_2">

                                <button title="Ajouter par Compte" onclick="gererOneCompte2(13)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompte2(13)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Regroupper les Comptes" onclick="regrouperCompte2(13)" class="btn btn-xs btn-danger"><i class="ace-icon fa fa-file-text"></i>R</button>

                            </td>
                            <td>
                                <input type="text" value="<?php if ($parametre_resultat[13]->getId()) echo $parametre_resultat[13]->getPlandossiercomptable2(); ?>" id="compte_debut_2_13" onkeyup="chargerCompte('#compte_debut_2_13', '#hidden_compte_debut_2_13', '#compte_debut_2_13_libelle')"/>
                                <input type="hidden" value="<?php echo $parametre_resultat[13]->getIdComptedebut(); ?>" name="hidden_compte_debut_2" id="hidden_compte_debut_2_13" />
                                <input type="hidden" value="<?php echo $parametre_resultat[13]->getPlandossiercomptable2()->getNumerocompte(); ?>" id="compte_debut_2_13_libelle" />
                            </td>
                            <td>
                                <input type="text" value="<?php if ($parametre_resultat[13]->getId()) echo $parametre_resultat[13]->getPlandossiercomptable(); ?>" id="compte_fin_2_13" onkeyup="chargerCompte('#compte_fin_2_13', '#hidden_compte_fin_2_13', '#compte_fin_2_13_libelle')"/>
                                <input type="hidden" value="<?php echo $parametre_resultat[13]->getIdComptefin(); ?>" name="hidden_compte_fin_2" id="hidden_compte_fin_2_13" />
                                <input type="hidden" value="<?php echo $parametre_resultat[13]->getPlandossiercomptable()->getNumerocompte(); ?>" id="compte_fin_2_13_libelle" />
                            </td>
                        </tr>
                        <tr style="background-color: #F0F0F0;">
                ...
                <table style="margin-bottom: 0px;">
                    <tr>
                        <td>
                            ...
                            <a href="<?php echo url_for('fiche_Bilan/imprimerParametreBilanGeneral?type=2') ?>" target="_blank" class="btn btn-success"><i class="ace-icon fa fa-print"></i> Imprimer </a>
                        </td>
                    </tr>
                </table>
            </div>
