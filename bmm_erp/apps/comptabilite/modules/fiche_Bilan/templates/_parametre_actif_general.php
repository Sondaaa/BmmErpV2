        ...
        <form class="mws-form">
            <div class="mws-form-inline">
                <legend>Paramétrage des Actifs
                    <button id="chargement_button_0" class="btn btn-xs btn-purple" style="float: right;" onclick="chargerPrecedentGeneral('0')"><i class="ace-icon fa fa-arrow-down"></i> Charger Paramétrage Précédent (<?php echo $_SESSION['exercice'] - 1; ?>)</button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <button title="Ajouter par Compte" onclick="gererOneCompte(0)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(0)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_1" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">


                                <button title="Ajouter par Compte" onclick="gererOneCompte(1)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(1)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_2" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(2)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(2)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_3" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(3)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(3)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_4" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(4)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(4)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_5" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(5)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(5)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_6" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(6)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(6)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_7" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(7)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(7)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_8" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(8)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(8)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_9" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(9)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(9)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_10" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(10)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(10)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_11" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(11)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(11)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_12" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(12)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(12)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_13" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(13)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(13)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <input id="regroupement_id_14" value="<?php echo $regroupement; ?>" type="hidden" name="compte_regroupe">

                                <button title="Ajouter par Compte" onclick="gererOneCompte(14)" class="btn btn-xs btn-success"><i class="ace-icon fa fa-file-text"></i></button>
                                <button title="Gèrer Tous les Comptes" onclick="gererCompteA(14)" class="btn btn-xs btn-primary"><i class="ace-icon fa fa-file-text"></i></button>
