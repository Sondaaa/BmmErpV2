...
<div class="row">
    <div class="col-xs-6" style="text-align: center; padding-top: 40px;">
        ...
        <button class="btn btn-sm btn-purple" onclick="dupliquerPiece('<?php echo $piece->getId() ?>')">
            <i class="ace-icon fa fa-files-o bigger-110"></i>
            <span class="bigger-110 no-text-shadow">Dupliquer</span>
        </button>
...
<div style="margin-top: 20px" id="zone_duplication">
