...
<?php foreach ($pager->getResults() as $i=>$piece): ?>
    <tr id="ligne_<?php echo $i ?>" onclick="formatLigne(<?php echo $i ?>)" index_ligne="<?php echo $i ?>" ondblclick="showPiece('<?php echo $piece->getId() ?>')">
        ...
        <td style="text-align: center;"> <?php echo $piece->getDateLiberation() ?></td>
        <td style="cursor: pointer; text-align: center;">
            <span class="btn-group">
                ...
                <!--<a style="cursor: pointer" onclick="showProprietePiece('<?php //echo $piece->getId() ?>')" class="btn btn-small"><i class="icon-light-bulb"></i></a>-->
                <a style="cursor: pointer" title="Imprimer" onclick="imprimerPiece('<?php echo $piece->getId() ?>')" class="btn btn-small"><i class="icon-print"></i></a>
