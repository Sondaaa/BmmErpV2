...
<div class="mws-panel grid_8" id="form_liste_piece">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">Liste des Pièces Libérées Comptables
            <div style="float:right; cursor:pointer;">
                <a href="<?php echo url_for('@saisiePieces') ?>" style="color: #c5d52b;" ><img style="width: 16px;" src="/images/icon/add.png" /> Ajouter Pièce </a>
            </div>
        </span>
    </div>
            ...
            <table id="listPiece" class="mws-datatable-fn mws-table">
                <thead>
                    <tr id="list_tri" style="border-bottom: 1px solid #000000" >
                        ...
                        <th style="width: 5%;">Date Libération</th>
                ...
                <tfoot>
                    <tr>
                        <td style="width: 100%;padding: 0" colspan="9">
                            <div id="list_piece_pager" style="background: none repeat scroll 0 0 #444444;width: 100%;float: left"></div>
                        </td>
                    </tr>
                </tfoot>
                <tbody>
                    <?php include_partial("operation_piece/liste_piece_libere", array("pager" => $pager, "page" => $page)) ?>
                </tbody>
            </table>
        </div>
    </div>
...
<script  type="text/javascript">
    ...
    function goPage(page) {
        ...
        type = 'ligne_' + type;
        $.ajax({
            url: '<?php echo url_for('@goPagePieceLibere'); ?>',
    ...
    function showPiece(id) {
        $.ajax({
            url: '<?php echo url_for('@showPieceDuplique') ?>',
            data: 'id=' + id,
            success: function(data) {
    ...
    function showProprietePiece(id) {
        $.ajax({
            url: '<?php echo url_for('@showProprietePieceDuplique') ?>',
            data: 'id=' + id,
            success: function(data) {
