        ...
        <form class="mws-form">
            <div class="mws-form-inline" >
                <div class="mws-panel-header">
                    <span>Propriétés de la Pièce</span>
                </div>
        ...
        <table style="width: 100%">
            <tr>
                <td>
                    <div class="btn-toolbar">
                        <div class="btn-group" style="width: 100%;">
                            <a class="btn" style="float: right; margin-right: 3%; cursor:pointer;" href="<?php echo url_for('@listePiece') ?>"  ><i class="icol-cross"></i> Fermer</a>
                        </div>
                    </div>
