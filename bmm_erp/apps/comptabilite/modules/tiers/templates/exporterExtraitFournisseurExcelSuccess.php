<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" 
                onclick="exportTableToExcel('PDFcontent', 'Etat-Extrait-Auxiliaire-Fournisseur-<?php echo $_SESSION['exercice']; ?>')" 

                >
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Extrait Auxiliaire  Fournisseur vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv"> 
        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter  Extrait Auxiliaire  Fournisseur <?php echo $fournisseur->getCodefrs() . ' ' . $fournisseur->getRs() ?>  => Excel</small>
    </h1>
...
$query = "SELECT CONCAT('<tr><td>', piececomptable.date,'</td>"
        ...
        . ",lignepiececomptable,Facturecomptableachat,Facturecomptableod,Fournisseur"
        . " WHERE lignepiececomptable.id_factureachat=Facturecomptableachat.id"
//        . " AND lignepiececomptable.id_factureod=Facturecomptableod.id"
        . " AND "
        . "Facturecomptableachat.id_fournisseur=" . $compte
//        . " Or ( lignepiececomptable.id_factureod=Facturecomptableod.id and Facturecomptableod.id_fournisseur=" . $compte . ')'
