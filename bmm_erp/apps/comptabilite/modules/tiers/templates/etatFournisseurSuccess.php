<div id="sf_admin_container">
    <h1 id="replacediv"> Tiers
        <small>
            ...
            Extrait Auxiliaire Fournissuer
        </small>
    </h1>
</div>
                            ...
                            <td>
                                ...
                                <select id="id_frs">
                                    ...
                                    <?php foreach ($fournisseur as $frs): ?>
                                        <option id="frs_<?php echo $frs->getId(); ?>" value="<?php echo $frs->getId() ?>"> <?php echo $frs->getCodefrs() . ' - ' . $frs->getRs(); ?> </option>
                                    <?php endforeach; ?>
                                </select>
...
<script  type="text/javascript">
    ...
    function afficher() {
        ...
        if ($('#id_frs').val() == '') {
            ...
            $.ajax({
                url: '<?php echo url_for('tiers/afficherEtatExtraitCompteFournissuer') ?>',
                data: 'id_frs=' + $('#id_frs').val() + '&journal=' + $('#journal').val() +
