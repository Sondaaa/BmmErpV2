...
<div class="row" ng-controller="myCtrlPaysVille">
    <div class="col-xs-12">
        <div class="table-header" style="background: #82AF6F; border-color: #82AF6F;">
            Extrait Client :
            <a target="_blank" class="btn btn-sm btn-primary" style="float: right; padding: 5px 12px;" href="<?php echo url_for("tiers/imprimeEtatExtraitClient?" . $url); ?>">
                <i class="ace-icon fa fa-print bigger-110"></i>
                <span class="bigger-110 no-text-shadow">Imprimer Extrait </span>
            </a>
            <a target="_blank" class="btn btn-sm btn-default" style="float: right; padding: 5px 12px; margin-left: 3px" href="<?php echo url_for("tiers/exporterExtraitClientExcel?=" . $url); ?>">
