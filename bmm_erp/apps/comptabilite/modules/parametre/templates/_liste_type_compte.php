<?php if ($pager->count() == 0): ?>
    <tr>
        <td style="text-align:center; font-weight: bold; font-size: 16px !important;" colspan="2">Liste des types des comptes comptables vide</td>
    </tr>
<?php endif; ?>
<?php foreach ($pager->getResults() as $type_compte): ?>
    <tr>
        <td><?php echo  $type_compte->getLibelle()  ?></td>
        <td style="text-align: center;">
            <button type="button" class="btn btn-white btn-info btn-sm" onclick="editForme('<?php echo $type_compte->getId() ?>')" style="text-align: center;">
                Modifier
                <i class="ace-icon fa fa-edit icon-on-right bigger-110"></i>
            </button>
            <button type="button" class="btn btn-white btn-danger btn-sm" onclick="deleteForme('<?php echo $type_compte->getId() ?>')" style="text-align: center;">
                Supprimer
