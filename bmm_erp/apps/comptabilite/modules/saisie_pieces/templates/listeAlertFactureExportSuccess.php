<div class="mws-panel grid_8" id="form_liste_piece">
    <div class="mws-panel-header">
        <span class="mws-i-24 i-table-1">Liste des Factures Export non Traitées</span>
    </div>
    ...
    <div class="mws-panel-body">
            <table id="listFacture" class="mws-datatable-fn mws-table">
                ...
                <tbody>
                    <?php include_partial("saisie_pieces/listeAlertFactureVente", array("pager" => $pager, "page" => $page)) ?>
                </tbody>
            </table>
    </div>
</div>
...
<script  type="text/javascript">
    ...
    function goPage(page) {
        ...
        $.ajax({
            url: '<?php echo url_for('@listeAlertFactureExport'); ?>',
            data: 'page=' + page + '&ref=' + ref +
                    '&client=' + client + '&dossier=' + dossier,
