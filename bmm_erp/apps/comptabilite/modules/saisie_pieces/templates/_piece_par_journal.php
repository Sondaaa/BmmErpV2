...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header">
            Journal Comptable : <?php
                                echo $journal->getCode() . ' - ' . $journal->getLibelle();
                                ?>
        ...
        <div>
            <table class="table table-bordered table-hover" id="listPiece">
                ...
                <tbody>
                        ...
                        ?>
                            ...
                            <tr style="background: <?php echo $Str_Row_Color ?>">
                                ...
                                <td style="text-align: left;">
                                    ...
                                    <?php elseif ($fiche->getPiececomptable()->getLibelle()) : ?>
                                ...
                                <td style="cursor: pointer; text-align: center;">
                                    ...
                                    ?>
                                        <span class="btn-group">
                                            <a class="btn btn-danger btn-xs" onclick="openPopupSupprimerForm(<?php echo $fiche->getPiececomptable()->getId() ?>)"><i class="ace-icon fa fa-trash"></i></a>
                                        </span>
                                    <?php else : ?>
                                        <span class="btn-group">
                    ...
                    <?php else : ?>
                        <tr>
                            <td style="text-align:center; font-weight: bold; font-size: 16px !important; height: 100px; vertical-align: middle;" colspan="10">Pas de Pièces Comptables dans ce Journal Comptable</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
                <?php if ($etatJournal->count() != 0) : ?>
