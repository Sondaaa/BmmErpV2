<div id="sf_admin_container">
    <h1 id="replacediv"> Importation 
        <small>
            ...
            Liste des Mouvements Comptables  saisies  : <?php echo $_SESSION['exercice']; ?>
        </small>
    </h1>
</div>
...
<div class="row">
    <div class="col-xs-12">
        <div class="table-header" style="margin-bottom: 0px;">
            Liste des Mouvements Comptables  Saisie :
            <?php
            ...
            <table id="listFacture" class="mws-datatable-fn mws-table">
                <thead>
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th><input type="text" id="numero" onkeyup="goPageMouement(1);" style="width: 100%;" /></th>
                        <th><input id="libelle" onkeyup="goPageMouement(1);" type="text" style="width: 100%;" /></th>
                       
                        <th></th>
                       
                        <th><input id="type" onkeyup="goPageMouement(1);" type="text" style="width: 100%;" /></th>
                ...
                <tbody>
                    <?php include_partial("importation/liste_mouvement_saisie", array("pager" => $pager, "page" => $page, "numero" => $reference)) ?>
                </tbody>
            </table>
        </div>
    </div>
...
<script  type="text/javascript">
   function goPageMouement(page) {
        var numero = $('#numero').val();
        var libelle = $('#libelle').val();
        var type = $('#type').val();
        
        $.ajax({
            url: '<?php echo url_for('importation/goPageMouvementSaisie'); ?>',
