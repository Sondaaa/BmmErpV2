<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        <span><i class="icon-magic"></i> Annuler Importation des Factures Achat</span>
    </div>
...
//            }
            ...
            if (valide) {
                var etranger = 0;
                $.ajax({
                    url: '<?php echo url_for('@getFactureAchatImportForAnnuler') ?>',
...
//                        $('.pp_loaderIcon').fadeOut();
        ...
        var factures = '';
         ...
         if(factures != ''){
             var etranger = 0;
            $.ajax({
                url: '<?php echo url_for('@getFactureAchatAnnuler') ?>',
