<div style="font-size: 14px; margin-bottom: 10px">
    <b>Mouvement comptable N°:</b> <?php echo $facture->getNumero() ?>
</div>
...
<table style="width: 100%;" class="table table-bordered table-hover" cellspacing="0" cellpadding="0" border="0">
    ...
    <tbody>
          <?php if(trim($facture->getType())=='Débit'): ?>
        <tr>
            <td>
            ...
            <td><input class="align_right" style="width: 100%;" type="text" id="debit_0" value="<?php echo number_format($facture->getMontant() , 3, '.', ' ') ?>" readonly="true"/></td>
        ...
        <tr>
            ...
            <td><input class="align_right" style="width: 100%;" id="credit_2" type="text" value="<?php echo number_format($facture->getMontant(), 3, '.', ' ') ?>" readonly="true"/></td>
        ...
        <tr>
            ...
            <td><input class="align_right" style="width: 100%;" type="text" id="debit_0" value="" readonly="true"/></td>
            <td><input class="align_right"  type="text" style="width: 100%;" value="<?php echo number_format($facture->getMontant() , 3, '.', ' ') ?>" id="credit_0" readonly="true"/></td>
            <td name="contre_partie" td_contre_id="0">
                <input type="text" value="" name="ligne_contre" id="ligne_contre_0" onfocus="chargerCompte('#ligne_contre_0', '#hidden_ligne_contre_0', '#ligne_contre_libelle_0')" onkeyup="chargerCompte('#ligne_contre_0', '#hidden_ligne_contre_0', '#ligne_contre_libelle_0')"/>
                <input type="hidden" value="" name="hidden_ligne_contre" id="hidden_ligne_contre_0" />
                <div name="ligne_contre_libelle" id="ligne_contre_libelle_0" class="mws-form-row" style="text-align: justify; margin-left: 2%;">
        ...
        <tr>
            ...
            <td><input class="align_right" type="text" style="width: 100%;" value="<?php echo number_format($facture->getMontant(), 3, '.', ' ') ?>" id="debit_2" readonly="true"/></td>
            <td><input class="align_right" style="width: 100%;" id="credit_2" type="text" value="" readonly="true"/></td>
            <td name="contre_partie" td_contre_id="2">
                <input type="text" value="" name="ligne_contre" id="ligne_contre_2" onfocus="chargerCompte('#ligne_contre_2', '#hidden_ligne_contre_2', '#ligne_contre_libelle_2')" onkeyup="chargerCompte('#ligne_contre_2', '#hidden_ligne_contre_2', '#ligne_contre_libelle_2')"/>
                <input type="hidden" value="" name="hidden_ligne_contre" id="hidden_ligne_contre_2" />
                <div name="ligne_contre_libelle" id="ligne_contre_libelle_2" class="mws-form-row" style="text-align: justify; margin-left: 2%;">
                                    ...
                                    <td style="width: 33%">
                                        <div class="mws-form-row">
                                            ...
                                            <div class="mws-form-item">
                                                <input class="align_right" id="total_debit" type="text" disabled="disabled" value="<?php echo number_format($facture->getMontant(), 3, '.', ' ') ?>" style="width: 100%;">
                                            </div>
                                        </div>
                                    </td>
                                    <td style="width: 33%">
                                        <div class="mws-form-row">
                                            Total Crédit :
                                            <div class="mws-form-item">
                                                <input class="align_right" id="total_credit" type="text" disabled="disabled" value="<?php echo number_format($facture->getMontant(), 3, '.', ' ') ?>" style="width: 100%;">
                                            </div>
                                        </div>
                                    </td>
                                    <td style="width: 33%">
