...
<div id="sf_admin_container">
    <h1 id="replacediv"> Retenue à la Source Client  
...
<div class="col-xs-12 col-sm-12" style="margin-bottom: 10px;">
    ...
    <a class="btn  btn-success pull-right" href="<?php echo url_for('importation/odExcelClient') ?>"><i class="ace-icon fa fa-undo"></i> Initialiser l'import</a>
</div>
...
//                data: 'libelles=' + libelles,
    ...
    function makeTableFromColumn() {
        ...
        text_table_facture = text_table_facture + '<thead><tr>\n\
                            ...
                            <th style="text-align:center;">Code Clinet</th>\n\
                            <th>Client</th>\n\
...
//                }
        ...
        <tr style="background-color: #DCDCDC"><td></td><td>Total</td>\n\
...
//            console.log('compte=' + numero + 'retenue=' + comptes_retenue);
            ...
            if (k == next_k) {
                $.ajax({
                    url: '<?php echo url_for('importation/saveFactureodClient') ?>',
                    data: 'numero=' + numero +
                            '&date=' + date +
