<div id="sf_admin_container">
    <h1 id="replacediv"> Importation 
        <small>
            ...
            Importer Achat : <?php echo $_SESSION['exercice']; ?>
        </small>
    </h1>
</div>
...
<div class="widget-box">
    <div class="widget-header widget-header-blue widget-header-flat">
        <h4 class="widget-title lighter">Importation des Factures Achats</h4>
    </div>
            ...
            <div id="import-fuelux-wizard-container">
                ...
                <div class="step-content pos-rel">
                    ...
                    <div class="step-pane" data-step="2">
                        <div id="zone_step_2">
                            <h4 class="lighter block green">Choix des factures achats à importer.</h4>
                            <div class="row">
                    ...
                    <div class="step-pane" data-step="3">
                        <div id="zone_radio_2_1">
                            <h4 class="lighter block green">Confirmation de la liste des factures achats à importer.</h4>
                            <div class="row">
                                <div class="col-md-offset-1 col-md-10" style="position: unset;">
                                    <label style="font-size: 18px; font-weight: bold;">Liste des factures achats à importer :</label>
                    ...
                    <div class="step-pane" data-step="4">
                        ...
                        <div class="center" id="final_success" style="display: none;">
                            ...
                            Facture(s) d'achat importée(s) avec succès.
                        </div>
                    </div>
                </div>
            </div>
...
<script  type="text/javascript">
    ...
    function choisirTransfert() {
        ...
        if (valide) {
            $.ajax({
                url: '<?php echo url_for('importation/getFactureAchat') ?>',
    ...
    function validerTransfert() {
        ...
        if (factures != '') {
            ...
            $.ajax({
                url: '<?php echo url_for('importation/saveFactureAchatImport') ?>',
                data: 'ids=' + factures,
                success: function (data) {
                    $("#progressbar").progressbar({
                        value: 66,
...
<script  type="text/javascript">
    document.title = ("BMM - G. Compta. : Importer les Achats");
</script>