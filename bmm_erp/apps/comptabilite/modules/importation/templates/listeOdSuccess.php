    ...
    <div class="col-xs-12">
        ...
        <div class="col-xs-12" style="border: 1px solid #307ECC; padding-top: 10px;">
            <table id="listFacture" class="mws-datatable-fn mws-table">
                ...
                <tbody>
                    <?php include_partial("importation/liste_od", array("pager" => $pager, "page" => $page, "reference" => $reference, "fournisseur" => $fournisseur)) ?>
                </tbody>
            </table>
        </div>
    </div>
...
<script  type="text/javascript">
    ...
    function goPageOd(page) {
        ...
        var fournisseur = $('#fournisseur').val();
        $.ajax({
            url: '<?php echo url_for('importation/listeOd'); ?>',
    ...
    function saisir(id) {
        ...
        $.ajax({
            url: '<?php echo url_for('importation/saisirFactureOd') ?>',
            data: 'id=' + id +
                    '&id_compte=' + id_compte +
                    '&debit=' + debit +
                    '&credit=' + credit +
