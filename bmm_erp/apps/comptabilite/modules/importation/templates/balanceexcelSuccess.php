    ...
    <div class="widget-box widget-color-blue2 ui-sortable-handle" id="widget-box-2">
        ...
        <div class="widget-body">
            <div class="widget-main">
                <form action="<?php echo url_for('importation/goBalanceExcel') ?>" name="form_upload" role="form" method="post" enctype="multipart/form-data">
...
<div class="col-xs-12 col-sm-6 widget-container-col ui-sortable" id="widget-container-col-2">
    <div class="widget-box widget-color-blue2 ui-sortable-handle" id="widget-box-2">
        <div class="widget-header">
            <h5 class="widget-title bigger lighter"><i class="ace-icon fa fa-info"></i> Instructions : Import Balance</h5>
        </div>
        ...
        <div class="widget-body">
            <div class="widget-main">
                <div class="col-sm-12">
                    ...
                    <ol id="info_import">
                        <li>Télécharger le fichier <a href="<?php echo sfconfig::get('sf_appdir') ?>uploads/import_format/balance.xlsx" target="_blank"><i class="ace-icon fa fa-hand-o-right"></i> balance.xlsx <i class="ace-icon fa fa-file-excel-o green"></i></a></li>
