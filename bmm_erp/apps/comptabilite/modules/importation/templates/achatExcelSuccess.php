        ...
        <div class="widget-body">
            <div class="widget-main">
                <div class="col-sm-12">
                    ...
                    <ol id="info_import">
                        <li>Télécharger le fichier <a href="<?php echo sfconfig::get('sf_appdir') ?>uploads/import_format/achat_comptabilite.xlsx" target="_blank"><i class="ace-icon fa fa-hand-o-right"></i> achat_comptabilite.xlsx <i class="ace-icon fa fa-file-excel-o green"></i></a></li>
                        <li>Saisir les données dans le fichier <i class="ace-icon fa fa-hand-o-right"></i> achat_comptabilite.xlsx
                            <br>
