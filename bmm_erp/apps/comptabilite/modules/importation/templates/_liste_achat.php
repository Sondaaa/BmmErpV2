        ...
        <td style="cursor: pointer; text-align: center;">
            <span class="btn-group">
                <?php if ($facture->getIdFacture() != null): ?>
                    ...
                    <a target="_blank" class="btn btn-xs btn-success" title="Afficher" href="<?php echo url_for('importation/detailfacture?id=') . $facture->getIdFacture() ?>">
                        <i class="ace-icon fa fa-eye"></i> <?php // echo $facture->getNumerodocachat()  ?>
                    </a>              
                <?php endif; ?>
