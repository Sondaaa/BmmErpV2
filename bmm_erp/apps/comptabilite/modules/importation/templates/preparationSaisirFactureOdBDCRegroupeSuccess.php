<div style="font-size: 14px; margin-bottom: 10px">
    <b>Facture OD N°:</b> <?php echo $facture->getReference() ?>
</div>
...
<table style="width: 100%" class="table table-bordered table-hover" cellspacing="0" cellpadding="0" border="0">
    ...
    <tbody>
        <tr>
            <td>
                <input type="text" value="<?php // echo $facture->getPlancomptable(); ?>" name="ligne_compte" id="ligne_compte_1" onfocus="chargerCompte('#ligne_compte_1', '#hidden_ligne_compte_1', '#ligne_compte_libelle_1')" onkeyup="chargerCompte('#ligne_compte_1', '#hidden_ligne_compte_1', '#ligne_compte_libelle_1')" onkeydown="moveToNext(event, 'ligne_compte', 1)"/>
                <input type="hidden" value="<?php // echo $facture->getPlancomptable()->getPlandossiercomptable()->getLast()->getId(); ?>" name="hidden_ligne_compte" id="hidden_ligne_compte_1" />
                <div name="ligne_compte_libelle" id="ligne_compte_libelle_1" class="mws-form-row" style="text-align: justify; margin-left: 2%;">
                    <?php // echo $facture->getPlancomptable(); ?>
                </div>
            </td>
            <td><input class="align_right" style="width: 100%;" type="text" id="debit_1" value="<?php echo number_format($facture->getTimbre(), 3, '.', ' ') ?>" readonly="true"/></td>
        ...
        <tr>
            ...
            <td><input class="align_right" style="width: 100%;" id="credit_0" type="text" value="<?php echo number_format($facture->getTimbre(), 3, '.', ' ') ?>" readonly="true"/></td>
                                    ...
                                    <td style="width: 33%">
                                        <div class="mws-form-row">
                                            ...
                                            <div class="mws-form-item">
                                                <input class="align_right" id="total_debit" type="text" disabled="disabled" value="<?php echo number_format($facture->getTimbre(), 3, '.', ' ') ?>" style="width: 100%;">
                                            </div>
                                        </div>
                                    </td>
                                    <td style="width: 33%">
                                        <div class="mws-form-row">
                                            Total Crédit :
                                            <div class="mws-form-item">
                                                <input class="align_right" id="total_credit" type="text" disabled="disabled" value="<?php echo number_format($facture->getTimbre(), 3, '.', ' ') ?>" style="width: 100%;">
                                            </div>
                                        </div>
                                    </td>
                                    <td style="width: 33%">
