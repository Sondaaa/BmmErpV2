<div style="font-size: 14px; margin-bottom: 10px">
    <b>Facture Vente N°:</b> <?php echo $facture->getNumero() ?>
</div>
...
<table style="width: 100%" class="table table-bordered table-hover" cellspacing="0" cellpadding="0" border="0">
    <tbody>
        <tr>
            ...
            <td style="width: 15%">
                Type Pièce
                <input readonly="true" type="text" value="REGLEMENT" />
            </td>
            <td style="width: 12%">
                N° Externe
...
<table style="width: 100%" class="table table-bordered table-hover" cellspacing="0" cellpadding="0" border="0">
    ...
    <tbody>
        <?php if(trim($facture->getType())=='Crédit'): ?>
        <tr>
            <td>
                <input type="text" value="<?php echo $facture->getPlandossiercomptable() ?>" name="ligne_compte" id="ligne_compte_0" onfocus="chargerCompte('#ligne_compte_0', '#hidden_ligne_compte_0', '#ligne_compte_libelle_0')" onkeyup="chargerCompte('#ligne_compte_0', '#hidden_ligne_compte_0', '#ligne_compte_libelle_0')" onkeydown="moveToNext(event, 'ligne_compte', 1)"/>
                <input type="hidden" value="<?php echo $facture->getIdComptecomptable(); ?>" name="hidden_ligne_compte" id="hidden_ligne_compte_0" />
            ...
            <td><input type="text" class="align_right" style="width: 100%;" value="0" id="debit_0" readonly="true"/></td>
        ...
        <tr>
            ...
            <td><input type="text" style="width: 100%;"  class="align_right" value="0" id="debit_1" readonly="true"/></td>
            <td><input class="align_right" style="width: 100%;"  class="align_right" id="credit_1" type="text" value="<?php echo number_format($facture->getTotaltva(), 3, '.', ' ') ?>" readonly="true"/></td>
        ...
        <tr>
            <td >
                <input type="text" value="" name="ligne_compte" id="ligne_compte_2" onfocus="chargerCompte('#ligne_compte_2', '#hidden_ligne_compte_2', '#ligne_compte_libelle_2')" onkeyup="chargerCompte('#ligne_compte_2', '#hidden_ligne_compte_2', '#ligne_compte_libelle_2')"><?php echo "";?>
            ...
            <td><input class="align_right" style="width: 100%;" type="text" id="debit_2" value="<?php echo number_format($facture->getTotalttc(), 3, '.', ' ') ?>" readonly="true"/></td>
            <td><input type="text" style="width: 100%;" value="0"  class="align_right" id="credit_2" readonly="true"/></td>
        ...
        <tr>
            ...
            <td><input type="text"class="align_right" style="width: 100%;"  id="debit_0" value="<?php echo number_format($facture->getTotalht(), 3, '.', ' ') ?>"  readonly="true"/></td>
            <td><input class="align_right" style="width: 100%;" id="credit_0" type="text" value="" readonly="true"/></td>
            <td name="contre_partie" td_contre_id="0">
                <input type="text" value="" name="ligne_contre" id="ligne_contre_0" onfocus="chargerCompte('#ligne_contre_0', '#hidden_ligne_contre_0', '#ligne_contre_libelle_0')" onkeyup="chargerCompte('#ligne_contre_0', '#hidden_ligne_contre_0', '#ligne_contre_libelle_0')"/>
                <input type="hidden" value="" name="hidden_ligne_contre" id="hidden_ligne_contre_0" />
                <div name="ligne_contre_libelle" id="ligne_contre_libelle_0" class="mws-form-row" style="text-align: justify; margin-left: 2%;">
        ...
        <tr>
            ...
            <td><input type="text" class="align_right" style="width: 100%;" value="<?php echo number_format($facture->getTotaltva(), 3, '.', ' ') ?>" id="debit_1" readonly="true"/></td>
            <td><input class="align_right" style="width: 100%;" id="credit_1" type="text" value="" readonly="true"/></td>
            <td name="contre_partie" td_contre_id="1">
                <input type="text" value="" name="ligne_contre" id="ligne_contre_1" onfocus="chargerCompte('#ligne_contre_1', '#hidden_ligne_contre_1', '#ligne_contre_libelle_1')" onkeyup="chargerCompte('#ligne_contre_1', '#hidden_ligne_contre_1', '#ligne_contre_libelle_1')"/>
                <input type="hidden" value="" name="hidden_ligne_contre" id="hidden_ligne_contre_1" />
                <div name="ligne_contre_libelle" id="ligne_contre_libelle_1" class="mws-form-row" style="text-align: justify; margin-left: 2%;">
        ...
        <tr>
            ...
            <td><input class="align_right" style="width: 100%;" type="text" id="debit_3" value="" readonly="true"/></td>
            <td><input  class="align_right" type="text" style="width: 100%;" value="<?php echo number_format($facture->getTotalttc(), 3, '.', ' ') ?>" id="credit_3" readonly="true"/></td>
            <td name="contre_partie" td_contre_id="2">
