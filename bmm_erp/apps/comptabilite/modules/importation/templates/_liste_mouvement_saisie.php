<?php if (count($pager) == 0): ?>
    <tr>
        <td style="text-align:center; font-weight: bold; font-size: 16px !important;" colspan="10">Liste des Mouements Vide</td>
    </tr>
<?php endif; ?>
<?php foreach ($pager->getResults() as $facture): ?>
    <tr>
        ...
        <td style="text-align: right;"><?php echo  number_format($facture->getMontant(), 3, '.', ' ')  ?></td>
