    ...
    <div id="sf_admin_content">
        ...
        <div  class="panel-body" >
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a id="profileNiveaueducatif" href="#profile" data-toggle="tab" aria-expanded="false" ng-click="InialiserChampsSelect()">
                        <i class="green ace-icon fa fa-money bigger-120"></i>Niveau Educatif
                    </a>
                </li>
                <li><a id="profilesociale" href="#sociale" data-toggle="tab" aria-expanded="false" ng-click="InialiserChampsSelect();">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><label>Prénom & <span class="required">*</span> Prénom Père </label></td>
                                        <td>
                                    ...
                                    <tr>  
                                        <td><label>Lieu Naissacance <span class="required">*</span></label></td>
                                        <td>
