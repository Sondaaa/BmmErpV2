    ...
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            <div class="widget-main" style="padding: 7%; text-align: center; min-height: 265px;">
                <a target="_blank" class="btn btn-outline btn_new btn-success" href="<?php echo url_for('transfertbudget/imprimerListe') ?>" style="text-align: center;height: 55px !important; width: 250px; font-size: 14px !important; margin-top: 5px;">Imprimer Liste<br>des Transferts</a>
                <br>
                <a target="_blank" class="btn btn-outline btn_new btn-success" href="<?php echo url_for('transfertbudget/imprimerListe?annee=' . date('Y')) ?>" style="text-align: center;height: 55px !important; width: 250px; font-size: 14px !important; margin-top: 5px;">Imprimer Liste<br>des Transferts - <?php echo date('Y'); ?></a>
            </div>
        </div>
    </div>
</div>
