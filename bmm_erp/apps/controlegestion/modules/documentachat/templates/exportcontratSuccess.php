...
<!--                                            <td style="text-align: center; vertical-align: middle;">
                                                <button class="btn btn-primary btn-xs" ng-click="AjouterFournisseur1()">
                                                    <i class="ace-icon fa fa-plus bigger-110 icon-only"></i>
                                                </button>
                                                <input type="button" value="+" class="btn btn-primary" data-toggle="modal"  >
                                            </td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <button class="btn btn-default btn-xs" ng-click="ViderFournisseur1()">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center">Désignation du travaux</th>
                            ...
                            <tbody>
                                <tr style="background-color: #EDEDED;">
                                    ...
                                    <td>
                                        <textarea id="designation" style="height: 34px;"></textarea>
                                    </td>
                                    <td>
                                        <select id="unite">
                                            <option></option>
                                    ...
                                    <td>
                                        <textarea id="observation" class="form-control" style="height: 34px;"></textarea>
                                    </td>
                                ...
                                <tr ng-repeat="item in detailscontrats">
                                    ...
                                    <td style="text-align: center;">
                                        <a class="btn btn-primary" ng-click="UpdateDetail(item.norgdre)" > 
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a class="btn btn-danger" ng-click="DeleteLigneContrat(item.norgdre)" >
