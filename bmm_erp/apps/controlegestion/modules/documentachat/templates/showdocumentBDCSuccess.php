    ...
    <div id="sf_admin_content">
        ...
        <?php if ($documentachat->getIdTypedoc() == 19 || $documentachat->getIdTypedoc() == 17 || $documentachat->getIdTypedoc() == 18 || $documentachat->getIdTypedoc() == 21): ?>
            <fieldset>
                <div class="col-md-9">
                    ...
                    <?php
                    if ($documentachat->getPiecejointbudget()->getFirst())
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 15%;"><?php if ($document_budget) echo date('d/m/Y', strtotime($document_budget->getDatecreation())); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F2F2F2;">Budget</td>
                                <td colspan="3"><?php if ($document_budget) echo $document_budget->getLigprotitrub()->getTitrebudjet(); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F2F2F2;">Rubrique</td>
                                <td colspan="3"><?php if ($document_budget) echo $document_budget->getLigprotitrub()->getRubrique(); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F2F2F2;">Montant Engagé</td>
                                <td><?php if ($document_budget) echo number_format($document_budget->getMnt(), 3, '.', ' '); ?> TND</td>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>  <button class="btn btn-xs btn-primary pull-right" onclick="valider('<?php echo $documentachat->getId() ?>')">
                                    ...
                                    <table class="tableligne" style="width:100%">
                                        <thead>
                                            <tr style="background-color:#EDEDED;font-weight:bold;">
                                                ...
                                                <th style="text-align:center;width: 10%">Qte(Unité) </th>
                                                ...
                                                <?php } ?>
                                                <th style="text-align:center;width: 10%">M.TTC.Net</th>
                                            </tr>                                                  
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            foreach ($listesdocuments as $lignedoc) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        ...
                                                        //echo $qtedemander . " (" . trim($lg->getUnitedemander()) . ")" 
                                                        ?></td>
        ...
        <!--                                                        <td>
                                            ...
                                            <tr style="background-color:#EDEDED;font-weight:bold;">
                                                ...
                                                <td><?php echo number_format($somme_htax, 3, ',', ' ') ?></td>
                                                <?php if ($remise != 0.000)  ?>
                                                <td></td>
                                                <?php if ($fodec != 0.000)  ?>
                                                <td> <?php echo number_format($somme_fdec, 3, ',', ' ') ?></td>
                                                <td><?php echo number_format($somme_htva, 3, ',', ' '); ?></td>
                                                <td></td>
                                                <?php if ($documentachat->getDroittimbre()) { ?>
                                                    <td style="text-align:center;width: 10%"><?php echo number_format($documentachat->getDroittimbre(), 3, ',', ' '); ?></td>
                                                <?php } ?>
