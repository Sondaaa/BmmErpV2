<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
                        ...
                        <table style="margin-bottom: 0px;">
                            ...
                            <?php if ($documentachat->getIdTypedoc() == 17 || $documentachat->getIdTypedoc() == 18): ?>    
                                <tr>
                                    ...
                                    //     $mntttc = $documentachat->getMntttc() + 0.600;
                                    // else
                                    $mntttc = $documentachat->getMntttc();
                                    ?>
                                    <td>Montant TTC</td>
                                    <td><?php echo number_format($mntttc, 3, '.', ' '); ?> TND</td>
        ...
        <?php endif; ?>
        <?php if ($documentachat->getIdTypedoc() != 9 && $documentachat->getIdTypedoc() != 17 && $documentachat->getIdTypedoc() != 18 && $documentachat->getIdTypedoc() != 21 && $documentachat->getIdTypedoc() != 22): ?>
        ...
        <?php endif; ?>
        <?php if ($documentachat->getIdTypedoc() == 2 || $documentachat->getIdTypedoc() == 7 || $documentachat->getIdTypedoc() == 19 || $documentachat->getIdTypedoc() == 17 || $documentachat->getIdTypedoc() == 18 || $documentachat->getIdTypedoc() == 21 || $documentachat->getIdTypedoc() == 22): ?>
            <fieldset>
                <div class="col-md-9">
                    <?php if ($documentachat->getIdTypedoc() == 22): ?>
                        <legend>Engagement Bugétaire Définitif </legend>
                    <?php else: ?>
                        <legend>Engagement Bugétaire Définitif</legend>

                    <?php endif; ?>
                    <?php $document_budget = $documentachat->getPiecejointbudget()->getLast()->getDocumentbudget(); ?>
                    <table>
                        <tbody>
                            <tr>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($documentachat->getIdTypedoc() != 22): ?>
                                            <button class="btn btn-xs btn-primary pull-right" onclick="validerBCEDef('<?php echo $documentachat->getId() ?>')">
                                                <i class="ace-icon fa fa-check bigger-110"></i>
                                                Valider Engagement
                                            </button>
                                        <?php else: ?>
                                            <button class="btn btn-xs btn-primary pull-right" onclick="validerEngDefBDCReg('<?php echo $documentachat->getId() ?>')">
                                                <i class="ace-icon fa fa-check bigger-110"></i>
                                                Valider Engagement
                                            </button>
                                        <?php endif; ?>
                        ...
                        <div>
                            <?php if ($documentachat->getDatesignature() == null): ?>
                                <div class="col-md-9" style="margin-top: 10px;">
                                    <button class="btn btn-xs btn-primary pull-right" onclick="validerBDCNull('<?php echo $documentachat->getId() ?>')">
                                        <i class="ace-icon fa fa-check bigger-110"></i>
                                        Valider Engagement
                                    </button>
                                </div>
                    ...
                    <table>
                        <thead>
                            ...
                            $liste_demande_de_prix = Doctrine_Core::getTable('lignedocachat')
                                            ->createQuery('a')
                                            ->where('id_doc=' . $documentachat->getId())
                            ...
                            <tr style="background-color:#EDEDED;font-weight:bold;">
                                <th style="text-align:center;width: 4%">N°<br>Ordre</th>

                                <th style="text-align:center;width: 18%">DESIGNATION<br></th>
                                <th style="text-align:center;width: 7%">Qte(Unité) </th>
                                ...
                                <th style="text-align:center;width: 12%">Total<br>H.TVA</th>
                                <th style="text-align:center;width: 12%">Taux<br>T.V.A</th>
                                <?php if ($documentachat->getDroittimbre())  ?>
                                <th style="text-align:center;width: 7%">Timbre</th>
                                <th style="text-align:center;width: 12%">M.TTC.Net</th>
                            </tr> 
                        </thead>
                        <tbody>
                            <?php
                            ...
                            foreach ($listesdocuments as $lignedoc) {
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <?php $prix_unitaire = floatval($lg->getMntht() * (1 / $lg->getQte())); ?>
                                    <td style="text-align:center;width: 10%">
                                        <?php echo number_format($prix_unitaire, 3, ',', ' ') ?>
                                    </td>
                                    <td style="text-align:right;width: 10%">
                                        <?php echo number_format(($lg->getMntht()), 3, ',', ' '); ?>
                                    </td>
                                    <?php if ($remise != 0.000)  ?>
                                    <td style="text-align:right;width: 10%"> 
                                        <?php echo number_format(($lg->getMntremise()), 2, ',', ' ') . '%'; ?>
                                    </td>

                                    <?php if ($fodec != 0.000)  ?>
                                    <td style="text-align:right;width: 10%">
                                        <?php echo number_format(($lg->getMntfodec()), 3, ',', ' ') ?>
                                    </td>
                                    <td style="text-align:right;width: 10%">
                                        <?php echo number_format(($lg->getMntthtva()), 3, ',', ' '); ?>
                                    </td>
                                    <td style="text-align:center;width: 10%">
                                        <?php echo $lg->getTva(); ?>
                                    </td>
                                    ...
                                    <?php $mnttc = $lg->getMntttc(); ?>
                                    <td style="text-align:right;width: 10%">
                                        <?php echo number_format(($mnttc), 3, ',', ' ') ?>
                                    </td>
                                </tr>
                                <?php
                                $somme_pru = $somme_pru + ($lg->getMntht() / $lg->getQte());
                                $somme_htax = $somme_htax + $prixhtax;
                                $somme_fdec = $somme_fdec + $lg->getMntfodec();
                                $somme_ttc = $somme_ttc + $lg->getMntttc();
                                $somme_htva = $somme_htva + $lg->getMntthtva();
                                ?>
                            <?php } ?>
                            <tr style="background-color:#EDEDED;font-weight:bold;">
                                ...
                                <td></td>
                                <?php if ($documentachat->getDroittimbre()) { ?>
                                    <td style="text-align:right;width: 10%"><?php echo number_format($documentachat->getDroittimbre(), 3, ',', ' '); ?></td>
                                <?php } ?>
...
//    } 
        ...
        <fieldset style="margin-left: 40%;">
            ...
            <div>
                ...
                <?php endif; ?>
                <?php if ($documentachat->getIdTypedoc() == 7): ?>
                    <a target="_blanc" class="btn btn-outline btn-success" href="<?php echo url_for('documentachat/imprimerBCEDefinitf?iddoc=' . $documentachat->getId()) ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                        Imprimer & Exporter Pdf
                    </a>
                <?php endif; ?>
...
<script  type="text/javascript">
    ...
    function validerBCEDef(id) {
        $.ajax({
            url: '<?php echo url_for('documentachat/validerEngagementBCEDEfinitif') ?>',
            ...
            success: function (data) {
                ...
                {
                    bootbox.dialog({
                        message: "Engagement Définitif validé !",
                        buttons:
                                {
                                    "button":
                                            {
    ...
    function validerEngDefBDCReg(id) {
        $.ajax({
            url: '<?php echo url_for('documentachat/validerEngagementDefiBDCReg') ?>',
            data: 'id=' + id + '&etat_budegt=' + $('#etat_budget').val()
                    + '&datevalidebudget=' + $('#datevalidebudget').val(),
            success: function (data) {
                if (data == 1)
                {
                    bootbox.dialog({
                        message: "Engagement Définitif pour BDC Regroupé validé !",
                        buttons:
                                {
                                    "button":
                                            {
