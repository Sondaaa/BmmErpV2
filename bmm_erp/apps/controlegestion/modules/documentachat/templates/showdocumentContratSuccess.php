<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        ...
        <?php endif; ?>
        <?php if ($documentachat->getIdTypedoc() != 9 && $documentachat->getIdTypedoc() != 17 && $documentachat->getIdTypedoc() != 18 && $documentachat->getIdTypedoc() != 21 && $documentachat->getIdTypedoc() != 22 && $documentachat->getIdTypedoc() != 20): ?>
        ...
        <?php endif; ?>
        <?php if ( $documentachat->getIdTypedoc() == 2 || $documentachat->getIdTypedoc() == 19 || $documentachat->getIdTypedoc() == 17 || $documentachat->getIdTypedoc() == 18 || $documentachat->getIdTypedoc() == 21 || $documentachat->getIdTypedoc() == 22  || $documentachat->getIdTypedoc() == 20): ?>
            <fieldset>
                <div class="col-md-9">
                    ...
                    <?php endif; ?>
                    <?php if($documentachat->getPiecejointbudget()->getIdDocBudget())
                     $document_budget = $documentachat->getPiecejointbudget()->getFirst()->getDocumentbudget(); ?>
                    <table>
                        <tbody>
                            <tr>
                                <td style="width: 16%; background-color: #F2F2F2;">Engagement</td>
                                <td style="width: 52%;"><?php if($documentachat->getPiecejointbudget()->getIdDocBudget()) echo $document_budget; ?></td>
                                <td style="width: 17%; background-color: #F2F2F2;">Date Engagement</td>
                                <td style="width: 15%;"><?php if($documentachat->getPiecejointbudget()->getIdDocBudget()) echo date('d/m/Y', strtotime($document_budget->getDatecreation())); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F2F2F2;">Budget</td>
                                <td colspan="3"><?php if($documentachat->getPiecejointbudget()->getIdDocBudget()) echo $document_budget->getLigprotitrub()->getTitrebudjet(); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F2F2F2;">Rubrique</td>
                                <td colspan="3"><?php  if($documentachat->getPiecejointbudget()->getIdDocBudget()) echo $document_budget->getLigprotitrub()->getRubrique(); ?></td>
                            </tr>
                            <tr>
                                <td style="background-color: #F2F2F2;">Montant Engagé</td>
                                <td><?php  if($documentachat->getPiecejointbudget()->getIdDocBudget()) echo number_format($document_budget->getMnt(), 3, '.', ' '); ?> TND</td>
                        ...
                        <tbody>
                            ...
                            foreach ($listesdocuments as $lignedoc) {
                                ...
                                <tr>
                                    ...
                                    //echo $qtedemander . " (" . trim($lg->getUnitedemander()) . ")" ?></td>
...
<script  type="text/javascript">
  ...
  function validerBDCNull(id) {
        $.ajax({
            url: '<?php echo url_for('documentachat/validerEngagementBDCNULL') ?>',
