...
<th>Projet & Observation</th>
                        ...
                        <tbody>
                            ...
                            //   die(count($listesdocumentscontrat) . 'rr');
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        if (intval($lg->getQte() == $lg->getQte()))
                                            ...
                                            $qte = $lg->getQte();
                                        if ($lg->getUnitemarche()):
                                            echo $qte . " (" . trim($lg->getUnitemarche()) . ")";
                                        else:
                                            echo $qte;
                                        endif;
                                        //echo $qtedemander . " (" . trim($lg->getUnitedemander()) . ")" 
                                        ?></td>
                                    <td><?php echo $lg->getObservation() . "  ".  $lg->getProjet() ?></td>                                   
                                    <td style="text-align:center;"><?php echo number_format($lg->getMntht(), 3, '.', ' ') ?></td>
                                    <td style="text-align:center;"><?php echo number_format($lg->getMntthtva(), 3, '.', ' '); ?></td>
                                    <td style="text-align:center;"><?php echo $lg->getTva(); ?></td>
                                    <td style="text-align:center;"><?php echo number_format($lg->getMntttc(), 3, '.', ' ') ?></td>         
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
