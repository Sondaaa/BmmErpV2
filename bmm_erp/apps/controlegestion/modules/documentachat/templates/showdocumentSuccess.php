        ...
        <?php if ($documentachat->getIdTypedoc() == 19 || $documentachat->getIdTypedoc() == 17 || $documentachat->getIdTypedoc() == 18 || $documentachat->getIdTypedoc() == 21): ?>
            <fieldset>
                <div class="col-md-9">
                    ...
                    <?php
                    if ($document_budget = $documentachat->getPiecejointbudget()->getLast())
                        $document_budget = $documentachat->getPiecejointbudget()->getLast()->getDocumentbudget();
                    if ($document_budget):
                        ?>
                        <table>
                            <tbody>
...
//    } 
        ...
        <fieldset style="margin-left: 40%;">
            ...
            <?php elseif ($documentachat->getIdTypedoc() == 19): ?>
                ...
                <?php endif; ?>
            <div>
<?php if ($documentachat->getIdTypedoc() != 18): ?>
...
<?php endif; ?>
<?php if ($documentachat->getIdTypedoc() == 18): ?>
                    <a target="_blanc" class="btn btn-outline btn-success" href="<?php echo url_for('documentachat/imprimerBCEProvisoire?iddoc=' . $documentachat->getId()) ?>">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                        Imprimer & Exporter Pdf
                    </a>
<?php endif; ?>
