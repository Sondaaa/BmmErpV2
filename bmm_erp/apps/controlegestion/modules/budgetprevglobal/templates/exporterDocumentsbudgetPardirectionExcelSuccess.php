<div id="sf_admin_container">
    <div class="col-sm-12">
        <button style="float: right;" class="btn btn-xs btn-success" onclick="exportTableToExcel('PDFcontent', 'Liste des Budgets Prévisionnels Globaux Par Direction')">
            <i class="ace-icon fa fa-file-excel-o"></i> Exporter  Liste des Budgets Prévisionnels Globaux Par Direction  vers Fichier Excel
        </button>
    </div>
    <h1 id="replacediv"> Liste des Budgets Prévisionnels Globaux Par Direction
        <small><i class="ace-icon fa fa-angle-double-right"></i> Exporter Liste des Budgets Prévisionnels Globaux Par Direction => Excel</small>
    </h1>
</div>
<?php
                        ...
                        if (!$ligne->getRubrique()->getIdRubrique()) {
                            ...
                            foreach ($resul as $ligne_ligneligpr):
                                ...
                                <tr style="font-size:10px;">
                                    ...
                                    <td style="width:50%"><b><?php echo $ligne_ligneligpr['direction'] ?></b></td>
