    ...
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            <div class="widget-main" style="padding: 5%; text-align: center;">
                <button style="font-size: 14px !important; font-weight: bold !important;" onclick="printListretenuesursalaire()" class=" btn btn-danger">
                    Imprimer Liste des Retenues sur salaire
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    function printListretenuesursalaire() {
        var url = '';
        if ($('#retenuesursalaire_filters_id_agents').val() != '')
        {
            if (url == '')
