 ...
 <?php $service = Doctrine_Core::getTable('servicerh')->findOneById($idd); ?>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer" >
                     <a id="button_print" target="_blanc" href="<?php echo url_for('posterh/Imprimerlisteposteparservice?idservice=' . $idd) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                      </a>
                    <button type="button" value="Fermer" class="btn  pull-left"  onclick="fermerposte4()" >
