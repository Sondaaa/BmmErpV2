        ...
        <div class="widget-body">
            <div class="widget-main">
                <div class="col-sm-12">
                    ...
                    <hr style="margin-bottom: 10px; margin-top: 10px;">
                    <span style="color: #40539d;"><i class="ace-icon fa fa-info-circle"></i> Veuillez bien vérifier les paramètres (Demandeurs / Services / ...) pour n'avoir plus des doublon dans la base des données.</span>
                </div>
                <div class="row"></div>
            </div>
        </div>
