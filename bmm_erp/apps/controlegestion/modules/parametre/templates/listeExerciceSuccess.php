<div id="sf_admin_container">
    <h1 id="replacediv"> Paramétres Global 
        <small>
...
<div class="row">
    <div class="col-xs-6">
        <div class="widget-box">
            <div class="widget-header widget-header-flat">
                <h4 class="widget-title smaller">Ajouter exercice budgétaire</h4>
            </div>
                ...
                <div class="widget-main">
                    <form>
                        <fieldset>
                            ...
                            <input id="libelle" placeholder="Libellé exercice budgétaire" readonly="true" type="text" value="" />
                        </fieldset>
                        <br>
                        <fieldset>
                            <div class="col-xs-6">
    ...
    <div class="col-xs-6" id="zone_edit" style="display: none;">
        <div class="widget-box widget-color-grey">
            <div class="widget-header widget-header-flat">
                <h4 class="widget-title smaller">Modifier exercice budgétaire</h4>
            </div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div>
            <table id="list_forme" class="table table-bordered">
                <thead>
                    <tr>
                        <th style="width: 40%; text-align: center;">Exercice Budgétaire</th>
                    ...
                    <tr>
                        <th style="padding: 6px;"><input style="text-align: center;" type="text" id="libelle_filtre" onkeyup="goPage(1);" /></th>
                        <th></th>
                        <th></th>
                        <th></th>
                    </tr>
...
<script  type="text/javascript">
        ...
        if ($('#libelle').val() != '') {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == 'existe') {
                        bootbox.dialog({
                            message: "<span class='bigger-110' style='margin:20px;'>Cet exercice budgétaire existe déjà !</span>",
                            buttons:
                                    {
                                        "button":
                                                {
    ...
    function deleteForme(id) {
        bootbox.confirm({
            message: "Voulez-vous supprimer cet exercice budgétaire ?",
            buttons: {
                cancel: {
                    label: "Non",
                    className: "btn-sm",
...
<script  type="text/javascript">
    document.title = ("BMM - G. Compta. : Exercice Budgétaire");
</script>