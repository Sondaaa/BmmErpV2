<div id="sf_admin_container">
    <h1>Statistique : Répartition Budgétaire / Caisse</h1>
    <div id="sf_admin_bar">
...
<script  type="text/javascript">
    ...
    function afficher() {
        $.ajax({
            url: '<?php echo url_for('ligneoperationcaisse/afficherStatCaisse') ?>',
...
<script  type="text/javascript">
    document.title = ("BMM - U. Contrôle Budgétaire : Statistique : Répartition Budgétaire / Caisse");
</script>