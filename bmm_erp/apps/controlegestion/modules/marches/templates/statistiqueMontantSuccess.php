<div id="sf_admin_container" ng-controller="CtrlStatistique">
    <h1>Statistique : Progression Projet / Montant</h1>
    <div id="sf_admin_bar">
...
<script  type="text/javascript">
    ...
    function afficher() {
        if ($("#id_beneficiaire").val() != '0' && $("#id_marche").val()) {
            $.ajax({
                url: '<?php echo url_for('marches/afficherStatMontant') ?>',
...
<script  type="text/javascript">
    document.title = ("BMM - U. Contrôle Budgétaire : Statistique : Progression Projet / Montant");
</script>