        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés relié au Corps   "<?php echo $cat->getLibelle(); ?> " et l'echelle "<?php echo $e->getLibelle(); ?> " " et au Catégorie "<?php echo $ech->getLibelle(); ?> "</h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparcorpsetechelleetcat?idcorps='.$id1.'&idechelle='.$id2.'&idcat='.$id3) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a> 
                        <button type="button" value="Fermer" id="btn1"  class="btn  pull-left"  onclick="fermeragentscorpsechelleetcat()">
                            Fermer</button>
                    </div>
                </div>
