        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <table id="dynamics-table" class="dynamic-table" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            foreach ($listes as $l) {
                                $ag = $l;
                                ?>
                            <tr id="idde" style="cursor: pointer;" ondblclick="chargerpersonne2('<?php echo $ag->getId(); ?>', '<?php echo $ag->getIdrh(); ?>', '<?php echo $ag->getNomcomplet(); ?>')">
                                    <td><?php echo $i ; ?></td>
                ...
                <div class="modal-footer" >
                    <button type="button" value="Fermer" class="btn  pull-left"  onclick="Fermeragents2()" >
                        Fermer</button>
                </div>
            </div>
        </div>
...
<script  type="text/javascript">
    ...
    {
        $('#my-modal-agents-rh2').removeClass('in');
        $('#my-modal-agents-rh2').css('display', 'none');
        $('#idp').val(id);
        $('#idfin').val(mat);
