        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés  relie au  "<?php echo $service->getLibelle(); ?> "</h4>
                </div>
...
//                                $listes=  AgentsTable::getInstance()->getlisteagents($idde,$idfin);
                    ...
                    <div class="modal-footer" >
                          <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparservice?idservice='.$idd) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" id="btn1"  class="btn  pull-left"  onclick="fermeragentsservice()">
                            Fermer</button>
                    </div>
                </div>
