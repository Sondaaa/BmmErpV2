        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés relié au Corps   "<?php echo $cat->getLibelle(); ?> " et l'echelon "<?php echo $e->getLibelle(); ?> " " et au Catégorie "<?php echo $ech->getLibelle(); ?> "</h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparcorpsetechelonetcat?idcorps='.$id1.'&idechelon='.$id2.'&idcat='.$id3) ?>" class="btn  btn-success pull-left">
