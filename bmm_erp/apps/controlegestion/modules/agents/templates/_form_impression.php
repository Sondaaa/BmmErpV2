        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" value="Initialiser" class="btn btn-primary pull-left" onclick="InitilaiserChoixFiche()">
                        Initialiser</button>
                    <button type="button" value="Imprimer" id="bntimp" class="btn pull-left" onclick="printfiche()">
                        Imprimer</button>
