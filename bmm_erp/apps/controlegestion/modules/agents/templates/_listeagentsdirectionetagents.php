        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés de la Direction  "<?php echo $directio->getLibelle(); ?> " entre "<?php echo $agentsd->getNomcomplet()." ".$agentsd->getPrenom(); ?> " et "<?php echo $agentsf->getNomcomplet()." ".$agentsf->getPrenom(); ?> "</h4>
                </div>
...
//                                $listes=  AgentsTable::getInstance()->getlisteagents($idde,$idfin);
                    ...
                    <div class="modal-footer" >
                        <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentspardirectionetpardebutfinagents?iddirection=' . $idd . '&idd=' . $id1 . '&idf=' . $id2) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" id="btn1"  class="btn  pull-left"  onclick="fermeragentsdirection1()">
                            Fermer</button>
                    </div>
                </div>
