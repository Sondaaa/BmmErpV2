...
<div class="sf_admin_form" ng-controller="CtrlFacturatioin">
  <?php echo form_tag_for($form, '@lignemouvementfacturation') ?>
    ...
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
      <?php include_partial('lignemouvementfacturation/form_fieldset', array('lignemouvementfacturation' => $lignemouvementfacturation, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>
