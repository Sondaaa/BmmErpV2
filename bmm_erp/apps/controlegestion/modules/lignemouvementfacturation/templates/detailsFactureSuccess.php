    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            <div class="tab-pane fade active in" id="accuelbci">
                <div class="row">
                    <div class="col-lg-12">
                        <?php echo html_entity_decode($documentachat->ReadHtmlFactureImression($documentachat->getId())); ?> 
                        <a style="float: right; margin-right: 2%;" class="btn btn-white btn-default" href="<?php echo url_for('Documents/Imprimerdocentre?iddoc=') . $documentachat->getId() ?>" target="_blanc">Exporter PDF</a>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <table border="1" style="padding:1%">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 70%;"><?php echo date('Y', strtotime($document_budget->getDatecreation())); ?></td>                    
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <?php if (trim($documentachat->getEtatdocachat()) != "Annulé(e)"): ?>
                                                                <button id="valide_button" class="btn btn-sm btn-success" onclick="validerDocument()">
                                                                    ...
                                                                    <span class="bigger-110 no-text-shadow">Valider Engagement</span>
                                                                </button>
                                                            <?php else: ?>
