        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <table id="dynamic-table" class="dynamic-table" style="width: 100%" >
                       ...
                       $i=1;
                            foreach ($listes as $l) {
                                $ag = $l;
                                ?>
                                <tr style="cursor: pointer;" id="idde" ondblclick="chargerpersonne13('<?php echo $ag->getId(); ?>', '<?php echo $ag->getIdrh(); ?>', '<?php echo $ag->getNomcomplet()." ". $ag->getPrenom(); ?>')">
                ...
                <div class="modal-footer" >
                    <button type="button" value="Fermer" class="btn pull-left"  onclick="fermeragents1()" >
                        Fermer</button>
                </div>
            </div>
        </div>
...
<script  type="text/javascript">
    function chargerpersonne13(id, mat, nom){
