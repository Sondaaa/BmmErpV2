<div id="my-modalagentPardomaineSousRubrique" class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés particpants à  La Formation du  Domaine d'utilisation "<?php echo $domaine->getLibelle(); ?> " et le Sous Rubrique "<?php echo $sousrubrique->getLibelle(); ?>"</h4>
                </div>
                ...
                <div class="modal-body" >
                    ...
                    <div class="modal-footer" >
                        <a id="button_print" target="_blanc" href="<?php echo url_for('planing/ImprimerAlllisteparDomaineSousRubrique?iddomaine=' . $idd .'&idsousrubriique='.$ids) ?>" class="btn  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" id="btn1"  class="btn  pull-left"  onclick="fermeragentsDomaineSousrubrique()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentsDomaineSousrubrique()
    {
        $('#my-modalagentPardomaineSousRubrique').removeClass('in');
        $('#my-modalagentPardomaineSousRubrique').css('display', 'none');
    }
