<div id="my-modalagentPardomaineRubrique" class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Emplyés particpants à  La Formation du  Domaine d'utilisation "<?php echo $domaine->getLibelle(); ?> " et le  Rubrique "<?php echo $rubrique->getLibelle(); ?>"</h4>
                </div>
                ...
                <div class="modal-body" >
                    ...
                    <div class="modal-footer" >
                        ...
                        <button type="button" value="Fermer" id="btn1"  class="btn  pull-left"  onclick="fermeragentsDomainerubrique()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentsDomainerubrique()
    {
        $('#my-modalagentPardomaineRubrique').removeClass('in');
        $('#my-modalagentPardomaineRubrique').css('display', 'none');
    }
