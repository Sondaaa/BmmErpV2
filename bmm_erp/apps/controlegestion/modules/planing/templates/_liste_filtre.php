            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="smaller lighter blue no-margin">
                        Liste des Agents Participants à la Formation :<br>
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <a id="button_print" target="_blanc" href="<?php echo url_for('planing/ImprimerAlllisteAllFilter?idreg=' . $idregr . '&ido=' . $ido . '&idf=' . $idF . '&iddebut=' . $iddebut . '&idfin=' . $idfin . '&idd=' . $idd . '&idr=' . $idr . '&ids=' . $ids . '&idu=' . $idu) ?>" class="btn  btn-success pull-left">
