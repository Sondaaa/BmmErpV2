        ...
        <div class="modal-content">
            ...
            <div class="modal-body" >
                    ...
                    <table id="dynamic-table" class="dynamic-table" style="width: 100%" >
                        ...
                        <tbody>
                            ...
                            foreach ($listes as $l) {
                                $ag = $l;
                                ?>
                                <tr style="cursor: pointer;" id="idorga" ondblclick="chargerFormateur2('<?php echo $ag->getId(); ?>','<?php echo $ag->getCin(); ?>','<?php echo $ag->getNom()." ". $ag->getPrenom(); ?>')">
                                    <!-- ', '<?php //echo $ag->getNom() ;?>'', -->
                ...
                <div class="modal-footer" >
                    ...
                    <button type="button" value="Fermer" class="btn  pull-left"  onclick="fermerFormateur1()" >
