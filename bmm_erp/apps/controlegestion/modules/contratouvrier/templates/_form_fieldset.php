            ...
            <div class="tab-content col-lg-12" ng-init="initialiserageretraite()">  
                <fieldset>
                    <div>
                        <legend>
                            Contrat
                            <a target="_blank" href="<?php echo url_for('contratouvrier/ImprimerFicheContrat') . '?id=' . $contratouvrier->getId() ?>" class="btn btn-xs btn-primary pull-right">Imprimer Contrat</a>
                        </legend>
                        <table class="table table-bordered table-hover disabledbutton" style="margin-bottom: 10px;">
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label> Date début contrat</label><span class="align2"> (بداية العقد )  </span></td>
                                    <td>   
