...
<div id="sf_admin_container">
  ...
  <div id="sf_admin_bar">
    <?php include_partial('lignebanquecaisse/filters', array('form' => $filters, 'configuration' => $configuration)) ?>
  </div>

  <div id="sf_admin_content">
    <form action="<?php echo url_for('lignebanquecaisse_collection', array('action' => 'batch')) ?>" method="post">
    <?php include_partial('lignebanquecaisse/list', array('pager' => $pager, 'sort' => $sort, 'helper' => $helper)) ?>
<!--    <ul class="sf_admin_actions">
  ...
  <div id="sf_admin_footer">
    <?php include_partial('lignebanquecaisse/list_footer', array('pager' => $pager)) ?>
  </div>
</div>
