...
<div class="col-md-12 annexe_type" id="div_add_annexe_<?php echo $type; ?>" style="margin-bottom: 15px;">
    <div class="col-md-12">
        <legend>
            <span style="font-size: 16px;">تكوين ورسكلة الأعوان</span>
            ...
            <table style="margin-bottom: 0px;">
                <thead>
                    <tr style="font-size: 12px;">
                        ...
                        <th style="width: 20%; text-align: center;">نوعية التكوين</th>
                        <th style="width: 25%; text-align: center;">مجالات التكوين</th>
                    ...
                    <tr name="tr_for_add">
                        ...
                        <th><input id="<?php echo $type; ?>_domaine" type="text" value=""></th>
            ...
            <table style="margin-bottom: 0px;">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center; width: 10%;"><input type="text" class="align_right" id="total_nombre_<?php echo $type; ?>" value="0.000" readonly="true"></th>
                        <th style="text-align: center; width: 60%;">Total - المجموع</th>
                    </tr>
                    <tr>
    ...
    <script  type="text/javascript">
        ...
        function addligne<?php echo $type; ?>() {
            if ($("#<?php echo $type; ?>_total").val() != '' && $("#<?php echo $type; ?>_type").val() != '' && $("#<?php echo $type; ?>_domaine").val() != '') {
                ...
                tr_html = tr_html + '<td name="<?php echo $type; ?>_domaine" style="text-align: right;">' + $("#<?php echo $type; ?>_domaine").val() + '</td>';
        ...
        function setTotalLigneAnnexeType<?php echo $type; ?>() {
            if ($("#<?php echo $type; ?>_prix").val() != '' && $("#<?php echo $type; ?>_nombre").val() != '') {
        ...
        function setTotalAnnexeType<?php echo $type; ?>() {
            var nombre = 0;
            $('[name="<?php echo $type; ?>_nombre"]').each(function () {
                nombre = parseFloat(parseFloat(nombre) + parseFloat($(this).html()));
            });
            $('#total_nombre_<?php echo $type; ?>').val(parseFloat(nombre).toFixed(3));
        ...
        function editLigneExemple<?php echo $type; ?>(id) {
            ...
            $("#<?php echo $type; ?>_type").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(3)').html().trim());
            $("#<?php echo $type; ?>_domaine").val($("#tr_annexe_type_<?php echo $type; ?>_" + id).find('td:eq(4)').html().trim());
        }
