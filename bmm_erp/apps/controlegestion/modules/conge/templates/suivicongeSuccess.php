...
<?php if ($conge->getTypeconge()->getId() == 1): ?>
    <fieldset>
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    $i++;
                    ?> 
                    <td><input type="text" value="<?php echo $jouprecanne ?>" style="text-align: center;" readonly="true" id="jourparanneprecedant"></td> 
                    <?php
...
//                    echo $conge->getNbrcongerestant()
                ...
                <tr>
                    ...
                    <td><input type="text"  id="nbrjrestantValide" readonly="true" placeholder="Nbr.j.Restant.Validé"value="<?php // echo ( $conge->getNbjcongeannuelle() + $jouprecanne - $conge->getNbrcongeralise())           ?>" ></td>

                    <td style="text-align: center"><input type="checkbox" id="extension" name="check_extension" <?php if ($conge->getExtension() == "true"): ?> checked="true" <?php endif; ?>></td>
                    ...
                    <td style="text-align: center"><input type="checkbox" id="valide" name="check_valide" <?php if ($conge->getValide() == "true"): ?> checked="true" <?php endif; ?>></td>
                </tr>
                <tr>
                    <td colspan="6"></td>
                    <td><input type="text" value="Congé.T.Réalisé"></td>
                    <td colspan="2">
        ...
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" value="<?php echo ($conge2->getTypeconge()->getNbrjour()); ?>" style="text-align: center;" readonly="true" id="jourparanne"></td>     
                ...
                <tr>
                    ...
                    <th>D.Fin</th>
                    <th>Nbr.Jour Prolongé</th>
                    <th colspan="2">Nb.J.R Aprés Prolongement</th>
                </tr>
                <tr>
                    ...
                    <td style="text-align: center"><input type="checkbox" id="extensiontype2" name="check_extension_2" <?php if ($conge->getExtension() == "true"): ?> checked="true" <?php endif; ?>></td>
                    ...
                    <td colspan="2"><input type="text"  id="nbrjrestantApresExtension2" readonly="true" placeholder="Nbr.J.Restant.Apres¨prolongatoin" value="<?php echo $conge->getNbrcongerestant(); ?>"></td>
                </tr>
                <tr>
                    <td colspan="6"></td>
                    <td><input type="text" value="Congé.T.Réalisé"></td>
        ...
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" value="<?php echo $conge->getTypeconge()->getNbrjour() - $conge->getNbrjvalide() ?>" id="nbrjrestant" readonly="true"></td>
                    <td style="text-align: center"><input type="checkbox" id="valide" name="check_valide" <?php if ($conge->getValide() == "true"): ?> checked="true" <?php endif; ?>></td>
                </tr>
                <tr>
                    <th style="width: 15%">D.Début.V</th>
                ...
                <tr>
                    ...
                    <td style="text-align: center"><input type="checkbox" id="extensiontype3" name="check_extension"<?php if ($conge->getExtension() == "true"): ?> checked="true" <?php endif; ?>></td>
                    ...
                    <td colspan="2"><input type="text" id="nbrjrestantApresExtension3" readonly="true" placeholder="Nbr.J.Restant.Apres¨prolongatoin" value="<?php echo $conge->getNbrcongerestant(); ?>"></td>
                </tr>
                <tr>
                    <td colspan="6"></td>
                    <td><input type="text" value="Congé.T.Réalisé"></td>
        ...
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="text" readonly="true" value="<?php echo $conge->getAgents()->getidrh(); ?>"></td>
                    <td colspan="2"><input type="text" readonly="true" value="<?php echo $conge->getAgents()->getNomcomplet() . "  " . $conge->getAgents()->getPrenom() ?>"></td>
                    <td><input type="text" value="<?php echo $conge->getTypeconge()->getNbrjour(); ?>" style="text-align: center;" readonly="true" id="jourparanne"></td> 
                    <?php
                    $annetype3 = $conge->getAnnee();
        ...
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="text" id='nbrjvtype5' placeholder="Nbr.Jour.V" readonly="true" value="<?php echo $conge->getNbrjourrealise() ?>"></td>
                </tr>
                <tr>
                    <td colspan="3"></td>
                    <td><input type="text" value="Congé.T.Réalisé"></td>
        ...
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    <td><input type="text" readonly="true" value="<?php echo $conge->getAgents()->getidrh(); ?>"></td>
                    <td><input type="text" readonly="true" value="<?php echo $conge->getAgents()->getNomcomplet() . "  " . $conge->getAgents()->getPrenom() ?>"></td>
                    <td><input type="text" value="<?php echo $conge->getTypeconge()->getNbrjour() * 365; ?>" style="text-align: center;" readonly="true" id="jourparanne"></td>              
                    <td><input type="text" value="<?php echo $conge->getNbrjvalide() ?>" id="nbrjourdemande" readonly="true"></td>
                    <td><input type="text" readonly="true" value="<?php echo date('d/m/Y', strtotime($conge->getDatedebutvalide())) ?> "></td>
                    <td><input type="text" readonly="true" value="<?php echo date('d/m/Y', strtotime($conge->getDatefinvalide())) ?>"></td>
                    <td><input type="text" value="<?php echo $conge->getTypeconge()->getNbrjour() * 365 - $conge->getNbrjvalide() ?>" id="nbrjrestant" readonly="true"></td>
                    <td style="text-align: center"><input type="checkbox" id="valide" name="check_valide" <?php if ($conge->getValide() == "true"): ?> checked="true" <?php endif; ?>></td>
        ...
        <table class="table table-bordered table-hover disabledbutton">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" id='nbrjvtype2' placeholder="Nbr.Jour.V" readonly="true" value="<?php echo $conge->getNbrjourrealise() ?>"></td>
                    <td><input type="text" id="nbrjrestantValidetyp2" readonly="true" placeholder="Nbr.j.Restant.Validé" ></td>
                    <td style="text-align: center"><input type="checkbox" id="extensiontype2" name="check_extension" <?php if ($conge->getExtension() == "true"): ?> checked="true" <?php endif; ?>></td>
                    <td><input type="date" id='datedebutextension2' class="disabledbutton" value="<?php echo $conge->getDatedenutprologement() ?>"></td>
                    <td><input type="date" id='datefinextension2' class="disabledbutton" value="<?php echo $conge->getDatefinprolongement() ?>"></td>
                    <td><input type="text" id='nbrjex2'  readonly="true" value="<?php echo $conge->getNbrjourprolonge() ?>"></td>
                    <td colspan="2"><input type="text" id="nbrjrestantApresExtension2" readonly="true" placeholder="Nbr.J.Restant.Apres¨prolongatoin" value="<?php echo $conge->getNbrcongerestant(); ?>"></td>
