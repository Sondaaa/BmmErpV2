            ...
            <div class="tabbable tabs-left">
                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset >
                            <legend>Information <?php echo "Bénéficiaire:" . $lots->getFournisseur() . " LOTS: " . $lots ?></legend>
                            <div class="col-lg-9" >
                            ...
                            <div class="col-lg-3">
                                <?php include_partial('lots/form_action_ios', array('type' => "ios", 'idlot' => $form->getObject()->getId(), 'formlot' => $form, 'OSARRET' => $OSARRET, 'OSREPISE' => $OSREPISE, 'OSCOMMTRAVAUX' => $OSCOMMTRAVAUX, 'listesordredeservice' => $listesordredeservice)); ?>
                            </div>
                        </fieldset>
                        <fieldset >
                            <legend>Listes des documents scannées</legend>
                            <?php
                    ...
                    foreach ($OSS as $od) {
                        ...
                        <div id="or<?php echo $ordres->getId() ?>" class="tab-pane fade" >
                            <?php
                            include_partial('ordredeservice/form_ios_c', array('formlot' => $form, 'ordres' => $ordres, 'formios' => $formios));
                            ?>
                        </div>
                    <?php } ?>
