...
?>
<?php if ($type == "ios") { ?>
    <a href="<?php echo url_for('lots/remplirios?id=' . $idlot . '&post=creeiosc&idtype=1') ?>" class="btn <?php echo $action_cree_ios_comm ?> btn-white btn-default" style="margin: 1%">Crée OS <br>Commencement du Travaux</a>
...
<?php } ?>
<?php if ($type == "date") { ?>
    <a href="<?php echo url_for('lots/rempliravenant?id=' . $idlot . '&post=creeavenanttypedate') ?>" class="btn <?php echo $action_cree_ios_comm ?> btn-white btn-default">Créer Avenant Type date</a> 
<?php } ?>
<?php if ($type == "type2") { ?>
    <a href="<?php echo url_for('lots/rempliravenanttype2?id=' . $idlot . '&post=creeavenanttype2') ?>" class="btn <?php echo $action_cree_ios_comm ?> btn-white btn-default">Créer Avenant Type Sous Détail de prix</a> 
<?php } ?>
