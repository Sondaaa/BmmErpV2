                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset >
                            ...
                            <div class="col-lg-3">
                                <?php include_partial('lots/form_action_ios', array('idlot' => $form->getObject()->getId(), 'type' => "date", 'formlot' => $form, 'listesordredeservice' => $listesordredeservice)); ?>
                            </div>
                        </fieldset>
                    </div>
                    ...
                    foreach ($listesordredeservice as $od) {
                        ...
                        <div id="or<?php echo $ordres->getId() ?>" class="tab-pane fade" >
                            <?php
                            include_partial('ordredeservice/form_ios_type_date', array('formlot' => $form, 'ordres' => $ordres, 'formios' => $formios));
                            ?>
                        </div>
                    <?php } ?>
                </div>
