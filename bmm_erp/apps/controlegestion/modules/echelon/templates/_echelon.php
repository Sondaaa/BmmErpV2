        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <table id="dynamic-table" class="dynamic-table" style="width: 100%">
                        <thead>
                            <tr>
                                ...
                                <th>Libellé</th> 
                                <th style="display: none">Code échelon</th> 
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                ...
                <div class="modal-footer">
                    <a id="button_print" target="_blanc" href="<?php echo url_for('echelon/ImprimerAlllisteEchelon') ?>" class="btn btn-success pull-left">
                        <i class="ace-icon fa fa-print bigger-110"></i>
                        <span class="bigger-110 no-text-shadow">Imprimer</span>
                    </a>
                    <button type="button" value="Fermer" class="btn pull-left" onclick="fermerechelon()">
                        Fermer</button>
                </div>
            </div>
        </div>
