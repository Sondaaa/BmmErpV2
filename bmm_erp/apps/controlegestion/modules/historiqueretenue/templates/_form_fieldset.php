                ...
                <div class="widget-main" style="min-height: 200px;" >
                    ...
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                <td>Mois</td>
                                <td class="disabledbutton"> <?php echo $form['mois']->renderError() ?>
                                    <?php echo $form['mois'] ?>
                                </td>
                                <td>Année</td>
        ...
        if (id_type == "0") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var demo1 = $('#id_demandeavance').bootstrapDualListbox({infoTextFiltered: '<span class="label label-purple label-lg">Filtré</span>'});
        ...
        if (id_type == "1") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var demo1 = $('#id_demandepret').bootstrapDualListbox({infoTextFiltered: '<span class="label label-purple label-lg">Filtré</span>'});
                    var container1 = demo1.bootstrapDualListbox('getContainer');
                    container1.find('.btn').addClass('btn-white btn-info btn-bold');
                }
            });
        ...
        if (id_type == "2") {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var demo1 = $('#id_retenue').bootstrapDualListbox({infoTextFiltered: '<span class="label label-purple label-lg">Filtré</span>'});
                    var container1 = demo1.bootstrapDualListbox('getContainer');
                    container1.find('.btn').addClass('btn-white btn-info btn-bold');
                }
            });
