        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul style="margin: 0 0 10px 20px;">
                    ...
                    <li class="info_modal"><span class="grand_point">.</span> 1,5 % dans tous les autres cas.</li>
                </ul>
                <hr>
...
<div id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <div class="col-sm-12">
            <div class="row">
                ...
                <?php $lignes = TvaTable::getInstance()->getBaseTvaByDocs($ids); ?>
                                ...
                                <table id="liste_ligne">
                                    ...
                                    <tfoot>
                                        ...
                                        if ($total_montant_tva_comprise >= 1000)
                                            $total_tva_retenue = $total_montant_tva_comprise / 4;
                                        else
                                            $total_tva_retenue = 0;
                                        ?>
    ...
    <div class="row" id="zone_save_button">
        <div class="col-xs-12">
            <button class="btn btn-primary" type="button" style="float: right; margin-top: 20px; margin-right: 1%;" onclick="saveCertificat()">
...
<style>
    ...
    .info_modal{text-align: justify; margin-top: 15px; font-weight: normal;}
