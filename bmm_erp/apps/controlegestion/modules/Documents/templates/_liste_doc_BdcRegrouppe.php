<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header">
            ...
            <a target="_blanc" href="<?php echo url_for('Documents/ImprimerListeDocFournisseurProvisoire?' . $str.'&id_type=21') ?>" class="btn btn-sm btn-success" style="float: right; padding: 5px 9px;">
                    ...
                    <table id="list_doc" class="table table-bordered table-hover" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (count($pager) == 0): ?>
                                <tr>
                                    <td style="text-align:center; font-weight: bold; font-size: 16px !important;" colspan="9">Pas de B.D.C.Regroupe Provisoire</td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($pager->getResults() as $doc): ?>
                                    <tr>
                                        <td><?php echo
                                        $doc->getTypedoc()->getPrefixetype() . ' ' . sprintf('%05d', $doc->getNumero()); 
                                                //$doc->getNumero();
                                        //include_partial('tddetaildoc', array('boncomm' => $doc)) ?></td>
