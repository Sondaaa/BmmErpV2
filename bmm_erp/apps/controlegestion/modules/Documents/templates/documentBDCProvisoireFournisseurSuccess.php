<div id="sf_admin_container">
    <h1>Liste des <u>B.D.C.S</u> Provisoires</h1>
    <div id="sf_admin_bar">
        <div class="sf_admin_filter" style=" width: 65%;">
            ...
            <table class="table table-bordered table-hover" cellspacing="0" style="margin-bottom: 0px;">
                ...
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('Documents/documentBDCProvisoireFournisseur') ?>" class="btn btn-white btn-success">Effacer</a>
...
<script  type="text/javascript">
    ...
    function goPage(page) {
        $.ajax({
            url: '<?php echo url_for('Documents/goPageBDCDocProvisoire') ?>',
            data: 'page=' + page +
