<div id="sf_admin_container">
    <h1>Liste des <u>Contrat Definitifs</u> par Fournisseur</h1>
    <div id="sf_admin_bar">
        <div class="sf_admin_filter" style=" width: 65%;">
            ...
            <table class="table table-bordered table-hover" cellspacing="0" style="margin-bottom: 0px;">
                ...
                <tfoot>
                    <tr>
                        <td colspan="2">
                            <a href="<?php echo url_for('Documents/documentContratDefFournisseur') ?>" class="btn btn-white btn-success">Effacer</a>
...
goPage(1);
    function goPage(page) {       
            $.ajax({
                url: '<?php echo url_for('Documents/goPageDocContratDef') ?>',
                data: 'page=' + page +
