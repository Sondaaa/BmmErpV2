<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header">
            ...
            <a target="_blanc" href="<?php echo url_for('Documents/ImprimerListeDocContratFournisseurProvisoire?' . $str) ?>" class="btn btn-sm btn-success" style="float: right; padding: 5px 9px;">
                    ...
                    <table id="list_doc" class="table table-bordered table-hover" cellspacing="0">
                        ...
                        <tbody>
                            <?php if (count($pager) == 0): ?>
                                <tr>
                                    <td style="text-align:center; font-weight: bold; font-size: 16px !important;" colspan="9">Pas de Contrats</td>
                                </tr>
                            <?php else: ?>
        ...
        <?php } ?>
                                        ...
                                        <td style="text-align: center;">
                                            <a target="_blanc" href="<?php echo url_for('documentachat/showdocumentBDC?iddoc=') . $doc->getId() ?>" class="btn btn-xs btn-primary">
