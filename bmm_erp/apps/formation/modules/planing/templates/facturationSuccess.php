            ...
            foreach ($listesdocuments as $lignedoc) {
                ...
                <tr>
                    <?php if ($lg->getRealise() == "1") { ?>
                        ...
                        <td>
                            <?php
                            $mags = Doctrine_Core::getTable('documentachat')->findByIdTypedoc(15);
                            ?>
                        ...
                        <td>
                            <button type="button" id="btnvaliderFacturation_<?php echo $lg->getId() ?>" class="btn btn-white btn-success" ng-click="ValiderLigneSuivireglement(<?php echo $lg->getId() ?>)">
                                valider
                            </button>
                        </td>
                    </tr>
