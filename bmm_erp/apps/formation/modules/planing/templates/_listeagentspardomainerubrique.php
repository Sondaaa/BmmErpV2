        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Agents particpants à  La Formation du  Domaine d'utilisation "<?php echo $domaine->getLibelle(); ?> " et le  Rubrique "<?php echo $rubrique->getLibelle(); ?>"</h4>
                </div>
