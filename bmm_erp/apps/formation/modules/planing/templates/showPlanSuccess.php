...
<fieldset style="width: 100%;">
    ...
    <button onclick="document.location.href = '<?php echo url_for('planing/showdocument') . '?iddoc=' . $planing->getId() ?>'" class="btn btn-white btn-success pull-left">
        <i class="ace-icon fa fa-undo bigger-110"></i>Retour à la Réalisation</button>
</fieldset>