            ...
            <div class="modal-body">
                ...
                <fieldset class="col-lg-6">
                    ...
                    <table> 
                        <tr>
                            <td>
                                ...
                                <input id="idfonction" readonly="true" style="width: 70px" type="text" onkeydown="chargerDomaine(event, false)" ondblclick="chargerDomaine(event, true)">
                            </td>
                            <td>
                    ...
                    <table> 
                        <tr>
                            <td>
                                <input id="idunite" readonly="true" style="width: 70px" type="text" onkeydown="chargerUnite(event, false)" ondblclick="chargerUnite(event, true)">
                            </td>
                            <td>
                ...
                <div class="modal-footer">
                    <fieldset class="col-lg-12">
                        <button type="button" value="Initialiser" class="btn btn-sm btn-primary pull-left" onclick="Initilaiser()">Initialiser</button>
                        ...
                        <button type="button" value="Filtrer" id="btnfil" class="btn btn-sm btn-primary pull-right" onclick="filtrerAll()">Filtrer</button>
                    </fieldset>
                </div>
            </div>
        </div><!-- /.modal-content -->
