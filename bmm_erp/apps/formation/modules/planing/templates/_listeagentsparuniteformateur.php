        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Agents de   "<?php echo $unite->getLibelle(); ?> " participants à La Formation avec le Formateur  "<?php echo $for->getNom() ." " .$for->getPrenom() ; ?> " </h4>
                </div>
