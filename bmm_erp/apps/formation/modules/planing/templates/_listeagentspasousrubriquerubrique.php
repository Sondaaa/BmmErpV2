        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Agents particpants à  La Formation du Rubrique "<?php echo $rubrique->getLibelle(); ?> " et le Sous Rubrique "<?php echo $sousrubrique->getLibelle(); ?>"</h4>
                </div>
