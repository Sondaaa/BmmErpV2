<div id="my-modalsousrubriqueparrubrique_2" class="modal fade" tabindex="-1" >
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <table id="dynamic-table"  style="width: 100%" >
                            ...
                            <tbody>
                                ...
                                foreach ($listes as $l) {
                                    $ag = $l;
                                    ?>
                                    <tr style="cursor: pointer;" ondblclick="chSousRubriqueParRubrique1('<?php echo $ag->getId(); ?>', '<?php echo $ag->getCode(); ?>', '<?php echo $ag->getLibelle(); ?>')">
                    ...
                    <div class="modal-footer" >
                        ...
                        <button type="button" value="Fermer" class="btn btn-sm pull-left"  onclick="fermerSousRubriqueParRubrique1()" >
...
<script>   $("table").addClass("table  table-bordered table-hover");
    function chSousRubriqueParRubrique1(id, code, libelle)
    {

        $('#my-modalsousrubriqueparrubrique_2').removeClass('in');
        $('#my-modalsousrubriqueparrubrique_2').css('display', 'none');
    ...
    function fermerSousRubriqueParRubrique1()
    {
        $('#my-modalsousrubriqueparrubrique_2').removeClass('in');
        $('#my-modalsousrubriqueparrubrique_2').css('display', 'none');
    }
