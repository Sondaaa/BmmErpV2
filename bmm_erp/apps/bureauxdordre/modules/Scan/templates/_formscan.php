    ...
    <div class="row ">
        <div class="col-md-9">
            <div class="panel panel-default">
                ...
                <iframe src="http://localhost:5000?url=<?php echo sfconfig::get('sf_appdir') ?>bureauxdordre.php/courrier/Uploaderfile&id=<?php echo $courrier->getId()  ?>" height="600" width="100%"></iframe>
        ...
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    $piecejoints = Doctrine_Core::getTable('piecejoint')->findByIdCourrier($id);
                    include_partial('document/formparcourrier', array('form' => $formp, 'courrier' => $courrier, 'piecejoints' => $piecejoints));
                    ?>
                </div>
            </div>
        </div>
