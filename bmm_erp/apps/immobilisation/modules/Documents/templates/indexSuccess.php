    ...
    <div class="col-xs-12" >
        ...
        <?php if ($documentachat) { ?>
            <ul class="nav nav-tabs">
                <li class="active"><a href="#home" data-toggle="tab" aria-expanded="true">Détail D.I. </a>
                </li>
                <li class=""><a href="#profile" data-toggle="tab" aria-expanded="false">Demandes des Prix</a>
                </li>
                <li class=""><a href="#profile1" data-toggle="tab" aria-expanded="false">Bon des Déponses aux Comptant </a>
                </li>
                <li class=""><a href="#profile2" data-toggle="tab" aria-expanded="false">Bon des commandes externes </a>
                </li>
            </ul>
            <div class="tab-content">
                    ...
                    <div class=" col-xs-12">
                        <div class="widget-box ui-sortable-handle" id="widget-box-1" style="opacity: 1;" >
                            <div class="widget-header">
                                ...
                                <div class="widget-toolbar"> <a href="#" data-action="collapse" class="btn btn-xs btn-success"> 
                ...
                <div class="tab-pane" style="height: 800px" id="profile2" >
                    <div class=" col-xs-12">
                        <div class="widget-box ui-sortable-handle" id="widget-box-1" style="opacity: 1;">
                            <div class="widget-header">
                                <h5 class="widget-title">Liste des Bons commandes externes</h5>
                                <div class="widget-toolbar"> <a href="#" data-action="collapse" class="btn btn-xs btn-success"> 
                                        <i class="ace-icon fa fa-chevron-up"></i> </a> 
                                </div>
                            </div> 
