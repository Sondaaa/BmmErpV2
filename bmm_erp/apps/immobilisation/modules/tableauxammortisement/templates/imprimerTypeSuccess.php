...
<script>
    ...
    function setRowStyle() {
        $('#tblData tr').each(function () {
            ...
            } else if ($(this).find("td:eq(6)").text().trim() == '0.000') {
                $(this).css('background-color', '#d9edf7');
            } else if ($(this).find("td:eq(9)").text().trim() == '0.000') {
    ...
    function setStyle() {
        ...
        $("#tblData tr td:nth-child(5)").css("text-align", "right");
        $("#tblData tr td:nth-child(6)").css("text-align", "center");
        ...
        $("#tblData tr td:nth-child(10)").css("text-align", "right");
