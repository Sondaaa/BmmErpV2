<div id="sf_admin_container" class="panel panel-green">
    <h1>Inventaire n°: <?php echo $doc->getNumero(); ?></h1>
    ...
    <div id="sf_admin_content">
        <div class="sf_admin_list">
            ...
            <ul>
                <li>
                    <a target="_blank" href="<?php echo url_for('Inventaire/ImprimerFiche?id=' . $iddoc . "&idbur=" . $idbur) ?>" class="btn btn-success">Imprimer Fiche</a>
                </li>
            </ul>
        </div>
    </div>
