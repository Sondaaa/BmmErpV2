            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- ->render(array('ng-model'=>'id_famille','ng-change'=>'ChargerSousFamille()'))-->
                            <div id=famille class="disabledbutton">
                    ...
                    <tr>
                        ...
                        <!-- //(array('ng-model'=>'id_sousfamille','ng-change'=>'ChargerCodeSousFamille()')) -->
                        <td colspan="3">
                            <div id=sousfamille class="disabledbutton">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $form['refcodeabarre']->renderError() ?>
                            <?php echo $form['refcodeabarre'] ?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <div class="testul">
                                <ul style="display: none; z-index: 9;" id="sltdesc" ng-model="desc">
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td>
                        <?php //echo $form['id_typeaffectationimmo']->renderError() ?>
                        <?php //echo $form['id_typeaffectationimmo'] ?>
                        <?php $type_affectations = TypeaffectationimmoTable::getInstance()->getAllOrderId(); ?>
                        <select id="immobilisation_id_typeaffectationimmo" name="immobilisation[id_typeaffectationimmo]" onchange="changeAffectation()">
                            <option id="affectation_0" value="0"></option>
                            <?php foreach ($type_affectations as $type_affectation): ?>
                                <option id="affectation_<?php echo $type_affectation->getId() ?>" value="<?php echo $type_affectation->getId() ?>" affectation="<?php echo $type_affectation->getAffectation() ?>" <?php if ($form->getObject()->getIdTypeaffectationimmo() == $type_affectation->getId()): ?>selected="true"<?php endif; ?>><?php echo $type_affectation->getLibelle() ?></option>
                            <?php endforeach; ?>
                        </select>
                    </td>
                    <td colspan="2"></td>
                </tr>
                <tr id="tr_affectation_1" <?php if (!$form->getObject()->getTypeaffectationimmo()->getAffectation()): ?>class="disabledbutton"<?php endif; ?>>
                ...
                <tr id="tr_affectation_2" <?php if (!$form->getObject()->getTypeaffectationimmo()->getAffectation()): ?>class="disabledbutton"<?php endif; ?>>
                ...
                <tr id="tr_affectation_3" <?php if (!$form->getObject()->getTypeaffectationimmo()->getAffectation()): ?>class="disabledbutton"<?php endif; ?>>
                    <td>
                        <label>Bureau</label>
                    </td>
                    <td colspan="3">
                ...
                <tr id="tr_affectation_4" <?php if (!$form->getObject()->getTypeaffectationimmo()->getAffectation()): ?>class="disabledbutton"<?php endif; ?>>
                    ...
                    <td colspan="2">
                        <table style="margin-bottom: 0px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $sourcesfinancemments = SourcesfinancemmentTable::getInstance()->findAll(); ?>
                                    <select id="sourcefinancement" name="sourcefinancement">
                                        <option value=""></option>
                                        <?php foreach ($sourcesfinancemments as $sourcesfinancemment): ?>
                                            <option value="<?php echo $sourcesfinancemment->getId(); ?>"><?php echo $sourcesfinancemment->getSourcefinancement(); ?></option>
                                        <?php endforeach; ?>
                                    </select>
<!--                                    <input type="text" id="sourcefinancement" name="sourcefinancement" ng-model="sourcefinancement" value="" class="form-control" ng-change="ChangerSourcefin()" ng-click="ChangerSourcefin()">
                                    <div class="testul">
                                        <ul style="display: none" id="ulsource" ng-model="ulsource">
                                            <li ng-repeat="ls in listedessource" ng-mousedown="selectedDesc(d.id, d.sourcefinancement)">
                                                {{ls.sourcefinancement}}
                                            </li>
                                        </ul>
                                    </div>-->
                                </td>
        ...
        <tfoot>
            <tr>
                <td colspan="2">
                    ...
                    <input class="btn btn-white btn-success disabledbutton" type="submit" value="Valider" />
                </td>
            </tr>
        </tfoot>
        <tbody>
...
//$(".mask").inputmask('Regex', {regex: "^[0-9]{1,6}(\\.\\d{1,2})?$"});
    $("#immobilisation_tva").addClass('mask');
    function changeAffectation() {
        if ($("#immobilisation_id_typeaffectationimmo").val() != "0") {
            if ($("#affectation_" + $("#immobilisation_id_typeaffectationimmo").val()).attr("affectation") == "0") {
                desableAffectation();
            } else {
                enableAffectation();
            }
    ...
    function enableAffectation() {
        $("#tr_affectation_1").removeClass("disabledbutton");
        $("#tr_affectation_2").removeClass("disabledbutton");
        $("#tr_affectation_3").removeClass("disabledbutton");
        $("#tr_affectation_4").removeClass("disabledbutton");
    }

    function desableAffectation() {
        $("#immobilisation_id_pays").val('').trigger("liszt:updated");
        $("#immobilisation_id_pays").trigger("chosen:updated");
        $("#immobilisation_id_gouvernera").val('').trigger("liszt:updated");
        $("#immobilisation_id_gouvernera").trigger("chosen:updated");
        $("#immobilisation_id_site").val('').trigger("liszt:updated");
        $("#immobilisation_id_site").trigger("chosen:updated");
        $("#immobilisation_id_etage").val('').trigger("liszt:updated");
        $("#immobilisation_id_etage").trigger("chosen:updated");
        $("#immobilisation_id_bureaux").val('').trigger("liszt:updated");
        $("#immobilisation_id_bureaux").trigger("chosen:updated");
        $("#immobilisation_id_agent").val('').trigger("liszt:updated");
        $("#immobilisation_id_agent").trigger("chosen:updated");
//        $("#immobilisation_adresse").val('');

        $("#tr_affectation_1").addClass("disabledbutton");
        $("#tr_affectation_2").addClass("disabledbutton");
        $("#tr_affectation_3").addClass("disabledbutton");
        $("#tr_affectation_4").addClass("disabledbutton");
    }
...
<?php if (!$form->getObject()->isnew()) { ?>
    ...
    <?php if ($form->getObject()->getIdBureaux()): ?>
                $("#immobilisation_id_bureaux").val(<?php echo $form->getObject()->getIdBureaux() ?>);
    ...
    ?>
            ...
            $scope.selectDesc = function () {
                $http({
                    ...
                    document.getElementById("sltdesc").style.zIndex = "9";
...
<?php }if ($form->getObject()->isnew()) { ?>
    <script  type="text/javascript">
        $("#immobilisation_datecreation").val('<?php echo date('Y-m-d'); ?>');
        document.getElementById("immobilisation_numero").readOnly = "readOnly ";
        document.getElementById("immobilisation_reference").readOnly = "readOnly ";
        document.getElementById("immobilisation_datecreation").readOnly = "readOnly";
    ...
    <script  type="text/javascript">
        $(document).ready(function () {
            $('#immobilisation_description').ckeditor();
        });
        //        var app = angular.module('myApp', []);
        app.controller('myCtrl', function ($scope, $http) {
            ...
            $scope.ChangerSourcefin = function () {
                ...
                $http({
                    ...
                    document.getElementById("ulsource").style.display = "";
                    document.getElementById("ulsource").style.zIndex = "9";

                    $scope.listedessource = response.data;

                }, function myError(response) {
                    alert(response);
                });

                $scope.selectedSource = function (id, libelle) {
                    $scope.filterdesc = namefrs;
                    document.getElementById("ulsource").style.display = "none";

                    $('#sourcefinancement').val(id);
                    $('#sourcefinancement').val(libelle);
                };
            };
        });
