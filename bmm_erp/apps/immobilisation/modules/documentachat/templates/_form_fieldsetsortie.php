...
$doc = $documentachat;
?>
<input type="hidden" value="<?php echo 'patrimoine'; ?>" id="typebnsortie">
...
<div class="col-lg-4" ng-init="ParametrageSociete();<?php if ($doc->getIdDemandeur() && $documentachat->getIdDocparent()) {?>
            InialiserBonSortieByBCIImmob(<?php echo $documentachat->getIdDocparent() ?>,<?php echo $doc->getIdDemandeur() ?>, '')<?php }?>">
...
<div class="col-lg-12">
        ...
        <table>
                        ...
                        <table>
                            ...
                            ?>
                                    ...
                                    <td style="vertical-align: bottom;">
                                        <p class="btn btn-sm btn-warning" ng-click="AjouterLigneBcIP()">Ajouter</p>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <tbody>
                <tr id="formligne">
                    ...
                    <td style="width: 50px">
                    <input type="text" style="text-align: center;" value="" ng-model="quantite.text" id="quantite" class="form-control" readonly="true"> </td>
    ...
    <fieldset style="margin-left: 30%">
        ...
        <div>
            ...
            <input id="btnvalider_provisoire" ng-click="AjouterBSPatri('<?php echo $idtype; ?>','')" type="button" value="Valider le Bon de Sortie Provisoire " class="btn btn-outline btn-danger" />
