...
<div class="col-lg-12">
    <fieldset>
        <legend>Liste des Immobilisation</legend>
        ...
        <table>
            ...
            <table style="margin-bottom: 0px;">
                <tr>
                    ...
                    <td><label>&emsp;</label><p class="btn btn-xs btn-warning" ng-click="AjouterTaux()">Appliquer</p></td>
                </tr>
            </table>
            </th> 
            <th colspan="6">
            <table style="margin-bottom: 0px;">
                <tbody>
                    <tr class="disabledbutton">
                        ...
                        <td><label>&emsp;</label>
                            <p class="btn btn-xs btn-warning" ng-click="AjouterLigneBce()">Ajouter</p>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <tbody>
                <tr id="formligne">
                    ...
                    <td style="width: 150px">
                      ...
                      <td>
<textarea  id="observation" ng-model="observation">

</textarea>

                            </td>
                    <td style="width: 180px">
                        <button type="button" class="btn btn-xs btn-primary" ng-click="AjouterLigne()">+ Ajouter</button>
                        <button type="button" class="btn btn-xs btn-danger" ng-click="InaliserChamps()">- Vider</button>
                ...
                <tr ng-repeat="lignedoc in lignedocbce">
                    ...
                    <td>
                        <button type="button" class="btn btn-info btn-xs" ng-click="MisAJour(lignedoc)"><i class="fa fa-hospital-o"></i>
                        </button>
                        <button type="button" class="btn btn-warning btn-xs" ng-click="SupprimerLigne(lignedoc)"><i class="fa fa-times"></i>
                        </button>
                    </td>
                </tr>
            </tbody>
