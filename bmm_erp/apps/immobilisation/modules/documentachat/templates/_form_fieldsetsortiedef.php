...
<div class="col-lg-4" ng-init="ParametrageSociete(); InialiserBonSortieLigneBciDEFPatrimoine('<?php echo $documentachat->getId();?>');<?php if ($doc->getIdDemandeur() && $documentachat->getIdDocparent()) {?>
...
<div class="col-lg-12">
    ...
    <fieldset style="margin-left: 30%">
        ...
        <div>
            ...
            <input id="btnvalider_definitif" ng-click="AjouterBSDefPatri('<?php echo $idtype; ?>','false')" type="button" value="Valider le Bon de Sortie Définitif  " class="btn btn-outline btn-danger" />
