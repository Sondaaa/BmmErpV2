...
<div style=" position: absolute;float: right;margin-left: 78%;margin-top: 1%;" class="disabledbutton">
    <table>
        <tr>
...
<fieldset style="margin-left: 50%;">
    ...
    <div >
        <a   style="font-size: 18px" class="btn btn-outline  btn-primary1" href="<?php echo url_for('@documentachat') ?>">Listes B.C.I.</a>
        <a target="_blanc" style="font-size: 18px" class="btn btn-outline  btn-primary1" href="<?php echo url_for('documentachat/Imprimerdocachat?iddoc='.$documentachat->getId()) ?>">Impprimer & Exporter Pdf</a>
