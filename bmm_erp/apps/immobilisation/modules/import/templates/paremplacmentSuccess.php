<div id="" class="panel panel-green">
    <div id="replacediv" class="panel-heading">Import Emplacment </div>
    <div id="sf_admin_content">

        <form action="<?php echo url_for('import/paremplacment?imp=emplacment')?>"  name="form_upload" role="form" method="post" enctype="multipart/form-data">
