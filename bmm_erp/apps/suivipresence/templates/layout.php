<?php if ($sf_user->isAuthenticated()) : ?>
    ...
    <body class="no-skin">
        ...
        <script>
            var demo1 = $('select[name="suivipresence[id_agent]"]').bootstrapDualListbox({
