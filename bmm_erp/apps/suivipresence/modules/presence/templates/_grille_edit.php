...
$query = " select  grillepresence.semaine as semaine,grillepresence.heuresupp as heuresupp"
        ...
        . " where  presence.id = grillepresence.id_presnece"
        . " and grillepresence.id_presnece=" . $id
;
            ...
            <?php for ($i = 1; $i <= date('t'); $i++): ?>
                ...
                <?php if ($i % 7 == $modulo_after || $i == 1): ?>
                    ...
                    <td id="td_<?php echo $i; ?>" style="text-align: center">
                        ...
                        ?>
                        <?php if ($nom_jour_courant == 'Sun'): ?>
                            <span    type="text" id="codemotif_<?php echo $i; ?>" >     
                            </span>
                            <input  name='jour_motif' type="hidden" id="idmotif_<?php echo $i; ?>">
                            <input class="grille_presence_input" jour="<?php echo $rang_jour_courant; ?>"  name="semaine_heure" type="text" id="s_<?php echo $i; ?>"  semaine="<?php echo $id_semaine ?>"  value="0" readonly="true"/>
                            <input class="grille_presence_input"  jour="<?php echo $rang_jour_courant; ?>"  name="heur_supp" type="text" id="h_<?php echo $i; ?>"  semaine="<?php echo $id_semaine ?>"  value="0" readonly="true"/>
                        <?php else: ?>
                            ...
                            <input class="grille_presence_input" jour="<?php echo $rang_jour_courant; ?>"  name="semaine_heure" type="text" type_input="heure_<?php echo $id_semaine ?>" semaine="<?php echo $id_semaine ?>" id="s_<?php echo $i; ?>" value="<?php echo trim($liste[$i - 1]['semaine']) ?>" onkeyup="CalculTotal('<?php echo $id_semaine ?>')" onchange="testerabsence('<?php echo $i ?>', '<?php echo $mois ?>', '<?php echo $annee ?>')"/>
                            <input class="grille_presence_input" jour="<?php echo $rang_jour_courant; ?>"  name="heur_supp" type="text" type_input="supp_<?php echo $id_semaine ?>" semaine="<?php echo $id_semaine ?>" id="h_<?php echo $i; ?>" value="<?php echo trim($liste[$i - 1]['heuresupp']) ?>" onkeyup="CalculTotalHsup('<?php echo $id_semaine ?>')"/>
                        <?php endif; ?>
                    </td>
                    <?php $j++; ?>
                    <?php $m++; ?>
