                    ...
                    <ul class="nav nav-list">
                        <li class="hover" id="menu_parameter">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a class="<?php if (!$user->getProfilModule($acces_admin->getId(), "Bureaux")) echo 'disabledbutton' ?>" href="<?php echo url_for('@typebureaux') ?>">Type Locaux</a></li>
                                ...
                                <!-- <li><a class="<?php //if (!$user->getProfilModule($acces_admin->getId(), "Direction")) echo 'disabledbutton' ?>" href="<?php //echo url_for('@naturedocachat') ?>">Nature Doc Achat</a></li> -->
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        <li class="hover" id="menu_parameterdev">
                            ...
                            <ul class="submenu">
                                ...
                                <!--                            <li><a href="<?php // echo url_for('@moduleerp') 
                                                                                ?>">Modules</a></li>
                            <li><a href="<?php // echo url_for('@role') 
                                            ?>">Role</a></li>                           
                            <li><a href="<?php // echo url_for('@rolemodule') 
                                            ?>">Roles / Modules</a></li>
                            <li><a href="<?php // echo url_for('@prevelege') 
                                            ?>">Privilège</a></li>
                            <li><a href="<?php // echo url_for('@prvelegedroit') 
                                            ?>">Privilège / Modules</a></li>-->
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        <li class="hover">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a class="<?php if (!$user->getProfilModule($acces_admin->getId(), "Bureaux")) echo 'disabledbutton' ?>" href="<?php echo url_for('@bureaux') ?>">Locaux</a></li>
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        <li class="hover">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a class="<?php if (!$user->getProfilModule($acces_admin->getId(), "Marque")) echo 'disabledbutton' ?>" href="<?php echo url_for('@marqueimmobilisation') ?>">Marque</a></li>
                                <li class="hover">
                        ...
                        <li class="hover">
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a class="" href="<?php echo url_for('@avis') ?>">Avis par Unité</a>
                                </li>
                                <li>
                                    <a class="" href="<?php echo url_for('@visaachat') ?>">Visa d'Achat</a>
                                </li>
                                <li>
                                    <a class="" href="<?php echo url_for('@parametragetypedoc') ?>">Paramétrage par Type Doc.</a>
                                </li>
                                <li>
                                    <a class="" href="<?php echo url_for('@objectdocument') ?>">Type Bon Commande Interne</a>
                                </li>
                                <li>
                                    <a class="" href="<?php echo url_for('@notesbce') ?>">Modalité de Livraison</a>
                                </li>
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        ...
                        <li class="hover">
                            ...
                            <ul class="submenu">
                                ...
                                <li><a class="<?php if (!$user->getProfilModule($acces_admin->getId(), "Types Documents budget")) echo 'disabledbutton' ?>" href="<?php //echo url_for('@demandeprivilege') ?>">Demandes  Privilèges</a></li>
                            </ul>
                            <!-- /.dropdown-user -->
                        </li>
                        <li class="hover">
