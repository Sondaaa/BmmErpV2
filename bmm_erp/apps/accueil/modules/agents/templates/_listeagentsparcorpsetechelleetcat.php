<div id="my-modalfiltragecorpsetechelleetcat"  class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés relié au Corps   "<?php echo $cat->getLibelle(); ?> " et l'echelle "<?php echo $e->getLibelle(); ?> " " et au Catégorie "<?php echo $ech->getLibelle(); ?> "</h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparcorpsetechelleetcat?idcorps='.$id1.'&idechelle='.$id2.'&idcat='.$id3) ?>" class="btn btn-sm btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a> 
                        <button type="button" value="Fermer" id="btn1"  class="btn btn-sm pull-left"  onclick="fermeragentscorpsechelleetcat()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentscorpsechelleetcat()
    {
        $('#my-modalfiltragecorpsetechelleetcat').removeClass('in');
        $('#my-modalfiltragecorpsetechelleetcat').css('display', 'none');
    }
