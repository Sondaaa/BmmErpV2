            ...
            <div class="modal-body">
                <fieldset class="col-lg-12">
                    ...
                    <table style="width: 100%">
                        <tr> 
                            <td>Matricule</td>
                            <td><input id="idrh_all" name="idrh_all" type="checkbox" style="width: 25px"></td>
                            <td>CIN</td>
                ...
                <div class="modal-footer">
                    <button type="button" value="Initialiser" class="btn btn-sm btn-primary pull-left" onclick="InitilaiserListe()">
                        Initialiser</button>
                    <button type="button" value="Imprimer" id="bntimp" class="btn btn-sm pull-left" onclick="printListePersonnel()">
                        Imprimer</button>
                    <button id="btnfermer" class="btn btn-sm pull-right" data-dismiss="modal" onclick="annulerListe()">
                        Fermer</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
...
<script  type="text/javascript">
    ...
    function printListePersonnel() {
        var valide = false;
        var url = '';
        if ($('input[name=idrh_all]').is(':checked') &&  $('#idrh_all').val() != 'undefined') {
            if (url == '')
        ...
        if (valide) {
            ...
            if ($('#agents_filters_idrh').val() != ''  && $('#agents_filters_idrh').val() != 'undefined' )
            {
                if (url == '')
            ...
            if ($('#agents_filters_cin').val() != '' &&  $('#agents_filters_cin').val() != 'undefined')
            {
                if (url == '')
                    url = '?cin_filtre=' + $('#agents_filters_cin').val();
                else
                    url = url + '&cin_filtre=' + $('#agents_filters_cin').val();
            }
//
//            if ($('#agents_filters_prenom').val() != '' &&  $('#agents_filters_prenom').val() != 'undefined') {
//                if (url == '')
//                    url = '?prenom_filtre=' + $('#agents_filters_prenom').val();
//                else
//                    url = url + '&prenom_filtre=' + $('#agents_filters_prenom').val();
//            }
//            if ($('#agents_filters_id_regrouppement').val() != '0' &&  $('#agents_filters_id_regrouppement').val() != 'undefined' &&  $('#agents_filters_id_regrouppement').val() != '') {
//                if (url == '')
