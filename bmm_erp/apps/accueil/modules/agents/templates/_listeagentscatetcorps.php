<div id="my-modalfiltragecorpsetcat" class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés relié au Corps  "<?php echo $c->getLibelle(); ?> "   catégorie   "<?php echo $cat->getLibelle(); ?> "</h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparcoretcat?idcor='.$id1.'&idcat='.$id2) ?>" class="btn btn-sm btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a> 
                        <button type="button" value="Fermer" id="btn1"  class="btn btn-sm  pull-left"  onclick="fermeragentscatetcorps()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentscatetcorps()
    {
        $('#my-modalfiltragecorpsetcat').removeClass('in');
        $('#my-modalfiltragecorpsetcat').css('display', 'none');
    }
