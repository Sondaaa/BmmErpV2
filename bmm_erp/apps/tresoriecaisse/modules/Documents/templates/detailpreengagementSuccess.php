...
<div id="sf_admin_container" ng-controller="CtrlCaisse" >
    ...
    <div class="panel-body">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="<?php if ($active == "detail") echo "active" ?>" ng-click="InialiserQuittance()" ><a href="#engagement" data-toggle="tab" aria-expanded="false">Fiche quittance <?php echo $form->getObject()->getCategorieoperation() ?></a>
            </li>
