    ...
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            <div class="widget-main" style="padding: 4%; text-align: center; min-height: 105px;">
                <a target="_blank" class="btn btn-outline btn_new btn-success" href="<?php echo url_for('declaration/imprimerListe') ?>" style="text-align: center;height: 55px !important; width: 250px; font-size: 14px !important; margin-top: 5px;">Imprimer Liste<br>des Déclarations</a>
            </div>
        </div>
    </div>
</div>