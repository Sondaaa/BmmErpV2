    ...
    <div class="btn-toolbar">
        <div class="btn-group" id="btnaction">
            ...
            <ul class="dropdown-menu" role="menu">
                <li>
                    <a target="_blanc" class="btn btn-outline btn-success width-fixed" href="<?php echo url_for('Documents/Imprimerreliverbancaire?iddoc=' . $caissesbanques->getId()) ?>"><i class="ace-icon fa fa-credit-card bigger-110"></i> Relevé Identité Bancaire</a>
                </li>
                <li>
