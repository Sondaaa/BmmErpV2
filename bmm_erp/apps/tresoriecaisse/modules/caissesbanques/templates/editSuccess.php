...
<div id="sf_admin_container">
  <h1><?php echo __('Mise à jour fiche compte %%libelle%%', array('%%libelle%%' => $caissesbanques->getLibelle()), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    <?php include_partial('caissesbanques/form', array('caissesbanques' => $caissesbanques, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
  </div>
