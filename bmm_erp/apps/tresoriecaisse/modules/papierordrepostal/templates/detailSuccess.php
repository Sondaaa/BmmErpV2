    ...
    <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        if ($bordereau) {
                            if (count($mvt) > 0)
                                if($mvt->getRefbenifi())
                                echo $mvt->getRefbenifi() . '  ' . FormatRib::Show($mvt->getRibbeni());
                        }
                        ?>
                    </td>
        ...
        <td style="width: 57%; padding: 5px; vertical-align: top;">
            <table id="table_ordre" style="width: 100%; margin-bottom: 0px;">
                ...
                <tr>
                    <td colspan="5" style="text-align: center;"><?php echo chiffreToLettre::cvnbst1($ordre->getMnt()) ?></td>
                </tr>
                <tr>
                    <td style="height: 31px;">Au profit de</td>
                    <td colspan="3" style="text-align: center;">
...
<div class="row">
    <a target="_blanc" href="<?php echo url_for('papierordrepostal/ImprimerVide?id=' . $ordre->getId() . '&id_bordereau=' . $bordereau->getId()) ?>" class="btn btn-sm btn-primary" style="float: left; margin-left: 20px;">
    ...
    <a target="_blanc" href="<?php echo url_for('papierordrepostal/Imprimer?id=' . $ordre->getId()) ?>" class="btn btn-sm btn-primary" style="float: right; margin-right: 20px;">
        <i class="ace-icon fa fa-print bigger-110"></i>
        <span class="bigger-110 no-text-shadow">Imprimer Ordre (Remplir)</span>
    </a>
</div>
