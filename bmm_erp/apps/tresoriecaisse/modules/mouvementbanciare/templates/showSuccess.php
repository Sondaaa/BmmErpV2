...
<div class="row">
    <div class="col-xs-12">
        <div class="widget-box" >
            <div class="widget-header widget-header-flat">
                <h4 class="widget-title smaller">Banque Ou CCP</h4>
            </div>
            <div class="widget-body">
                <div class="widget-main" style="padding-bottom: 0px;">
                    <table>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <?php echo FormatRib::Show($details_banque_ccp->getCaissesbanques()->getRib()); ?>
                                <?php //echo $details_banque_ccp->getCaissesbanques()->getRib(); ?>
                            </td>
                        </tr>
                        <tr>
                            <td>Solde Départ :</td>
    ...
    <div class="col-xs-12">
        <div class="widget-box" >
            <div class="widget-header widget-header-flat">
                ...
                <a target="_blanc" style="float: right;" class="btn btn-outline btn-primary" href="<?php echo url_for('mouvementbanciare/ImprimerMouvementBanque?ids=' . $ids) ?>"><i class="ace-icon fa fa-print bigger-110"></i> Imprimer</a>
            </div>
            <div class="widget-body">
                            ...
                            <?php foreach ($mouvements as $mvt): ?>
                                ...
                                <?php if ($mvt->getMntenoper() != null): ?>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td style="text-align: right;"><?php echo number_format($mvt->getSolde() - $mvt->getMntenoper(), 3, '.', ' '); ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php $i++; ?>
                            <?php endforeach; ?>
...
<div class="row">
    <div class="col-xs-12">
        <a target="_blanc" style="float: right;" class="btn btn-outline btn-info" href="<?php echo url_for('mouvementbanciare/ImprimerMouvementBanque?ids=' . $ids) ?>"><i class="ace-icon fa fa-print bigger-110"></i> Imprimer</a>
    </div>
</div>
