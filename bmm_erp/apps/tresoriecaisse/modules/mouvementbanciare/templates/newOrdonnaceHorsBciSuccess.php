...
?>
                                ...
                                <select class="chosen-select form-control"
                                 name="mouvementbanciare[id_banque]"
                                  id="mouvementbanciare_id_banque">
                ...
                <div class="widget-main" style="padding-bottom: 0px; width: 100%; overflow: auto; min-height: 500px">
                    <table id="idformulaire"  
                        ...
                        <td>Réf.Ordonnancement<br>
                                ...
                                <div id="ordonnance_input" <?php if ($id): ?>  style="display: block;"<?php else: ?> style="width: 100%;display: none;"<?php endif; ?> >
                            ...
                            <td style="width: 20%">Libellé d'opération<br>
...
<?php echo $form['id_object'] ?>
                    ...
                    <a title="Ajouter à la fin." data-rel="tooltip" ng-click="PushNewLigne('<?php echo $id; ?>','p')" class="btn btn-info" style="float: right; padding: 4px 12px; padding-top: 3px;"><i class="ace-icon fa fa-arrow-down align-center bigger-110"></i> Ajouter Ligne</a>
                    <table   style="list-style: none" class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>N°</th>
...
<?php endif; ?>
                                ...
                                <td>{{lgop.instrument}}<br ng-if=" lgop.ncheque !=''">
                                {{lgop.ncheque}}<br ng-if=" lgop.refinstrument !=''">
                                {{lgop.refinstrument}}</td>
                                <td>{{lgop.debit}}</td>
                                <td>{{lgop.credit}}</td>
