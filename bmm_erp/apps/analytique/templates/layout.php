<?php if ($sf_user->getAttribute('userB2m')) : ?>
    <script type="text/javascript">
        document.location.href = "<?php echo sfconfig::get('sf_appdir') . 'index.php' ?>";
    </script>
<?php endif; ?>
<?php
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo sfconfig::get('sf_appdir') ?>assets/css/jquery.gritter.min.css" />
...
<body class="no-skin">
    ...
    <script type="text/javascript">
        ...
        $('select').not('[id="skin-colorpicker"]').not('[id="tva"]').not('[id="listesbdcp"]').not('[id="idnote"]').attr('class', "chosen-select form-control");
