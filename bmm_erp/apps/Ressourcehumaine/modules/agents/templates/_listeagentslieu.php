        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés affectés au   "<?php echo $lieu->getLibelle(); ?> "</h4>
                </div>
                ...
                $i=1;                
                    ...
                    <div class="modal-footer" >
                         <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparlieu?idlieu='.$id1) ?>" class="btn btn-sm btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" id="btn1"  class="btn btn-sm pull-left"  onclick="fermeragentslieu()">
                            Fermer</button>
                    </div>
                </div>
