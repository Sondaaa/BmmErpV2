...
<?php foreach ($pager->getResults() as $agents): ?>
    <tr>
        ...
        <td class="sf_admin_text sf_admin_list_td_daten" style="text-align: center;">
            <?php echo date('d-m-Y', strtotime($agents->getDatenaissance())); ?>
        </td>
        <td class="sf_admin_text sf_admin_list_td_regroupementagents" style="text-align: center;">
            <?php echo $agents->getRegroupementagents() ?>
        </td>
        <td class="sf_admin_text sf_admin_list_td_sexe" style="text-align: center;">
