        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés relié au Catégorie   "<?php echo $cat->getLibelle(); ?> " et l'echelon "<?php echo $e->getLibelle(); ?> "</h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparechelonetcategorie?idechelon='.$id1.'&idcat='.$id2) ?>" class="btn btn-sm btn-success pull-left">
