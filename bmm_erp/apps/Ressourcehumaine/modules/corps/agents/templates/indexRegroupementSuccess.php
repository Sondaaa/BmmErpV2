    ...
    <div class="col-xs-12">
        ...
        <div>
            <table id="listAgents">
                <thead>
                    <tr>
                        <th style="width: 8%; text-align: center;">Matricule</th>
                        <th style="width: 15%;">Nom</th>
                        <th style="width: 15%;">Prénom</th>
                        <th style="width: 8%; text-align: center;">CIN</th>
                        <th style="width: 8%; text-align: center;">Regroupement</th>
                        <th style="width: 36%; text-align: center;">Opérations</th>
                    </tr>
                </thead>
                <tfoot>
