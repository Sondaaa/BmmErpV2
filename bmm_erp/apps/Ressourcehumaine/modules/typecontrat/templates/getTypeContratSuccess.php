<?php if ($agents->count() != 0): ?>
    <script type="text/javascript">
        $('#container_typecontrat').highcharts({
            chart: {
            ...
            title: {
                text: 'Statistique des Agents Par Situation Administrative   :'
            },
            tooltip: {
            ...
            series: [{
                    type: 'pie',
                    name: 'Statistique Par Situation Administrative ',
                    data: [
    <?php for ($i = 0; $i < sizeof($agents); $i++): ?>
                            ['Situation Administrative :<?php echo $agents[$i]['typecontrat'] ?>', <?php echo $agents[$i]['nbragents'] ?>],
    <?php endfor; ?>
                    ]
                }]
        });</script>
