        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés relié au Corps   "<?php echo $c->getLibelle(); ?> " et l'echelle "<?php echo $e->getLibelle(); ?> " " et l'echelon "<?php echo $ech->getLibelle(); ?> "  et au catégorie "<?php echo $cat->getLibelle(); ?> "</h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparcorpsetechelleetecehlonetcat?idcorps='.$id1.'&idechelle='.$id2.'&idechelon='.$id3.'&idcat='.$id4) ?>" class="btn btn-sm  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a> 
                        <button type="button" value="Fermer" id="btn1"  class="btn btn-sm pull-left"  onclick="fermeragentscorpsechelleetecheloncat()">
                            Fermer</button>
                    </div>
                </div>
