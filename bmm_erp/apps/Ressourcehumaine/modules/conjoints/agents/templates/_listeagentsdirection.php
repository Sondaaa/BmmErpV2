<div id="my-modalagentsdirection" class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés de la Direction "<?php echo $directio->getLibelle(); ?> "</h4>
                </div>
            ...
            $i=1;
                   ...
                   $i++;             }
                    ...
                    <div class="modal-footer" >
                        <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentspardirection?iddirection='.$idd) ?>" class="btn btn-sm  btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a>
                        <button type="button" value="Fermer" id="btn1"  class="btn btn-sm pull-left"  onclick="fermeragentsdirection()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentsdirection()
    {
        $('#my-modalagentsdirection').removeClass('in');
        $('#my-modalagentsdirection').css('display', 'none');
    }
