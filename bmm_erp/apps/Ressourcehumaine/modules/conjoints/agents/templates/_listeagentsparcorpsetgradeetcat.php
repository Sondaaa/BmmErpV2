<div id="my-modalfiltragecorpsetgradeetcat"  class="modal fade" tabindex="-1" >
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="smaller lighter blue no-margin"> Liste des Employés relié au Corps   "<?php echo $cat->getLibelle(); ?> " " , au Catégorie "<?php echo $ech->getLibelle(); ?> " et au Grade "<?php echo $e->getLibelle(); ?> " </h4>
                </div>
...
$i=1;                                
                    ...
                    <div class="modal-footer" >
                      <a id="button_print" target="_blanc" href="<?php echo url_for('agents/ImprimerAlllisteagentsparcorpsetgradeetcat?idcorps='.$id1.'&idgrade='.$id2.'&idcat='.$id3) ?>" class="btn btn-sm btn-success pull-left">
                            <i class="ace-icon fa fa-print bigger-110"></i>
                            <span class="bigger-110 no-text-shadow">Imprimer</span>
                        </a> 
                        <button type="button" value="Fermer" id="btn1"  class="btn btn-sm pull-left"  onclick="fermeragentscorpsgradeetcat()">
                            Fermer</button>
                    </div>
                </div>
...
<script  type="text/javascript">
    ...
    function fermeragentscorpsgradeetcat()
    {
        $('#my-modalfiltragecorpsetgradeetcat').removeClass('in');
        $('#my-modalfiltragecorpsetgradeetcat').css('display', 'none');
    }
