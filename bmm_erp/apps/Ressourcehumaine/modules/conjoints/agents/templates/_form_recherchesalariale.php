            ...
            <div class="modal-body">
                ...
                <fieldset class="col-lg-6">
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idsituation" readonly="true" type="text" style="width: 45px"  onkeydown="chargersituation(event, false)" ondblclick="chargersituation(event, true)">
                        </td>
                        <td>
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idposition" readonly="true" type="text" style="width: 45px" onkeydown="chargerpositio(event, false)" ondblclick="chargerpositio(event, true)">
                        </td>
                        <td>
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idlieu" readonly="true" type="text" style="width: 45px" onkeydown="chargeelieu(event, false)" ondblclick="chargeelieu(event, true)">
                        </td>
                        <td>
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idprime" readonly="true" type="text" style="width: 45px"  onkeydown="chargerprime(event, false)" ondblclick="chargerprime(event, true)">
                        </td>
                        <td>
                ...
                <fieldset class="col-lg-6">
                    <table> 
                        <tr>
                        <h11><label><i>Filière</i></label></h11>

                        <td>
                            <input id="idcorps"  readonly="true"  type="text" style="width: 45px"  onkeydown="chargerecorps(event, false)" ondblclick="chargerecorps(event, true)" >
                        </td>
                        <td>
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idechelle"  readonly="true"  type="text" style="width: 45px" onkeydown="chargerechelle(event, false)" ondblclick="chargerechelle(event, true)" >
                        </td>
                        <td>
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idechelon"   readonly="true" type="text" style="width: 45px"  onkeydown="chargerechelon(event, false)" ondblclick="chargerechelon(event, true)">
                        </td>
                        <td>
                    ...
                    <table> 
                        ...
                        <td>
                            <input id="idcategorie"  readonly="true"  type="text" style="width: 45px"   onkeydown="chargerecat(event, false)" ondblclick="chargerecat(event, true)">
                        </td>
                        <td>
                    ...
                    <table style="margin-bottom: 20px;"> 
                        ...
                        <td>
                            <input id="idgrade"  readonly="true"  type="text" style="width: 45px"    onkeydown="chargeregrade(event, false)" ondblclick="chargeregrade(event, true)">
                        </td>
                        <td>
                ...
                <div class="modal-footer" >
                    <button type="button" value="Filtrer" class="btn btn-sm btn-primary pull-left"  onclick="filtrer1()">

                        Filtrer</button>



                    <button id="btnfermer" class="btn btn-sm pull-right" data-dismiss="modal" onclick="fermerAgent()">
                        Fermer
                    </button>   
                    <button type="button" value="Initialiser"  class="btn btn-sm btn-primary pull-right" onclick="Initilaiser1()">
                        Initialiser</button>
...
<script  type="text/javascript">
    ...
    function  chargerprojet(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
        ...
        if (key == 112 || dbclick) {
            $('#my-modalprojet').addClass('in');
            $('#my-modalprojet').css('display', 'block');
        }

    }
    function  chargerpositio(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargerechelle(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargerecorps(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargerechelon(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargerecat(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargeregrade(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargeelieu(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
    ...
    function  chargerprime(e, dbclick)
    {
        if (e.keyCode == true)
        {
            var key = e.keyCode;
...
//    function  filtrerAllAgents() {
//        $.ajax({
//            url: '<?php // echo url_for('agents/filtrerAllAgents')                 ?>',
//            data: 'idcorps=' + $('#idcorps').val() +
//                    '&idechelle=' + $('#idechelle').val() +
//                    '&idechelon=' + $('#idechelon').val() +
//                    '&idcategorie=' + $('#idcategorie').val() +
//                    '&idgrade=' + $('#idgrade').val() +
//                    '&idsituation=' + $('#idsituation').val() +
//                    '&idprime=' + $('#idprime').val() +
//                    '&idlieu=' + $('#idlieu').val() +
...
//    }
    function  filtrer1() {
        if ($('#idcorps').val() == "" && $('#idechelle').val() == "" && $('#idechelon').val() == "" && $('#idcategorie').val() == "" && $('#idgrade').val() == "" && $('#idsituation').val() == "" && $('#idprime').val() == "" && $('#idlieu').val() == "" && $('#idposition').val() == "" && $('#idechelon').val() == "")
        {
