    ...
    <div class="btn-toolbar">
        <div class="btn-group" id="btnaction">
            ...
            <ul class="dropdown-menu" role="menu">
                <?php echo $helper->linkToEdit($attestationdetravail, array('params' => array(), 'class_suffix' => 'edit', 'label' => 'Edit',)) ?>

                <?php echo $helper->linkToDelete($attestationdetravail, array('params' => array(), 'confirm' => 'Are you sure?', 'class_suffix' => 'delete', 'label' => 'Delete',)) ?>
