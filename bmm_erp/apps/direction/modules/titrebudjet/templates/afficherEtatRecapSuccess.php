            ...
            <?php foreach ($listes as $liste): ?>
                ...
                <?php foreach ($sous_listes as $sous_liste): ?>
                    <tr style="background-color: #deffd0;">
                        ...
                        <td style="text-align: right;"><?php echo number_format($sous_liste->getRelicatEngager(), 3, '.', ' '); ?></td>
                        <td style="text-align: right;"><?php echo number_format($sous_liste->getRelicatPaiment(), 3, '.', ' '); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php endforeach; ?>
