            ...
            <?php foreach ($listes as $liste): ?>
                ...
                <?php foreach ($sous_listes as $sous_liste): ?>
                    <tr style="background-color: #deffd0;">
                        <td><b style="color: #0066cc;"><?php echo $sous_liste->getLigprotitrub()->getNordre(); ?> : </b> <?php echo $sous_liste->getRubrique(); ?></td>
                        <td style="text-align: right;"><?php echo number_format($sous_liste->getMntCaisse(), 3, '.', ' '); ?></td>
                        <td style="text-align: right;"><?php echo number_format($sous_liste->getMntBanque(), 3, '.', ' '); ?></td>
                        <td style="text-align: right; color: #3BB014;"><?php echo number_format($sous_liste->getMntCaisse() + $sous_liste->getMntBanque(), 3, '.', ' '); ?></td>
                        <td style="text-align: right;"><?php echo number_format($sous_liste->getMntAnt(), 3, '.', ' '); ?></td>
                        <td style="text-align: right; color: #CC1F00;"><?php echo number_format($sous_liste->getMntCaisse() + $sous_liste->getMntBanque() + $sous_liste->getMntAnt(), 3, '.', ' '); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php endforeach; ?>
