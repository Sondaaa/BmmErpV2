    ...
    <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="smaller lighter blue no-margin">SUIVI BON DEPENSE AU COMPTANT </h4>
            </div>
            <div class="modal-body">
                <fieldset class="col-lg-12">
                    <legend>Données de bon dépense au comptant<input id="base_check" name="base_check" type="checkbox" style="float: right;" onchange="checkAllBase()"></legend>
                    <table style="width: 100%">
                        ...
                        <tr> <td><h4 class="smaller lighter blue no-margin"><i>FACTURATIO</i></h4></td>
...
<script  type="text/javascript">
    function annuler() {
        $('#my-modalimpression_bdc ').removeClass('in');
        $('#my-modalimpression_bdc ').css('display', 'none');
  ...
  if ($('input[name=datepai]').is(':checked')) {
        ...
        if (valide) {
            ...
            url = '<?php echo url_for('Accueil/imprimerFicheBDCeAvecChoix') ?>' + url;
