...
<div class="sf_admin_filter col-xs-8" >
    ...
    <form action="<?php echo url_for('parcourcourier_collection', array('action' => 'filter')) ?>" method="get">
...
<div class="col-xs-4 widget-container-col" id="widget-container-col-1">
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            <div class="widget-main" style="text-align: center; padding-top: 20px; padding-bottom: 40px;">
                ...
                <a style="height: 55px !important; width: 250px; font-size: 14px !important; font-weight: bold !important;" target="_blanc" href="<?php echo url_for('parcourcourier/Imprimerlistecourrier') . $str ?>" class=" btn btn-white btn-success">
                    Exporter<br>PDF
                </a>
            </div>
        </div>
