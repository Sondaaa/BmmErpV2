<div id="sf_admin_container">
    ...
    <div id="sf_admin_content" style="font-size: 14px;">
        <div>
            <fieldset>
                ...
                <div class="col-xs-9">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><?php echo date('d/m/Y', strtotime($courrier->getDatecorespondanse())) ?></td>
                        </tr>
                        <tr>
                ...
                <div class="col-xs-3" style="text-align: center;">
                    <ul class="sf_admin_bar">
                        ...
                        <li class="sf_admin_action_list" style="display: inline;">
                            <a style="margin: 2%; height: 55px !important; width: 200px; font-size: 14px !important; font-weight: bold !important;" target="_blanc" href="<?php echo url_for('courrier/Imprimercourrier?idcourrier=' . $courrier->getId()) ?>" class=" btn btn-outline btn-success">
            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>Document</td>
                        <td>Courrier Origine ou sources</td>
                        <td>Action</td>
                    </tr>
                    <?php
                    ...
                    foreach ($piecejoints_original as $piecejoint):
                        ...
                        <tr>
                            ...
                            <td><a target="_blanc" href="<?php echo sfconfig::get('sf_appdir') . 'uploads/scanner/' . $piecejoint->getChemin() ?>">Voir et Imprimer</a></td>
                        </tr>
                    <?php endforeach; ?>
                    <?php
