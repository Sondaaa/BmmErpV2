                ...
                <div class="widget-box transparent">
                    ...
                    <div class="widget-body">
                        <div class="widget-main padding-24">
                                ...
                                <table >
                                    <thead>
                                        <tr >
                                            ...
                                            <th style="text-align:center;width: 340px">Désignation<br>
                            ...
                            <div class="col-sm-7 pull-left"> Remarques Importantes </div>
                            <div class="space-6"></div>
                            <div class="space-6"></div>
                            <div class="well">
                                <p>1) L'Exemplaire original de ce bon de commande doit être joint à la facture</p>
                                 <p>2) la facture doit être établie en 4 exemplaires signées et arrétées en toutes lettres.</p>
                                 <p>Elle doit en outre faire référence au numéro et à la date du présent bon de commande</p>
                            </div>
                        </div>
                    </div>
                </div>
