                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset>
                            ...
                            <div class="col-lg-3">
                                <?php include_partial('lots/form_action_ios', array('idlot' => $form->getObject()->getId(), 'type' => "type2", 'formlot' => $form, 'listesordredeservice' => $listesordredeservice, 'OSARRET' => null, 'OSREPISE' => null, 'OSCOMMTRAVAUX' => null)); ?>
                            </div>
                        </fieldset>
                    </div>
                    <?php
