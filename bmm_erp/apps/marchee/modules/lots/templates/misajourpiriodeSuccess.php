                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset>
                                ...
                                <fieldset >
                                    ...
                                    <table class="disabledbutton">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 27%"><label>TOTAL GENERAL HTVA</label></td>
                                                <td style="width: 30%">
                            ...
                            <div class="col-lg-6" ng-init="Initialiserdelaiexecution"> 
                                <fieldset>
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><label>Période d'arrêt justifié</label></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><label>Délai contractuel</label></td>
                                                <td>
                                                    <?php echo $form['delaicontractuelle']->renderError() ?>
                                                    <?php echo $form['delaicontractuelle'] ?> 
                                                </td>
                                                <td><label>Période réelle d'exécution</label></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><label>Période de retard</label></td>
                                                <td>
                                            ...
                                            <tr>
                                                <td><label>Pèriode de Garantie</label></td>
                                                
                                                   <td>
                                                    <?php echo $form['delaigarantie']->renderError() ?>
                                                    <?php echo $form['delaigarantie'] ?>
