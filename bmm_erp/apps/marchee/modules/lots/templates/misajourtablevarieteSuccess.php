...
<div id="sf_admin_container">
    <h1><?php echo __('Mise à Jour Table Variété', array(), 'messages') ?></h1>
            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        <fieldset class="disabledbutton">
                            ...
                            <table >
                                <tbody>
                                    <tr>
                                        <td style="width: 20%"><label>N° Ordre</label></td>
                                        <td style="width: 15%">
                    ...
                    <div id="messages" class="tab-pane fade">
                        ...
                        include_partial('sousdetailprix/form_mis_a_jour_table_variete', array('sousdetailprix' => $sousdetailprix, 'form' => $formsousdetail,'formlot'=>$form));
                        ?>
                    </div>
                </div>
            </div>
