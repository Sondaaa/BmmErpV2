...
<div class="row">
    <div class="col-xs-6">
        <div class="widget-box">
            <div class="widget-header widget-header-flat">
                <h4 class="widget-title smaller">Ajouter Rèfèrentiel </h4>
            </div>
    ...
    <div class="col-xs-6" id="zone_edit" style="display: none;">
        <div class="widget-box widget-color-grey">
            <div class="widget-header widget-header-flat">
                <h4 class="widget-title smaller">Modifier Rèfèrentiel </h4>
            </div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="table-header">
            Liste des Rèfèrenteils
        </div>
        <div>
            <table id="list_forme" class="mws-datatable-fn mws-table">
                <thead>
                    <tr>
                        <th style="width: 40%;">Rèfèrentiel</th>
                ...
                <tbody>
                    <?php include_partial('referentielmarche/liste_referentiel', array('pager' => $pager))?>
                </tbody>
            </table>
        </div>
    </div>
...
<script  type="text/javascript">
    ...
    function goPage(page) {
        $.ajax({
            url: '<?php echo url_for('@referentielmarche') ?>',
...
//    }
    ...
    function deleteForme(id) {
        bootbox.confirm({
            message: "Voulez-vous supprimer ce Rèfèrentiel   ?",
            buttons: {
                cancel: {
                    label: "Non",
                    className: "btn-sm",
    ...
    function validerSuppression(id) {
        $.ajax({
            url: '<?php echo url_for('referentielmarche/deleteReferentiel') ?>',
            data: 'id=' + id,
            success: function (data) {
                $('#list_forme > tbody').html(data);
            }
...
<script  type="text/javascript">
    document.title = ("BMM - G. Compta. : Referentiel  ");
</script>