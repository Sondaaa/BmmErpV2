<div class="sf_admin_form" ng-controller="myCtrldoc">
   
    <?php echo $form->renderHiddenFields(false) ?>

    <input type="hidden" ng-value="<?php if (isset($_REQUEST['idtype'])) echo $_REQUEST['idtype']; else echo "9" ?>" ng-model="typedocid.text" id="idtypedoc" value="<?php if (isset($_REQUEST['idtype'])) echo $_REQUEST['idtype']; else echo "9" ?>">
