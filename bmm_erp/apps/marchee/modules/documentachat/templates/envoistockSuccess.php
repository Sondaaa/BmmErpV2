                    ...
                    foreach ($listesdocuments as $lignedoc) {
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><input type="checkbox"  <?php //if (strtoupper(trim($lg->getEtatligne())) == strtoupper(trim("P.E.S."))) echo 'checked="checked"' ?> id="check1_<?php echo $lignedoc->getId() ?>" class="disabledbutton"  ></td>
                                        <td> <input type="checkbox"  <?php// if (strtoupper(trim($lg->getEtatlignepatrimoine())) == strtoupper(trim("P.E.P."))) echo 'checked="checked"' ?> id="check1_<?php echo $lignedoc->getId() ?>" class="disabledbutton"  ></td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td><input type="checkbox"  <?php //if (strtoupper(trim($lg->getEtatligne())) == strtoupper(trim("P.A.S."))) echo 'checked="checked"' ?> id="check1_<?php echo $lignedoc->getId() ?>" class="disabledbutton"  ></td>
                                        <td> <input type="checkbox"  <?php //if (strtoupper(trim($lg->getEtatlignepatrimoine())) == strtoupper(trim("P.A.P."))) echo 'checked="checked"' ?> id="check1_<?php echo $lignedoc->getId() ?>" class="disabledbutton"  ></td>
                                    </tr>
                                </table>
                            </td>
...
<?php } ?>
        ...
        <fieldset style="margin-left: 50%;">
            ...
            <div >
                <a class="btn btn-outline btn-danger" href="<?php echo url_for('documentachat/envoistock') . '?iddoc=' . $documentachat->getId() . '&btn=valider' ?>">Valider et Envoi vers Stock&Patrimoine </a>
