    ...
    <div id="sf_admin_content">  
        <div class="panel-body">
            ...
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#profile" data-toggle="tab" aria-expanded="false">Fiche Bon de Dépenses aux Comptant</a></li>
                <li class=""><a href="#listesdemandeprix" data-toggle="tab" aria-expanded="false">Liste Bon de Dépenses aux Comptant</a></li>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                ...
                <div class="tab-pane" id="profile" ng-controller="CtrlDemandeprix">
                    <h4>
                        <p>
                            ...
                            <br>Formulaire de Bon de déponse aux comptant
                        </p>
                    </h4>
                        ...
                        <table style="list-style: none" class="table table-striped table-bordered table-hover">
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td colspan="2">Bon de dépenses aux comptant N°:  <?php echo $numerodemande ?></td>
                                        </tr>
                                        <tr>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            <td>Fournisseur</td>
                                            <td>
                                                <input type="text" value="" style="width: 100px" ng-model="reffournisseur.text" id="reffournisseur" class="form-control" ng-change="AfficheFournisseur()">
                                            </td>
                                            <td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" ng-model="designation.text" id="designation" ng-click="ChoisArticle(<?php echo $documentachat->getId() ?>)" ng-change="ChoisArticle(<?php echo $documentachat->getId() ?>)">
                                    </td>
                ...
                <div class="tab-pane" style="height:  1200px" id="listesdemandeprix" ng-controller="CtrlListesBondeponse" ng-init="AfficheDoc(<?php echo $documentachat->getId() ?>)">
                    <h4>
                        <p>
                            <strong><?php echo strtoupper($societe); ?></strong>
                            <br>Liste des bons de dépensee aux comptant
                        </p>
                    </h4>
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr ng-repeat="demandeprix in docDemandePrix">
                                    ...
                                    <td>
                                        <input type="button" ng-model="btndetail" class="btn btn-primary1" ng-click="DetailLignedoc(demandeprix.id)" value="+ Détail">
                                    </td>
