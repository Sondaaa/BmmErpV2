    ...
    <div class="widget-box" id="widget-box-1">
        ...
        <div class="widget-body">
            <div class="widget-main" style="padding: 5%; text-align: center;">
                <a href="<?php echo url_for('fournisseur/new') ?>" class="btn btn-outline btn_new btn-success" style="text-align: center; width: 250px; font-size: 14px !important;">Nouvelle Fiche Fournisseur</a>  
            </div>
        </div>
    </div>
</div>