                    ...
                    <tbody>
                        ...
                        foreach ($stocks as $stock) {
                            ...
                            <tr>
                                ...
                                <td style="width: 10%">
                                    <input value="<?php echo $stock['ecartthorique'] ?>"  type="text" id="txt<?php echo $stock['idart']; ?>" >
                                ...
                                <td id="ecart<?php echo $stock['idart']; ?>">
                                     <?php if ($stock['ecartthorique']) {echo "Ecart : "; echo $stock['qtetheorique'] - $stock['ecartthorique'];} ?>
                                    <br>                                   
                                    <?php
                                    if ($stock['ecartthorique']) {
                                        $st = new Stock();
