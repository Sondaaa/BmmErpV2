...
<div class="col-lg-12">
            ...
            <tbody>
                <tr id="formligne">
                    ...
                    <td style="width: 180px">
                        <button type="button" class="btn btn-primary" ng-click="AjouterLigneRetour()">+</button>
    ...
    <fieldset style="margin-left: 30%">
        ...
        <div>
            <a class="btn btn-danger" href="<?php echo url_for('documentachat/index?idtype=12'); ?>">Liste des fiches de retour</a>
