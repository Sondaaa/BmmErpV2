    ...
    <fieldset>
        ...
        <table>
            ...
            <table style="margin-bottom: 0px;">
                <tr>
                    ...
                    <td style="vertical-align: bottom;"><label>&emsp;</label><p class="btn btn-sm btn-warning" ng-click="AjouterTaux()">Appliquer</p></td>
                </tr>
            </table>
            </th> 
            <th colspan="6">
        ...
        <div class="col-lg-4" style="float: right">
            <table style="font-weight: bold">
                <tr>
                    <td>Total H.TAX</td><td style="text-align: right;"> {{totalfiche.thtxa}}</td>
                </tr>
                <tr>
                    <td>Total Remise</td><td style="text-align: right;"> {{totalfiche.totalremise}}</td>
                </tr>
                <tr>
                    <td>Fodec</td><td style="text-align: right;"> {{totalfiche.fodec}}</td>
                </tr>
                <tr>
                    <td>Total H.TVA</td><td style="text-align: right;"> {{totalfiche.tht}}</td>
                </tr>
                <tr><td>Total TVA</td><td style="text-align: right;"> {{totalfiche.ttva}}</td>
                </tr>
                <tr>
                    <td>Total TTC </td><td style="text-align: right;">{{totalfiche.ttcnet}}</td>
                </tr>
            </table>
        </div>
    </fieldset>
