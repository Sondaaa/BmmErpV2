                        ...
                        <table class="table table-bordred">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><b>BDCR Provisoire</b></td>
                                    <td  style="min-width: 25%;">
                                        <select class="chosen-select form-control" name="id_bdcreg" id="id_bdcreg">
                                            <option></option>
                                            <?php foreach ($AllBdc as $bdc): ?>
                                                <option value="<?php echo $bdc->getId() ?>"
                                                <?php
                                                if ($id_bdc && $id_bdc == $bdc->getId()):
                                                    echo 'selected';
                                                endif;
                                                ?> >
                                                            <?php echo $bdc->getNumerodocachat() .' -Référence- '.$bdc->getReference(); ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <select class="chosen-select form-control" name="id_bdcdef" id="id_bdcdef">
                                            ...
                                            <?php foreach ($AllBDCDef as $bdcdef): ?>
                                                ...
                                                <?php
                                                if ($id_bdcdef && $id_bdcdef == $bdcdef->getId()):
                                                    echo 'selected';
                                                endif;
                                                ?> >
                                                            <?php echo $bdcdef->getNumerodocachat() .' -Référence- '.$bdcdef->getReference();  ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </td>
                                        ...
                                        <td style="text-align: center" colspan="3">
                                            ...
                                            foreach ($document_achat_externe_difinitif as $definitif) {
                                                ...
                                                if ($docparent_parent) {
                                                    ...
                                                    foreach ($definitif->getLignemouvementfacturation() as $lignmvtfac) {
                                                        echo '<p>' . $docparent_parent->getNumerodocachat();
                                                        echo ' - ' . $lignmvtfac->getNumerofacture();
