<div class="table-responsive" >
    <table>
        <tfoot>
            <tr>
                <td colspan="2">
                    <input type="button" class="btn btn-outline btn-success" value="Valider Attachement" ng-click="ValiderAttachementDocument(<?php echo $document->getId(); ?>)" />
                </td>
            </tr>
        </tfoot>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo $form['chemin']->render(array('id' => 'piecejoint_chemin' . $document->getId())) ?>
                </td>
            </tr>
        </tbody>
    </table>
