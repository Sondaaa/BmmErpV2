<td>
    <ul class="sf_admin_td_actions">
        ...
        <li>
            <a  href="<?php echo url_for('Documents/Imprimerreclamation?iddoc=') . $reclamationfrs->getId() ?>" class="btn btn-primary btn-xs"
                style="margin-left: 2px" ng-model="BtnExporter"  target="_blanc">
