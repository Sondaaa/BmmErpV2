...
//                $ids = explode(',', $ids);
                ...
                $total_doc_ttc = 0;
                $objet_reglement = '';
                $docachats = DocumentachatTable::getInstance()->find($ids);
//                die(sizeof($docachats).'vdf'.json_encode($ids));
...
//                        print $docachat->getMntttc();
                ...
                <div class="col-xs-12">
                    <div class="widget-box">
                        <div class="widget-header widget-header-flat">
                            <h4 class="widget-title smaller">Informations sur le Facture</h4>
                        </div>
                        <div class="widget-body">
                            <div class="widget-main" style="padding-bottom: 0px;">
                                <legend>C/ INFORMATIONS RELATIVES AU Facture</legend>
                                <table style="margin-bottom: 10px;">
                                    <tr>
