        ...
        <div id="sf_admin_content" ng-controller="Ctrlfacturation">  
            <div class="panel-body">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                if ($documentachat->getIdTypedoc() == 7) {
                                    ?>
                                    <div class="col-lg-10">
                                        <?php echo html_entity_decode($documentachat->ReadHtmlBonexterneBDCR($id)); ?> 
                                    </div>
                                ...
                                <?php if ($documentachat->getIdTypedoc() == 2) { ?>
                                    <div class="col-lg-10">
                                        <?php echo html_entity_decode($documentachat->ReadHtmlBondeponseBDCR($id)); ?> 
                                    </div>
                                    <!--                                <div class="col-lg-2" style="margin-top: 4%">
                                    ...
                                    <div class="col-lg-2" style="margin-top: 5%;">
                                        <ul>
                                            ...
                                            <?php if ($ligne_mouvement): ?>
                                                <?php if ($jeton): ?>
                                                    <?php if ($ligne_mouvement->getMontant() == ''):
                                                        ?>
                                                        <?php $disabled = 'disabledbutton'; ?>
                                                    <?php else: ?>
                                                        <?php $disabled = ''; ?>
                                            ...
                                            <?php else: ?>
                                                <?php // $disabled = ' disabledbutton'; ?>
                                            <?php endif; ?>
                                            <li id="export_to_facture" style="margin-top: 1%" class="<?php    ?>"><!--$classBtn . ' ' . . ' ' . $disabled $classBtnF-->
                                                <a href="<?php echo url_for('Documents/detaillignemouvementAchat') . '?exporterfacture=' . $documentachat->getId() . '&id=' . $ligne_mouvement->getId() ?>" style="font-size: 18px; width: 150px; height: 80px; margin-top: 2px;" class="btn btn-primary">Exporter<br>Facture</a>
                                            </li>
                                        </ul>
                                    </div>
                                <?php } ?>
                    ...
                    <?php // include_partial('documentachat/pvreceptionBdCR', array('documentachat' => $documentachat, 'lienBCEJ' => $lienBCEJ, 'lienFacture' => $lienFacture, 'jeton' => $jeton, 'facture' => $facture, 'classBtn' => $classBtn, 'classBtnF' => $classBtnF, 'disabled' => $disabled)) ?>
                </div>
            </div>
        </div>
    </div>
