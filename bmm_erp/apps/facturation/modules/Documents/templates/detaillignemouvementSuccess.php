...
//                            $docparent = $documentachat->getDocumentparent();
                            ?>
                            <li>
                                <a href="#accuelbci" data-toggle="tab" aria-expanded="true">
                                    Détail <?php // echo $docparent;      ?></a>
                            </li>
                            <?php
                        }
                    }
...
// echo html_entity_decode($doc_achat->getBonCommandeInterne()); 
                                        ...
                                        <div class="col-lg-2">
                                            <a style="font-size: 18px; width: 150px; height: 70px" class="btn btn-white btn-default" href="<?php echo url_for('documentachat/ImprimerdocachatContrat?iddoc=') . $doc_achat->getId() ?>" target="_blanc">Exporter PDF<br>
                    ...
                    ?>
                    <div class="tab-pane fade " id="bceoubdc">
                        <div class="row">
                            <div class="col-lg-10">
                                <?php
                                $disabled = '';
                                    ...
                                    <div class="col-lg-2" style="margin-top: 5%;">
                                        <ul>
                                            <?php if ($documentachat->getContratachat()->getConsulte() != 'true') { ?>
                                                ...
                                                <?php } ?>
                                                <li>
                                                    <a style="font-size: 18px; width: 150px; height: 70px;margin-top: 1%" class="btn btn-white btn-default" href="<?php echo url_for('Documents/imprimerBCEDefinitfContrat?iddoc=') . $documentachat->getId() ?>" target="_blanc">Exporter PDF
                                                        <br>
                                                        <?php echo $documentachat->getContratachat()->getReference(); ?>
                                                    </a>
                                                </li>
