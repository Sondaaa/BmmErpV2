    ...
    <div class="col-lg-6">
        <table>
            <tr>
                ...
                <td style="width: 30%;"><?php echo date('Y', strtotime($details->getDatecreation())) ?></td>
                <td style="width: 20%;">Mois :</td>
                <td style="width: 30%;"><?php echo date('m', strtotime($details->getDatecreation())) ?> ( <?php echo $array[intval(date('m', strtotime($details->getDatecreation())))] ?> )</td>
            </tr>
        </table>
    </div>
    <div class="col-lg-9">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($sdetails->getQuetiteant() > 0) { ?>
                                <?php $quantite_cumule = $sdetails->getAncienQteDuMois($sdetails->getNordre()); ?>
                                <table style="text-align: center; margin-bottom: 0px;">
                                    <tr>
                                        ...
                                        <td><input ng-model="qtedumois<?php echo $sdetails->getId() ?>" <?php if ($quantite_cumule >= $sdetails->getQuetiteant()): ?>class="disabledbutton"<?php endif; ?> ng-value="<?php echo $sdetails->getQteDuMois(); ?>" value="<?php $sdetails->getQteDuMois(); ?>" type="text" id="qtedumois<?php echo $sdetails->getId() ?>" ng-change="CalculerCumule(<?php echo $sdetails->getId() ?>, '<?php echo $sdetails->getQuetiteant() ?>', '<?php echo $sdetails->getPrixunitaire(); ?>', '<?php echo $details->getId() ?>')"></td>
                                        <td><input value="<?php echo $quantite_cumule; ?>" class="disabledbutton" type="text" id="qtecumule<?php echo $sdetails->getId() ?>"></td>
                                    </tr>
                                </table>
                            <?php } ?>
                        </td>
        ...
        <table class="disabledbutton">
            ...
            <tr>
                <td  colspan="2">
                    ...
                    <label>Rabais, Remises ou Ristourne: <?php echo $formlot->getObject()->getRrr() ?></label>
