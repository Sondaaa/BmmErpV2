...
<div id="sf_admin_container">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main" style="padding-bottom: 0px;">
                                ...
                                <table style="margin-bottom: 10px;">
                                    <tr>
                                        <td style="width: 30%;">Objet de l'ordonnance de paiement</td>
    ...
    <div class="row">
        <div class="col-xs-12">
            <a class="btn btn-default" href="<?php echo url_for('documentachat/index?idtype=15') ?>" type="button" style="float: left; margin-top: 20px; margin-left: 1%;">
                <i class="ace-icon fa fa-undo bigger-110"></i>
                Retour à la Liste
            </a>
            <a class="btn btn-primary" target="__blanc" href="<?php echo url_for('documentachat/ImprimerCertificat?id=' . $certificat->getId()) ?>" type="button" style="float: right; margin-top: 20px; margin-right: 1%;">
                <i class="ace-icon fa fa-print bigger-110"></i>
                Imprimer Certificat
            </a>
            <a class="btn btn-primary" target="__blanc" href="<?php echo url_for('documentachat/ImprimerRecap?id=' . $certificat->getId()) ?>" type="button" style="float: right; margin-top: 20px; margin-right: 1%;">
                <i class="ace-icon fa fa-print bigger-110"></i>
                Recap. de Règlement
            </a>

            <?php if ($documentbudget->getDocumentbudget()->count() != 0): ?>
                <a class="btn btn-primary" target="__blanc" href="<?php echo url_for('documentachat/Imprimerordonnance?id=' . $documentbudget->getDocumentbudget()->getFirst()->getId()) ?>" type="button" style="float: right; margin-top: 20px; margin-right: 1%;">
                    <i class="ace-icon fa fa-print bigger-110"></i>
                    Ordonnance de paiement (Déclaration) N° <?php echo $documentbudget->getDocumentbudget()->getFirst()->getNumero(); ?>
                </a>
            <?php endif; ?>
        </div>
    </div>
