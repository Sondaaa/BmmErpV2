...
//                        print $docachat->getMntttc();
                                ...
                                <table id="liste_ligne">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($lignes as $ligne):
                                           ?>
                                            <tr style="text-align: center;">
                                                <td><input class="align_right" readonly="true" type="text" 
                                                value="<?php echo number_format($ligne->getMntht(), 3, '.', ' '); ?>">
                                                </td>
                                                <td><input class="align_center" readonly="true" type="text"
                                                value="<?php echo number_format($ligne->getValeurtva(), 2, '.', ' '); ?>">
                                               </td>
    ...
    <div class="row" id="zone_save_button">
        <div class="col-xs-12">
            ...
            <a href="<?php echo url_for('documentachat/index?idtype=15') ?>" class="btn btn-xs btn-success" style="float: right; margin-right: 1%;">
...
<script  type="text/javascript">
    ...
    function saveCertificat() {
        if (($('#taux_retenue').val() != '0')) {
            $.ajax({
                url: '<?php echo url_for('documentachat/saveCertificatRetenue') ?>',
