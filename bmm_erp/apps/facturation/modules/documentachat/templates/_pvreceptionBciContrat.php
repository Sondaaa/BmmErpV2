                ...
                <table border="1" style="padding:1%" id="liste_article">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center;width: 10%">T.<br>H.T</th>
                        ...
                        foreach ($liste_demande_de_prix as $lgnedoc) {
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                 ...
                                 <td style="text-align:center;">
                                    <p style="border-bottom: #000 dashed 1px !important">
                                        <input type="text" id="fodec<?php echo $lignedoc->getId() ?>" value="<?php echo $lignedoc->getTauxfodec() ?>" class="align_right"> 
                                    </p>
                                </td>
                                <td style="text-align:justify;">
                                    <p style="border-bottom: #000 dashed 1px !important">
...
<?php if ($lienFacture != 0) { ?>
    <div class="tab-pane" id="facture">
        <div class="row">
            <div class="col-lg-12">
                <?php echo html_entity_decode($facture->ReadHtmlFactureImressionBCIContrat($id)); ?>
            </div>
        </div>
    </div>
<?php } ?>
