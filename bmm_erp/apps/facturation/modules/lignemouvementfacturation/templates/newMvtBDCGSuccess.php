                ...
                <div class="widget-main" style="padding-bottom: 0px; width: 100%; overflow: auto; min-height: 500px" >
                    <table id="idformulaire" class="table table-bordered table-hover" style="width: 100%; margin-bottom: 0px;">
                        <tr>
                            ...
                            <td colspan="5" style="text-align: center; background-color: #dff0d8;">BDC G </td>
                        </tr>
                        <tr>
                            <td>Date<br>
                        ...
                        <tr>
                            ...
                            ?>
                            <td colspan="5">Fournisseur:
                                <select  id="id_fournisseur"   class="chosen-select form-control" style="width: 100%;">
                                    <option value=""></option>
