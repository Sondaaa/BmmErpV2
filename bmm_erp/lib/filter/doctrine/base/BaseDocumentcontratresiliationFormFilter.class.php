...
/**
 * Documentcontratresiliation filter form base class.
 *
 * @package    Bmm
 * @subpackage filter
 ...
 */
abstract class BaseDocumentcontratresiliationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'dateresiliation'   => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'id_user'           => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Utilisateur'), 'add_empty' => true)),
      'motifresiliattion' => new sfWidgetFormFilterInput(),
      ...
      'montantconsomme'   => new sfWidgetFormFilterInput(),
      'montantrestant'    => new sfWidgetFormFilterInput(),
    ));

    $this->setValidators(array(
      'dateresiliation'   => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
      'id_user'           => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Utilisateur'), 'column' => 'id')),
      'motifresiliattion' => new sfValidatorPass(array('required' => false)),
      ...
      'montantconsomme'   => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'montantrestant'    => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ));

    $this->widgetSchema->setNameFormat('documentcontratresiliation_filters[%s]');
