...
/**
 * Facturecomptablevente filter form base class.
 *
 ...
 */
abstract class BaseFacturecomptableventeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'id_facture'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Documentvente'), 'add_empty' => true)),
      ...
      'totalhtax'         => new sfWidgetFormFilterInput(),
      'tfodec'            => new sfWidgetFormFilterInput(),
    ));
    ...
    $this->setValidators(array(
      ...
      'id_facture'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Documentvente'), 'column' => 'id')),
      ...
      'totalhtax'         => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
      'tfodec'            => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ));

    $this->widgetSchema->setNameFormat('facturecomptablevente_filters[%s]');
