...
/**
 * Souscorps filter form base class.
 *
 ...
 */
abstract class BaseSouscorpsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('souscorps_filters[%s]');
