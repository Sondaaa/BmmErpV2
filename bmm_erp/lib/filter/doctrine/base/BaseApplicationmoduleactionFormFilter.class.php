...
/**
 * Applicationmoduleaction filter form base class.
 *
 * @package    PhpProject1
 * @subpackage filter
 ...
 */
abstract class BaseApplicationmoduleactionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('applicationmoduleaction_filters[%s]');
