...
/**
 * Modalitedecalcul filter form base class.
 *
 ...
 */
abstract class BaseModalitedecalculFormFilter extends BaseFormFilterDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('modalitedecalcul_filters[%s]');
