...
abstract class BaseDeviseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'secondaire' => new sfWidgetFormFilterInput(),
      'sigle'      => new sfWidgetFormFilterInput(),
    ));

    $this->setValidators(array(
      'libelle'    => new sfValidatorPass(array('required' => false)),
      'secondaire' => new sfValidatorPass(array('required' => false)),
      'sigle'      => new sfValidatorPass(array('required' => false)),
    ));
