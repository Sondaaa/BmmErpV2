...
/**
 * Mouvementcomptable filter form base class.
 *
 ...
 */
abstract class BaseMouvementcomptableFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('mouvementcomptable_filters[%s]');
