...
/**
 * Gouvernerat filter form base class.
 *
 ...
 */
abstract class BaseGouverneratFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('gouvernerat_filters[%s]');
