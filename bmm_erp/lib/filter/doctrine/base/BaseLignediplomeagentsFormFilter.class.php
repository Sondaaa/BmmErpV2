...
/**
 * Lignediplomeagents filter form base class.
 *
 ...
 */
abstract class BaseLignediplomeagentsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lignediplomeagents_filters[%s]');
