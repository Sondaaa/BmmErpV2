 ...
 */
class Lieutravail extends BaseLieutravail {

    public function __toString() {
        return "" . $this->getLibelle();
    }

    public function ReadHtmlAlllisteLieu() {

        $html = ' <h3>Liste des Lieus d"affectations </h3>';
        $html.=
        ...
        $sousd = Doctrine_Core::getTable('lieutravail')->findAll();
