 ...
 * @property integer $tauxpourcentage
 ...
 * @property Doctrine_Collection $Lignecontrat_9
 ...
 * @method integer             getTauxpourcentage()    Returns the current record's "tauxpourcentage" value
 ...
 * @method Doctrine_Collection getLignecontrat9()      Returns the current record's "Lignecontrat_9" collection
 ...
 * @method Lignecontrat        setIdTypepiece()        Sets the current record's "id_typepiece" value
 * @method Lignecontrat        setIdDocparent()        Sets the current record's "id_docparent" value
 * @method Lignecontrat        setTauxpourcentage()    Sets the current record's "tauxpourcentage" value
 ...
 * @method Lignecontrat        setLignecontrat()       Sets the current record's "Lignecontrat" collection
 * @method Lignecontrat        setLignecontrat9()      Sets the current record's "Lignecontrat_9" collection
 * @method Lignecontrat        setTauxfodec()          Sets the current record's "Tauxfodec" value
 * 
 * @package    Bmm
 * @subpackage model
...
abstract class BaseLignecontrat extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('tauxpourcentage', 'integer', 4, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => false,
             'notnull' => false,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Lignecontrat as Lignecontrat_9', array(
             'local' => 'id',
             'foreign' => 'id_docparent'));
