 ...
 */
class Facturecomptableod extends BaseFacturecomptableod
{
 public function ReadHtmlListe(sfWebRequest $request) {
        ...
        $factures = FacturecomptableodTable::getInstance()->getForPrint($saisie, $reference, $fournisseur, $date_debut, $date_fin);
        ...
        $html = '<div border="1">
                    <table cellspacing="0" cellpadding="3">
                        ...
                        <tr><td colspan="3" style="width:100%;" align="center"><b>Liste des Factures Comptables - Retenue à la source ' . $saisie . '</b></td></tr>
                    </table>
                </div>';
