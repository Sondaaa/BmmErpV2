 ...
 */
class Facturecomptablevente extends BaseFacturecomptablevente {

    public function ReadHtmlListe(sfWebRequest $request) {

        $fournisseur = $request->getParameter('client', '');
        ...
        $factures = FacturecomptableventeTable::getInstance()->getForPrint($saisie, $reference, $fournisseur, $date_debut, $date_fin);
        ...
        $html = '<div border="1">
                    <table cellspacing="0" cellpadding="3">
                        ...
                        <tr><td colspan="3" style="width:100%;" align="center"><b>Liste des Factures Comptables - Ventes ' . $saisie . '</b></td></tr>
                    </table>
                </div>';
        ...
        $html.='<div border="1">
                    <table cellspacing="0" cellpadding="3">
                        <tr style="font-size: 11px;">
                            ...
                            <td style="width:35%;"><b>Client :</b> ' . $fournisseur . '</td>
