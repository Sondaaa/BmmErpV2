 ...
 */
class Titreprimes extends BaseTitreprimes
{
public function   __toString() {
        return $this->getLibelle();
    }
     public function ReadHtmlAlllistePrimes() {

        $html = ' <h3>Liste des Primes  </h3>'
        ;
        $html.=
        ...
        $sousd = Doctrine_Core::getTable('titreprimes')->findAll();
