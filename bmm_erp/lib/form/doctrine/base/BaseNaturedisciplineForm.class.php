...
/**
 * Naturediscipline form base class.
 *
 * @method Naturediscipline getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseNaturedisciplineForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('naturediscipline[%s]');
