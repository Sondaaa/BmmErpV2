...
/**
 * Documentparent form base class.
 *
 * @method Documentparent getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseDocumentparentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'id_documentparent' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Documentachat_2'), 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('documentparent[%s]');
