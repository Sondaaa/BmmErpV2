...
/**
 * Modalitedecalcul form base class.
 *
 * @method Modalitedecalcul getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseModalitedecalculForm extends BaseFormDoctrine {
    ...
    public function setup() {
        ...
        $this->widgetSchema->setNameFormat('modalitedecalcul[%s]');
