...
/**
 * Lignedipagents form base class.
 *
 * @method Lignedipagents getObject() Returns the current form's model object
 *
 ...
 * @version    SVN: $Id$
 */
abstract class BaseLignedipagentsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'libelle'    => new sfValidatorString(array('max_length' => 55, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('lignedipagents[%s]');
