...
/**
 * CorpsDet form base class.
 *
 * @method CorpsDet getObject() Returns the current form's model object
 *
 ...
 * @version    SVN: $Id$
 */
abstract class BaseCorpsDetForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('corps_det[%s]');
