...
/**
 * Rubrique form base class.
 *
 * @method Rubrique getObject() Returns the current form's model object
 *
 * @package    BmmErpTest
 * @subpackage form
 ...
 */
abstract class BaseRubriqueForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rubrique[%s]');
