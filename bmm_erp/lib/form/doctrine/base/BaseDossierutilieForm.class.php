...
/**
 * Dossierutilie form base class.
 *
 * @method Dossierutilie getObject() Returns the current form's model object
 *
 * @package    Bmm
 * @subpackage form
 ...
 */
abstract class BaseDossierutilieForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dossierutilie[%s]');
